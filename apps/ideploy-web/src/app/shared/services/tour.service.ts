 ...
 * globale — celle qui porte déjà l'authentification de cette application.
 * Changer de navigateur ou de machine ne rejoue donc pas un didacticiel déjà
 * suivi. Le stockage local ne sert que de cache.
 */
