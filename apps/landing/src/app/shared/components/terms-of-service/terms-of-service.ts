  ...
  ngOnInit(): void {
    this.sections = [
      ...
      },
      {
        ...
        content:
          'IDEM is an AI-powered project management and development platform that provides comprehensive tools and services for modern software development and project management:',
        contentI18n: '@@terms.description.content',
        list: [
          {
            strong: 'Project Management',
            strongI18n: '@@terms.description.project_management.strong',
            text: 'Create, organize, and manage projects with AI-powered insights and recommendations',
      ...
      },
      {
        ...
        list: [
          {
            text: 'Provide accurate, current, complete, and truthful information during registration',
            textI18n: '@@terms.accounts.accurate_info',
          },
          {
            text: 'Maintain and promptly update your account information to keep it accurate and current',
            textI18n: '@@terms.accounts.update_info',
          },
          {
            text: 'Maintain the security and confidentiality of your password and account credentials',
            textI18n: '@@terms.accounts.security',
          },
          {
            text: 'Accept full responsibility for all activities that occur under your account',
            textI18n: '@@terms.accounts.responsibility',
          },
          {
            text: 'Notify us immediately of any unauthorized use, security breach, or suspected fraud',
            textI18n: '@@terms.accounts.notify_breach',
          },
          {
            text: 'Not share your account credentials or allow others to access your account',
            textI18n: '@@terms.accounts.no_sharing',
          },
          {
            text: 'Not create multiple accounts or use automated means to create accounts',
            textI18n: '@@terms.accounts.no_multiple',
          },
          {
            text: 'Be at least 18 years old or have parental consent to use the Service',
      ...
      },
      {
        ...
        content:
          'You agree to use the Service in compliance with all applicable laws and regulations. You explicitly agree NOT to:',
        ...
        subsections: [
          {
            ...
            list: [
              {
                text: 'Violate any applicable local, state, national, or international laws or regulations',
                textI18n: '@@terms.acceptable_use.prohibited.violate_laws',
              },
              {
                text: 'Infringe on intellectual property rights, copyrights, trademarks, or patents of others',
                textI18n: '@@terms.acceptable_use.prohibited.infringe_ip',
              },
              {
                text: 'Upload, transmit, or distribute malicious code, viruses, malware, or harmful content',
                textI18n: '@@terms.acceptable_use.prohibited.malicious_code',
              },
              {
                text: 'Attempt to gain unauthorized access to our systems, networks, or other user accounts',
                textI18n: '@@terms.acceptable_use.prohibited.unauthorized_access',
              },
              {
                text: 'Interfere with, disrupt, or impose unreasonable load on the Service or servers',
                textI18n: '@@terms.acceptable_use.prohibited.interfere',
              },
              {
                text: 'Use the Service for any illegal, fraudulent, or unauthorized purpose',
                textI18n: '@@terms.acceptable_use.prohibited.illegal_use',
              },
              {
                text: 'Harass, abuse, threaten, or harm other users or third parties',
                textI18n: '@@terms.acceptable_use.prohibited.harass',
              },
              {
                text: 'Distribute spam, unsolicited communications, or engage in phishing',
                textI18n: '@@terms.acceptable_use.prohibited.spam',
              },
              {
                text: 'Scrape, crawl, or use automated tools to extract data without permission',
                textI18n: '@@terms.acceptable_use.prohibited.scraping',
              },
              {
                text: 'Reverse engineer, decompile, or disassemble any part of the Service',
                textI18n: '@@terms.acceptable_use.prohibited.reverse_engineer',
              },
              {
                text: 'Remove, obscure, or alter any proprietary notices or labels',
          ...
          },
          {
            ...
            content:
              'All content you create, upload, or share must comply with the following standards:',
            contentI18n: '@@terms.acceptable_use.content_standards.content',
            list: [
              {
                text: 'Must not contain illegal, defamatory, obscene, or offensive material',
                textI18n: '@@terms.acceptable_use.content_standards.no_illegal',
              },
              {
                text: 'Must not violate privacy rights or disclose confidential information without authorization',
                textI18n: '@@terms.acceptable_use.content_standards.no_privacy_violation',
              },
              {
                text: 'Must not promote violence, discrimination, or hate speech',
                textI18n: '@@terms.acceptable_use.content_standards.no_hate',
              },
              {
                text: 'Must not contain misleading, false, or deceptive information',
      ...
      },
      {
        ...
        content: 'Intellectual property rights are governed by the following terms:',
        contentI18n: '@@terms.intellectual_property.content',
        subsections: [
          {
            title: '5.1 Our Content and Platform',
            titleI18n: '@@terms.intellectual_property.our_content.title',
            content:
              'The Service and its original content, features, functionality, design, code, and all related intellectual property are owned by IDEM and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws. You may not copy, modify, distribute, sell, or lease any part of our Service without explicit written permission.',
          ...
          },
          {
            ...
            content:
              'You retain full ownership of all content you create, upload, or submit to the Service. By using the Service, you grant us a non-exclusive, worldwide, royalty-free, sublicensable, and transferable license to use, reproduce, distribute, prepare derivative works of, display, and perform your content solely for the purpose of providing, maintaining, and improving the Service.',
            contentI18n: '@@terms.intellectual_property.your_content.content',
          },
          {
            title: '5.3 AI-Generated Content',
            titleI18n: '@@terms.intellectual_property.ai_content.title',
            content:
              'Content generated by our AI tools based on your inputs and prompts is provided to you under a non-exclusive, worldwide, royalty-free license. You may use, modify, and distribute AI-generated content for your personal and commercial purposes, subject to these terms. However, we cannot guarantee that AI-generated content is free from third-party intellectual property claims.',
            contentI18n: '@@terms.intellectual_property.ai_content.content',
          },
          {
            title: '5.4 Feedback and Suggestions',
            titleI18n: '@@terms.intellectual_property.feedback.title',
            content:
              'Any feedback, suggestions, ideas, or other information you provide to us about the Service becomes our property. We may use this feedback without any obligation to compensate you or provide attribution.',
      ...
      },
      {
        ...
        content:
          'Certain features and services require payment. By subscribing to a paid plan, you agree to:',
        contentI18n: '@@terms.payment.content',
        list: [
          {
            strong: 'Payment Obligation',
            strongI18n: '@@terms.payment.obligation.strong',
            text: 'Pay all fees and charges associated with your account and subscription plan',
            textI18n: '@@terms.payment.obligation.text',
          },
          {
            strong: 'Billing Information',
            strongI18n: '@@terms.payment.billing_info.strong',
            text: 'Provide accurate, complete, and current billing and payment information',
            textI18n: '@@terms.payment.billing_info.text',
          },
          {
            strong: 'Updates',
            strongI18n: '@@terms.payment.updates.strong',
            text: 'Notify us promptly of any changes to your payment information or billing address',
            textI18n: '@@terms.payment.updates.text',
          },
          {
            strong: 'Authorization',
            strongI18n: '@@terms.payment.authorization.strong',
            text: 'Authorize us to charge your payment method for all fees and charges',
          ...
          },
          {
            ...
            text: 'Subscription fees are generally non-refundable except as required by law or stated in our refund policy',
            textI18n: '@@terms.payment.refund.text',
          },
          {
            strong: 'Price Changes',
            strongI18n: '@@terms.payment.price_changes.strong',
            text: 'We reserve the right to change pricing with 30 days advance notice',
            textI18n: '@@terms.payment.price_changes.text',
          },
          {
            strong: 'Taxes',
            strongI18n: '@@terms.payment.taxes.strong',
            text: 'You are responsible for all applicable taxes, duties, and government charges',
      ...
      },
      {
        ...
        content:
          'Your privacy is important to us. Our Privacy Policy explains in detail how we collect, use, protect, and share your information when you use the Service. By using the Service, you agree to the collection, use, and disclosure of information in accordance with our Privacy Policy. Key points include:',
        contentI18n: '@@terms.privacy.content',
        list: [
          {
            text: 'We collect personal information you provide and technical data automatically',
            textI18n: '@@terms.privacy.collection',
          },
          {
            text: 'We use your data to provide, improve, and personalize the Service',
          ...
          {
            text: 'You have rights to access, correct, delete, and port your data',
      ...
      },
      {
        ...
        list: [
          {
            text: 'Modify, suspend, or discontinue any part of the Service at any time with reasonable notice',
            textI18n: '@@terms.service_availability.modify',
          },
          {
            text: 'Perform scheduled maintenance, updates, and upgrades that may cause temporary interruptions',
            textI18n: '@@terms.service_availability.maintenance',
          },
          {
            text: 'Update these Terms of Service with advance notice for material changes',
            textI18n: '@@terms.service_availability.update_terms',
          },
          {
            text: 'Refuse service to anyone for any lawful reason',
            textI18n: '@@terms.service_availability.refuse_service',
          },
          {
            text: 'Remove, modify, or restrict access to content that violates these terms',
            textI18n: '@@terms.service_availability.remove_content',
          },
          {
            text: 'Change features, functionality, pricing, or service tiers',
            textI18n: '@@terms.service_availability.change_features',
          },
          {
            text: 'Impose usage limits, quotas, or restrictions on certain features',
      ...
      },
      {
        ...
        content:
          'The Service is provided under the following disclaimers and liability limitations:',
        contentI18n: '@@terms.disclaimers.content',
        subsections: [
          {
            title: '9.1 Service Disclaimer',
          ...
          {
            title: '9.2 AI Content Disclaimer',
          ...
          {
            title: '9.3 Third-Party Content and Services',
            titleI18n: '@@terms.disclaimers.third_party.title',
            content:
              'The Service may contain links to third-party websites, services, or content. We are not responsible for the availability, accuracy, content, or practices of third-party services. Your use of third-party services is at your own risk and subject to their terms and policies.',
            contentI18n: '@@terms.disclaimers.third_party.content',
          },
          {
            title: '9.4 Limitation of Liability',
            titleI18n: '@@terms.disclaimers.liability.title',
            content:
              'TO THE MAXIMUM EXTENT PERMITTED BY LAW, IDEM AND ITS OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, SUPPLIERS, AND AFFILIATES SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, REVENUES, DATA, USE, GOODWILL, OR OTHER INTANGIBLE LOSSES, WHETHER INCURRED DIRECTLY OR INDIRECTLY, ARISING FROM: (A) YOUR USE OR INABILITY TO USE THE SERVICE; (B) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SERVERS OR YOUR DATA; (C) ANY INTERRUPTION OR CESSATION OF THE SERVICE; (D) ANY BUGS, VIRUSES, OR HARMFUL CODE; (E) ANY ERRORS OR OMISSIONS IN CONTENT; OR (F) ANY USER CONTENT OR CONDUCT. OUR TOTAL LIABILITY SHALL NOT EXCEED THE AMOUNT YOU PAID US IN THE 12 MONTHS PRECEDING THE CLAIM.',
        ...
        subsections: [
          {
            ...
            content:
              'You may terminate your account at any time by following the account closure process in your settings. Upon termination, your access to the Service will cease, but you remain responsible for any outstanding fees.',
          ...
          },
          {
            ...
            list: [
              {
                text: 'Violation of these Terms of Service or our policies',
                textI18n: '@@terms.termination.by_us.violation',
              },
              {
                text: 'Non-payment of fees or fraudulent payment activity',
                textI18n: '@@terms.termination.by_us.nonpayment',
              },
              {
                text: 'Illegal, fraudulent, or abusive activity',
                textI18n: '@@terms.termination.by_us.illegal',
              },
              {
                text: 'Prolonged inactivity or abandonment of account',
                textI18n: '@@terms.termination.by_us.inactivity',
              },
              {
                text: 'Security concerns or risk to the Service or other users',
                textI18n: '@@terms.termination.by_us.security',
              },
              {
                text: 'Discontinuation of the Service',
      ...
      },
      {
        ...
        content:
          'We reserve the right to modify these Terms of Service at any time. We will provide notice of material changes by posting the updated terms on this page and updating the "Effective Date" at the top. For significant changes, we may provide additional notice such as an email notification or in-app message. Your continued use of the Service after changes take effect constitutes acceptance of the modified terms. If you do not agree to the changes, you must stop using the Service and may terminate your account.',
