...
const CONFIG = {
  ...
  pathToKeyMapping: {
    ...
    'modules/dashboard/components/document-preview': 'dashboard.documentPreview',
    ...
    'modules/dashboard/pages/show-pitch-deck/pitch-deck-new': 'dashboard.pitchDeckTypes',
    'modules/dashboard/pages/deliverable-list': 'dashboard.deliverableList',
