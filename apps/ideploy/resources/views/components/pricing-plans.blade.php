    ...
    <div class="px-6 mx-auto lg:px-8">
        ...
        <div class="flow-root mt-12">
            <div class="pb-10 text-xl text-center">For the detailed list of features, please visit our landing page: <a
                    class="font-bold underline dark:text-white" href="https://ideploy.io">ideploy.io</a></div>
            <div
        ...
        <div class="grid grid-cols-1 gap-10 md:grid-cols-2 gap-y-28">
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    Once you connected your server, Ideploy will start managing it and do a
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    ...
                    you decide to stop using Ideploy, you can still continue to manage your
                    deployed resources.
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    Ideploy will automatically monitor your configured servers and deployed
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    Automatically deploy new commits and pull requests separately to quickly
