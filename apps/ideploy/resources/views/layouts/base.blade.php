...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Hanken+Grotesk:wght@400;600&family=Playfair+Display:wght@600;700;800&family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@500&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        body, html, input, textarea, select, button {
            font-family: 'Vilevile', sans-serif !important;
        }
    </style>
