<div x-data x-init="$wire.loadServers" class="max-w-5xl mx-auto pb-12">
    ...
    @if ($current_step === 'deployment-choice')
        <div class="border border-[rgba(255,255,255,0.05)] rounded-glass overflow-hidden bg-surface-1 flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-[rgba(255,255,255,0.05)]">
