                    ...
                    <div class="flex w-full justify-end gap-2">
                        @if ($isDisabled)
                            <button disabled type="submit"
                                class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg bg-gray-700/40 text-gray-500 border border-gray-700/30 cursor-not-allowed opacity-60">
                            ...
                            <button wire:click='lock'
                                class="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg bg-amber-500/10 text-amber-400 border border-amber-500/25 hover:bg-amber-500/20 transition-colors cursor-pointer">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @else
                            <button type="submit"
                                class="inner-button flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-white rounded-lg">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4"/>
                                </svg>
                                Update
