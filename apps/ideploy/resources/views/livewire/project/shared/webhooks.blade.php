<div>
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-light opacity-70">Configure webhooks to trigger deployments and other actions.</p>
    </div>

    <div class="flex flex-col gap-6">
        {{-- Deploy Webhook Section --}}
        <div class="glass-card p-6">
            <h3 class="text-lg font-semibold text-accent mb-4">Deploy Webhook</h3>
        ...
        @if ($resource->type() === 'application')
            <div class="glass-card p-6">
                <h3 class="text-lg font-semibold text-accent mb-4">Manual Git Webhooks</h3>
