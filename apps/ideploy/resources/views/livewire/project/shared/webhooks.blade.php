<div class="flex flex-col gap-2">
    <div class="flex items-center gap-2">
        <h2>Webhooks</h2>
        <x-helper
            helper="For more details goto our <a class='underline dark:text-white' href='https://ideploy.io/docs/api/operations/deploy-by-tag-or-uuid' target='_blank'>docs</a>." />
    </div>
    <div>
