    ...
    <form wire:submit="submit" class="max-w-7xl pb-32">
            ...
            <div class="relative flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
                <div class="flex-1">
                    <div class="flex items-center gap-4 mb-4">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold text-white mb-1">PostgreSQL Database</h1>
            ...
            <div x-show="expanded" x-collapse x-cloak class="px-6 pb-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <x-forms.input label="Image" id="image" required
                        helper="For all available images, check here:<br><br><a target='_blank' href='https://hub.docker.com/_/postgres'>https://hub.docker.com/_/postgres</a>" canGate="update" :canResource="$database" />
                </div>
            </div>
        </div>
        ...
        <div x-data="{ expanded: false }" class="group relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 hover:border-green-500/50 transition-all duration-300 mb-6">
            ...
            <div x-show="expanded" x-collapse x-cloak class="px-6 pb-6">
                ...
                @else
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <x-forms.input label="Username" id="postgresUser" placeholder="If empty: postgres" canGate="update" :canResource="$database" />
                        <x-forms.input label="Password" id="postgresPassword" type="password" required canGate="update" :canResource="$database" />
                        <x-forms.input label="Initial Database" id="postgresDb"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <x-forms.input label="Host Auth Method" id="postgresHostAuthMethod" 
                        placeholder="If empty, use default. See in docker docs." canGate="update" :canResource="$database" />
                </div>
            </div>
        </div>
                    ...
                    <div class="mx-2">
                        @if ($database->isExited())
                            <x-forms.select id="sslMode" label="SSL Mode" wire:model.live="sslMode"
                                ...
                                helper="Choose the SSL verification mode for PostgreSQL connections" canGate="update" :canResource="$database">
        ...
        <div x-data="{ expanded: false }" class="group relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 hover:border-orange-500/50 transition-all duration-300 mb-6">
            ...
            <div x-show="expanded" x-collapse x-cloak class="px-6 pb-6">
                ...
                <x-forms.textarea label="Custom PostgreSQL Configuration" rows="10" id="postgresConf" canGate="update" :canResource="$database" />
            </div>
        </div>
