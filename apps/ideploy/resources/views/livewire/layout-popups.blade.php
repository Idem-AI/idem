                ...
                if (window.Echo) {
                    if (window.Echo.connector.pusher.connection.state === 'connected') {
                        ...
                        if (checkNumber > 5) {
                            ...
                            console.error(
                                'Ideploy could not connect to its real-time service. This will cause unusual problems on the UI if not fixed! Please check the related documentation (https://ideploy.io/docs/knowledge-base/cloudflare/tunnels/overview) or get help on Discord (https://coollabs.io/discord).)'
                            );
                        }
                ...
                <x-popup>
                    ...
                    <x-slot:description>
                        <div>This will cause unusual problems on the
                            ...
                            <a class="underline" href='https://ideploy.io/docs/knowledge-base/server/firewall'
                ...
                <x-slot:customActions>
                    <div
                        ...
                        <div class="flex flex-col gap-2 lg:px-10 px-1">
                            <div class="lg:text-xl text-md dark:text-white font-bold">Love Ideploy? Support our work.
                            </div>
    ...
    @if (!currentTeam()->isAnyNotificationEnabled())
        <span x-show="popups.notification">
            <x-popup>
                ...
                <x-slot:icon>
                    <svg xmlns="http://www.w3.org/2000/svg" class="text-accent stroke-current w-14 h-14 shrink-0"
                ...
                <x-slot:description>
                    ...
                    notification channel to receive important alerts.<br>Visit <a
                        href="{{ route('notifications.email') }}" class="underline text-accent hover:text-accent/80">/notification</a> to
