    ...
    @else
        <form class="flex flex-col w-full gap-2" wire:submit='submit'>
            ...
            <div class="text-xs dark:text-warning text-coollabs ">Non-root user is experimental: <a
                    ...
                    href="https://ideploy.io/docs/knowledge-base/server/non-root-user">docs</a>.</div>
            ...
            <div class="">
                ...
                <div class="pb-4">Read the docs <a class='underline dark:text-white'
                        href='https://ideploy.io/docs/knowledge-base/docker/swarm' target='_blank'>here</a>.</div>
