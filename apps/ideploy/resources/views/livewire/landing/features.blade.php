<section id="features" class="py-32 px-6 relative z-10">
    <div class="max-w-7xl mx-auto">
        <h1 class="text-4xl md:text-5xl font-black text-white text-center mb-16 drop-shadow-md">Everything you <span class="i-underline">need</span>. <span class="text-white/40">Nothing you don't.</span></h1>
