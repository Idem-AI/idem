    ...
    <div class="max-w-7xl mx-auto flex flex-col gap-32">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="max-w-xl">
                ...
                <h1 class="text-5xl font-black text-white mb-6 leading-tight drop-shadow-md">Push to <span class="i-underline">deploy</span>.<br>It's that simple.</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="order-1 lg:order-2 max-w-xl lg:pl-10">
                ...
                <h1 class="text-5xl font-black text-white mb-6 leading-tight drop-shadow-md">Instantiate DBs<br>in <span class="i-underline">1-Click</span>.</h1>
                <p class="text-xl text-white/60 mb-8 font-medium leading-relaxed">
