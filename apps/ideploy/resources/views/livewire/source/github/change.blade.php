<div>
    @if (data_get($github_app, 'app_id'))
        <form wire:submit='submit'>
            {{-- Header --}}
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-5 border-b border-gray-800/60">
                <div class="flex items-center gap-3">
                    <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-gray-700/60 to-gray-800/40 border border-gray-700/50 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        <h1 class="text-xl font-bold text-white leading-tight">GitHub App</h1>
                        <p class="text-xs text-gray-500 mt-0.5">Private repositories integration</p>
                    </div>
                </div>
                <div class="flex items-center gap-2">
                    @if (data_get($github_app, 'installation_id'))
                        <button canGate="update" type="submit" class="inner-button px-4 py-2 text-sm font-semibold text-white rounded-lg flex items-center gap-2">
