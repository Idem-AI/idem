...
!(function (e, t) {
  ...
  var re = (function t() {
    ...
    o.isSupported =
      'function' == typeof e && 'function' == typeof ae && se && void 0 !== se.createHTMLDocument;
    const {
      MUSTACHE_EXPR: he,
      ERB_EXPR: ge,
      TMPLIT_EXPR: Te,
      ...
      gt = function () {
        ...
        if (!ft || ft !== e) {
          if (
            ((e && 'object' == typeof e) || (e = {}),
            (e = D(e)),
            (ut = -1 === mt.indexOf(e.PARSER_MEDIA_TYPE) ? 'text/html' : e.PARSER_MEDIA_TYPE),
            ...
            e.FORBID_CONTENTS && ($e === Ke && ($e = D($e)), w($e, e.FORBID_CONTENTS, pt)),
            je && (Ne['#text'] = !0),
        ...
        return e instanceof O &&
          ...
          : ('noscript' !== n && 'noembed' !== n && 'noframes' !== n) ||
            ...
            ? (ke &&
                ...
                e.textContent !== t &&
                  (f(o.removed, { element: e.cloneNode() }), (e.textContent = t))),
          ...
          if (
            !(
              (Dt(e) &&
                ...
                ((De.attributeNameCheck instanceof RegExp && S(De.attributeNameCheck, t)) ||
                  (De.attributeNameCheck instanceof Function && De.attributeNameCheck(t)))) ||
              ('is' === t &&
                De.allowCustomizedBuiltInElements &&
      ...
      vt = function (e) {
        ...
        for (; r--; ) {
          ...
          if (
            ...
            (f = n.attrValue),
            !Ye || ('id' !== s && 'name' !== s) || (At(a, e), (f = 'user-content-' + f)),
      ...
      (o.sanitize = function (e) {
        ...
        if ((Pe || gt(t), (o.removed = []), 'string' == typeof e && (Xe = !1), Xe)) {
          if (e.nodeName) {
            ...
            if (!Ne[t] || ve[t]) throw b('root node is forbidden and cannot be sanitized in-place');
          }
          ...
          if (!Fe && !ke && !ze && -1 === e.indexOf('<')) return le && We ? le.createHTML(e) : e;
