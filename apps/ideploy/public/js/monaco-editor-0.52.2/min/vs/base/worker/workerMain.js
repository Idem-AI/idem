    ...
    class i {
      static validateConfigurationOptions(d) {
        ...
        if (
          ...
          d.baseUrl.length > 0 && (W.Utilities.endsWith(d.baseUrl, '/') || (d.baseUrl += '/')),
      ...
      static mergeConfigurationOptions(d = null, f = null) {
        ...
        return (
          W.Utilities.forEachProperty(d, (c, a) => {
            c === 'ignoreDuplicateModules' && typeof p.ignoreDuplicateModules < 'u'
    ...
    class x {
      ...
      _applyPaths(d) {
        ...
        for (let p = 0, c = this.sortedPathsRules.length; p < c; p++)
          if (((f = this.sortedPathsRules[p]), W.Utilities.startsWith(d, f.from))) {
            let a = [];
      ...
      _addUrlArgsIfNecessaryToUrls(d) {
        if (this.options.urlArgs)
          for (let f = 0, p = d.length; f < p; f++) d[f] = this._addUrlArgsToUrl(d[f]);
        return d;
      }
      moduleIdToPaths(d) {
        if (
        ...
        if (!W.Utilities.endsWith(f, '.js') && !W.Utilities.isAbsolutePath(f)) {
          ...
          for (let c = 0, a = p.length; c < a; c++)
            (this.isBuild() && p[c] === 'empty:') ||
              (W.Utilities.isAbsolutePath(p[c]) || (p[c] = this.options.baseUrl + p[c]),
          ...
          if (
            ...
            fetch(m)
              ...
              .then((o) => {
                ((o = `${o}
//# sourceURL=${m}`),
                  (r ? self.eval(r.createScript('', o)) : new Function(o)).call(self),
                  e());
              })
              .then(void 0, h);
            return;
    ...
    class d {
      ...
      _createAndEvalScript(a, m, e, h, r) {
        ...
        return (
          ...
          L ? h() : r(new Error(`Didn't receive define call in ${e.filename}!`)),
          o
        );
      }
      ...
      _createAndWriteCachedData(a, m, e, h) {
        let r = Math.ceil(
            h.getConfig().getOptionsLiteral().nodeCachedData.writeDelay * (1 + Math.random())
          ),
          s = -1,
          o = 0,
          u;
    ...
    class f {
      ...
      enqueueDefineAnonymousModule(c, a) {
        ...
        (this._config.isBuild() && (m = new Error('StackLocation').stack || null),
          (this._currentAnonymousDefineCall = { stack: m, dependencies: c, callback: a }));
      }
            ...
            if ((h++, h >= m.length)) this._onLoadError(c, s);
              ...
              if (this._config.isBuild() && o === 'empty:') {
                ((this._buildInfoPath[c] = o),
                  this.defineModule(this._moduleIdProvider.getStrModuleId(c), [], null, null, null),
                  this._onLoad(c));
                return;
              }
              (u.record(10, o),
          ...
          for (let m = 0, e = a.length; m < e; m++) {
            ...
            if (this._hasDependencyPath(h.id, c.id)) {
              ...
              (s.reverse(),
                s.push(h.id),
                console.warn(
                  s.map((o) => this._moduleIdProvider.getStrModuleId(o)).join(` => 
`)
                ),
                c.unresolvedDependenciesCount--);
              continue;
            ...
            if (
              ((this._inverseDependencies2[h.id] = this._inverseDependencies2[h.id] || []),
              ...
              (o || ((o = []), this._inversePluginDependencies2.set(h.pluginId, o)),
                o.push(h),
  ...
  ((function (W) {
    ...
    const x = function (p, c, a) {
      (typeof p != 'string' && ((a = c), (c = p), (p = null)),
        ...
        p ? i.defineModule(p, c, a, null, null) : i.enqueueDefineAnonymousModule(c, a));
    };
    x.amd = { jQuery: !0 };
    ...
    function f() {
      ...
      n.isNode && !n.isElectronRenderer && !n.isElectronNodeIntegrationWebWorker
        ? (module.exports = d)
        : (n.isElectronRenderer || (W.global.define = x), (W.global.require = d));
    }
    ((W.init = f),
    ...
    (function () {
      ...
      function A() {
        try {
          return (
            (x ? globalThis.eval(x.createScript('', 'true')) : new Function('true')).call(
              globalThis
            ),
            !0
          );
          ...
          if (
            ...
            fetch(r)
              ...
              .then((o) => {
                ((o = `${o}
//# sourceURL=${r}`),
                  (x ? globalThis.eval(x.createScript('', o)) : new Function(o)).call(globalThis),
                  e());
              })
              .then(void 0, h);
            return;
      ...
      function c(e) {
        setTimeout(function () {
          ...
          for (self.onmessage = (r) => h.onmessage(r.data, r.ports); m.length > 0; )
    ...
    X(J[7], Z([0, 1]), function (W, n) {
      ...
      function* m(F, q) {
        let B, G;
        for (const $ of F)
          (G !== void 0 && q(G, $) ? B.push($) : (B && (yield B), (B = [$])), (G = $));
        B && (yield B);
      }
      function e(F, q) {
      ...
      function h(F, q) {
        for (let B = 0; B < F.length; B++)
          q(B === 0 ? void 0 : F[B - 1], F[B], B + 1 === F.length ? void 0 : F[B + 1]);
      }
      function r(F) {
        return F.filter((q) => !!q);
      }
      ...
      class z {
        ...
        findLastMaxBy(q) {
          let B,
            G = !0;
          return (
            this.iterate(($) => ((G || y.isGreaterThan(q($, B))) && ((G = !1), (B = $)), !0)),
            B
          );
        }
      }
      ...
      class A {
        ...
        static fromRGBA(c) {
          ...
          const S = (s + r) / 2,
            L = r - s;
          if (L > 0) {
            switch (((u = Math.min(S <= 0.5 ? L / (2 * S) : L / (2 - 2 * S), 1)), r)) {
              case a:
                o = (m - e) / L + (m < e ? 6 : 0);
                break;
              case m:
      ...
      class f {
        ...
        constructor(c) {
          if (c)
            ...
            else if (c instanceof A) ((this._hsla = c), (this.rgba = A.toRGBA(c)));
            else if (c instanceof d) ((this._hsva = c), (this.rgba = d.toRGBA(c)));
...
` +
    ...
    X(J[19], Z([0, 1]), function (W, n) {
      ...
      (function (x) {
        ...
        function* P(l, b, g = l.length) {
          for (
            b < 0 && (b += l.length), g < 0 ? (g += l.length) : g > l.length && (g = l.length);
            b < g;
            b++
          )
            yield l[b];
    ...
    X(J[20], Z([0, 1]), function (W, n) {
      ...
      class x {
        ...
        _insert(d, f) {
          const p = new i(d);
          if (this._first === i.Undefined) ((this._first = p), (this._last = p));
          else if (f) {
            const a = this._last;
          ...
          if (d.prev !== i.Undefined && d.next !== i.Undefined) {
            ...
            d.prev === i.Undefined && d.next === i.Undefined
              ...
              : d.next === i.Undefined
                ...
                : d.prev === i.Undefined &&
                  ((this._first = this._first.next), (this._first.prev = i.Undefined));
          this._size -= 1;
        }
        *[Symbol.iterator]() {
          let d = this._first;
    ...
    X(J[21], Z([0, 1]), function (W, n) {
      ...
      class p {
        ...
        forEach(r, s) {
          ...
          let u = this._head;
          for (; u; ) {
            if ((s ? r.bind(s)(u.value, u.key, this) : r(u.value, u.key, this), this._state !== o))
        ...
        addItemFirst(r) {
          ...
          else if (this._head) ((r.next = this._head), (this._head.previous = r));
          else throw new Error('Invalid list');
          ((this._head = r), this._state++);
        }
        addItemLast(r) {
          if (!this._head && !this._tail) this._head = r;
          else if (this._tail) ((r.previous = this._tail), (this._tail.next = r));
          else throw new Error('Invalid list');
          ((this._tail = r), this._state++);
        }
        removeItem(r) {
          if (r === this._head && r === this._tail) ((this._head = void 0), (this._tail = void 0));
    ...
    X(J[22], Z([0, 1]), function (W, n) {
      ...
      class x {
        ...
        constructor(d) {
          ((this._now =
            i && d === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance)),
    ...
    X(J[9], Z([0, 1, 3, 18, 8, 20, 22]), function (W, n, i, x, A, d, f) {
      ...
      (function (C) {
        ...
        function Ee(K) {
          return (Q, k, I) => {
            ...
            return (
              I instanceof A.DisposableStore ? I.add(te) : Array.isArray(I) && I.push(te),
              te
            );
          };
        }
      ...
      class r {
        ...
        check(R, D) {
          ...
          if (
            (this._stacks.set(R.value, O + 1), (this._warnCountdown -= 1), this._warnCountdown <= 0)
          ) {
          ...
          ((this._size = 0),
            ...
            (this._leakageMon =
              h > 0 || this._options?.leakWarningThreshold
                ...
                : void 0),
            (this._perfMon = this._options?._profName ? new e(this._options._profName) : void 0),
          ...
          return (
            (this._event ??= (R, D, T) => {
              ...
              (this._leakageMon &&
                ...
                ((O.stack = s.create()), (z = this._leakageMon.check(O.stack, this._size + 1))),
                c && (O.stack = j ?? s.create()),
                this._listeners
                  ? this._listeners instanceof S
                    ? ((this._deliveryQueue ??= new l()), (this._listeners = [this._listeners, O]))
...
`
                    ...
                    .trim(),
                  B = /(file:|vscode-file:\/\/vscode-app)?(\/[^:]*:\d+:\d+)/.exec(q);
          ...
          if (this._size * L <= D.length) {
            ...
            for (let j = 0; j < D.length; j++)
              D[j]
                ? (D[z++] = D[j])
                : O &&
                  (this._deliveryQueue.end--, z < this._deliveryQueue.i && this._deliveryQueue.i--);
            D.length = z;
          }
        }
        _deliver(R, D) {
            ...
            R(
              (F) => {
                ...
                ((B.items ??= []),
                  ...
                  B.buffers.length === 0 &&
                    q.buffers.push(() => {
                      ((B.reducedResult ??= T ? B.items.reduce(D, T) : B.items.reduce(D)),
    ...
    X(J[23], Z([0, 1, 9]), function (W, n, i) {
      ...
      class d {
        ...
        get onCancellationRequested() {
          return this._isCancelled
            ? x
            : (this._emitter || (this._emitter = new i.Emitter()), this._emitter.event);
        }
        dispose() {
    ...
    X(J[6], Z([0, 1, 39, 43]), function (W, n, i, x) {
      ...
      function u(k) {
        return k.source === '^' || k.source === '^$' || k.source === '$' || k.source === '^\\s*$'
          ? !1
      ...
      function me(k) {
        return (
          (k >= 11904 && k <= 55215) || (k >= 63744 && k <= 64255) || (k >= 65281 && k <= 65374)
        );
      }
      function pe(k) {
        return (
      ...
      function Ce(k) {
        return (
          (k = k % (2 * 26)),
          k < 26 ? String.fromCharCode(97 + k) : String.fromCharCode(65 + k - 26)
        );
      }
      function ve(k, I) {
        return k === 0
      ...
      class K {
        ...
        static {
          this._locales = new x.Lazy(() =>
            Object.keys(K.ambiguousCharacterData.value).filter((I) => !I.startsWith('_'))
          );
        }
        static getLocales() {
        ...
        _push(u, S, L) {
          return (
            L < 128
              ? (u[S++] = L)
              : L < 2048
                ? ((u[S++] = 192 | ((L & 1984) >>> 6)), (u[S++] = 128 | ((L & 63) >>> 0)))
                : L < 65536
                  ? ((u[S++] = 224 | ((L & 61440) >>> 12)),
                    (u[S++] = 128 | ((L & 4032) >>> 6)),
                    (u[S++] = 128 | ((L & 63) >>> 0)))
    ...
    X(J[24], Z([0, 1, 41, 44]), function (W, n, i, x) {
      ...
      class a {
        ...
        ElementsAreEqual(e, h) {
          return this._originalElementsOrHash[e] !== this._modifiedElementsOrHash[h]
            ? !1
            : this._hasStrings
              ? this._originalStringElements[e] === this._modifiedStringElements[h]
              : !0;
        }
        ...
        OriginalElementsAreEqual(e, h) {
          return this._originalElementsOrHash[e] !== this._originalElementsOrHash[h]
            ? !1
            : this._hasStrings
              ? this._originalStringElements[e] === this._originalStringElements[h]
              : !0;
        }
        ModifiedElementsAreEqual(e, h) {
          return this._modifiedElementsOrHash[e] !== this._modifiedElementsOrHash[h]
            ? !1
            : this._hasStrings
              ? this._modifiedStringElements[e] === this._modifiedStringElements[h]
              : !0;
        }
        ComputeDiff(e) {
        ...
        ComputeDiffRecursive(e, h, r, s, o) {
          ...
          if (e > h || r > s) {
            ...
            return (
              r <= s
                ? (f.Assert(e === h + 1, 'originalStart should only be one more than originalEnd'),
                ...
                : e <= h
                  ...
                  : (f.Assert(
                    ...
                    f.Assert(r === s + 1, 'modifiedStart should only be one more than modifiedEnd'),
                    (E = [])),
              E
            );
          }
          ...
          if (!o[0]) {
            ...
            return (
              o[0]
                ? (v = [new i.DiffChange(N + 1, h - (N + 1) + 1, P + 1, s - (P + 1) + 1)])
        ...
        WALKTRACE(e, h, r, s, o, u, S, L, N, P, E, v, l, b, g, w, M, y) {
          ...
          do {
            ...
            (F === D || (F < T && N[F - 1] < N[F + 1])
              ...
              : ((E = N[F - 1] + 1),
                ...
                (O = F - 1 - e)),
              j >= 0 && ((N = this.m_forwardHistory[j]), (e = N[0]), (D = 1), (T = N.length - 1)));
          } while (--j >= -1);
          if (((_ = R.getReverseChanges()), y[0])) {
            ...
            ((R = new c()),
              ...
              (O = l[0] - w[0] - L),
              (z = 1073741824),
              (j = M ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2));
            do {
              const F = O + o;
              (F === D || (F < T && P[F - 1] >= P[F + 1])
                ? ((E = P[F + 1] - 1),
                ...
                : ((E = P[F - 1]),
                  ...
                  (O = F - 1 - o)),
                j >= 0 &&
                  ((P = this.m_reverseHistory[j]), (o = P[0]), (D = 1), (T = P.length - 1)));
            } while (--j >= -1);
            C = R.getChanges();
          }
        ...
        ComputeRecursionPoint(e, h, r, s, o, u, S) {
          ...
          for (let O = 1; O <= b / 2 + 1; O++) {
            ...
            for (let q = P; q <= E; q += 2) {
              (q === P || (q < E && w[q - 1] < w[q + 1]) ? (L = w[q + 1]) : (L = w[q - 1] + 1),
                (N = L - (q - y) - C));
              const B = L;
              ...
              if (
                ...
                return (
                  ...
                  (u[0] = N),
                  B <= M[q] && O <= 1448
                    ? this.WALKTRACE(y, P, E, C, _, v, l, R, w, M, L, h, o, N, s, u, T, S)
                    : null
                );
            }
            const F = (z - e + (j - r) - O) / 2;
            ...
            for (let q = v; q <= l; q += 2) {
              (q === v || (q < l && M[q - 1] >= M[q + 1]) ? (L = M[q + 1] - 1) : (L = M[q - 1]),
                (N = L - (q - _) - R));
              const B = L;
        ...
        PrettifyChanges(e) {
          for (let h = 0; h < e.length; h++) {
            const r = e[h],
              s = h < e.length - 1 ? e[h + 1].originalStart : this._originalElementsOrHash.length,
          ...
          for (let h = e.length - 1; h >= 0; h--) {
            ...
            for (let E = 1; ; E++) {
              ...
              if (
                v < s ||
                l < o ||
                (u && !this.OriginalElementsAreEqual(v, v + r.originalLength)) ||
    ...
    X(J[25], Z([0, 1]), function (W, n) {
      ...
      function o(u, S) {
        if (i(S)) {
          ...
          if ((!m(u) && u.constructor === S) || (S.length === 1 && S.call(void 0, u) === !0))
            return;
          throw new Error(
    ...
    X(J[27], Z([0, 1, 25]), function (W, n, i) {
      ...
      function m(r) {
        ...
        for (; Object.prototype !== r; )
          ((s = s.concat(Object.getOwnPropertyNames(r))), (r = Object.getPrototypeOf(r)));
        return s;
      }
      function e(r) {
        const s = [];
    ...
    X(J[5], Z([0, 1, 3]), function (W, n, i) {
      ...
      class x {
        ...
        clip(f) {
          if (this.isEmpty)
            throw new i.BugIndicatingError(`Invalid clipping range: ${this.toString()}`);
      ...
      class A {
        ...
        addRange(f) {
          ...
          for (; p < this._sortedRanges.length && this._sortedRanges[p].endExclusive < f.start; )
            p++;
          let c = p;
          for (; c < this._sortedRanges.length && this._sortedRanges[c].start <= f.endExclusive; )
            c++;
    ...
    X(J[4], Z([0, 1]), function (W, n) {
      ...
      class i {
        ...
        static equals(A, d) {
          return !A && !d
            ? !0
            : !!A && !!d && A.lineNumber === d.lineNumber && A.column === d.column;
        }
        isBefore(A) {
      ...
      class x {
        ...
        static containsRange(d, f) {
          return !(
            ...
            (f.startLineNumber === d.startLineNumber && f.startColumn < d.startColumn) ||
        ...
        static plusRange(d, f) {
          ...
          return (
            f.startLineNumber < d.startLineNumber
              ...
              : f.startLineNumber === d.startLineNumber
                ? ((p = f.startLineNumber), (c = Math.min(f.startColumn, d.startColumn)))
                : ((p = d.startLineNumber), (c = d.startColumn)),
            f.endLineNumber > d.endLineNumber
              ? ((a = f.endLineNumber), (m = f.endColumn))
              : f.endLineNumber === d.endLineNumber
                ? ((a = f.endLineNumber), (m = Math.max(f.endColumn, d.endColumn)))
        ...
        static areIntersectingOrTouching(d, f) {
          return !(
            ...
            (d.endLineNumber === f.startLineNumber && d.endColumn < f.startColumn) ||
            f.endLineNumber < d.startLineNumber ||
            (f.endLineNumber === d.startLineNumber && f.endColumn < d.startColumn)
          );
        }
    ...
    X(J[13], Z([0, 1, 3, 5, 2, 15]), function (W, n, i, x, A, d) {
      ...
      class p {
          ...
          for (; e < this._normalizedRanges.length || h < a._normalizedRanges.length; ) {
            ...
            r === null
              ...
              : r.endLineNumberExclusive >= s.startLineNumber
                ? (r = new f(
                    r.startLineNumber,
                    Math.max(r.endLineNumberExclusive, s.endLineNumberExclusive)
                  ))
                : (m.push(r), (r = s));
          }
        ...
        subtractFrom(a) {
          ...
          return (
            r < a.endLineNumberExclusive && h.push(new f(r, a.endLineNumberExclusive)),
            new p(h)
          );
        }
        toString() {
...
`
        ...
        createRange(f) {
          return this.lineCount === 0
            ? new x.Range(f.lineNumber, f.column, f.lineNumber, f.column + this.columnCount)
            : new x.Range(
                f.lineNumber,
                f.column,
        ...
        addToPosition(f) {
          return this.lineCount === 0
            ...
            : new i.Position(f.lineNumber + this.lineCount, this.columnCount + 1);
        }
        toString() {
...
` && this.lineStartOffsetByLineIdx.push(p + 1);
    ...
    X(J[50], Z([0, 1, 12, 3, 4, 49, 2, 30]), function (W, n, i, x, A, d, f, p) {
      'use strict';
      (Object.defineProperty(n, '__esModule', { value: !0 }),
        (n.StringText = n.AbstractText = n.SingleTextEdit = n.TextEdit = void 0));
      class c {
        constructor(s) {
          ((this.edits = s),
            (0, i.assertFn)(() =>
              (0, i.checkAdjacentItems)(s, (o, u) =>
                o.range.getEndPosition().isBeforeOrEqual(u.range.getStartPosition())
              )
            ));
        }
        apply(s) {
      ...
      n.SingleTextEdit = a;
      function m(r, s) {
        if (r.lineNumber === s.lineNumber && r.column === Number.MAX_SAFE_INTEGER)
        ...
        _getIntlSegmenterWordsOnLine(c) {
          return this._segmenter
            ? this._cachedLine === c
              ? this._cachedSegments
              : ((this._cachedLine = c),
                (this._cachedSegments = this._filterWordSegments(this._segmenter.segment(c))),
                this._cachedSegments)
            : [];
        }
    ...
    X(J[10], Z([0, 1, 7, 3, 5]), function (W, n, i, x, A) {
      ...
      class d {
        static trivial(e, h) {
          return new d(
            [new f(A.OffsetRange.ofLength(e.length), A.OffsetRange.ofLength(h.length))],
            !1
          );
        }
            ...
            (0, i.forEachAdjacent)(e, (s, o) => {
              r.push(
                f.fromOffsetPairs(
                  ...
                  o
                    ? o.getStarts()
                    : new p(h, (s ? s.seq2Range.endExclusive - s.seq1Range.endExclusive : 0) + h)
                )
              );
            }),
            r
      ...
      class A {
        compute(a, m, e = x.InfiniteTimeout.instance) {
          ...
          const h = a,
            r = m;
          function s(l, b) {
            for (; l < h.length && b < r.length && h.getElement(l) === r.getElement(b); )
              (l++, b++);
            return l;
          }
          let o = 0;
          ...
          for (;;) {
            ...
            if (
              ((l !== E || b !== v) &&
                P.push(new x.SequenceDiff(new i.OffsetRange(l, E), new i.OffsetRange(b, v))),
              !N)
            )
              break;
    ...
    X(J[52], Z([0, 1, 7, 5, 10]), function (W, n, i, x, A) {
          ...
          if (E.seq1Range.isEmpty || E.seq2Range.isEmpty) {
            ...
            for (
              ...
              !(
                ...
                o.getElement(E.seq2Range.start - l) !== o.getElement(E.seq2Range.endExclusive - l)
              );
              l++
            );
            if ((l--, l === v)) {
              S[S.length - 1] = new A.SequenceDiff(
                new x.OffsetRange(P.seq1Range.start, E.seq1Range.endExclusive - v),
                new x.OffsetRange(P.seq2Range.start, E.seq2Range.endExclusive - v)
              );
              continue;
            }
            E = E.delta(-l);
        ...
        for (let N = 0; N < S.length - 1; N++) {
          ...
          if (E.seq1Range.isEmpty || E.seq2Range.isEmpty) {
            ...
            for (
              ...
              l < v &&
              !(
                !s.isStronglyEqual(E.seq1Range.start + l, E.seq1Range.endExclusive + l) ||
                !o.isStronglyEqual(E.seq2Range.start + l, E.seq2Range.endExclusive + l)
              );
              l++
            );
            if (l === v) {
              S[N + 1] = new A.SequenceDiff(
                new x.OffsetRange(E.seq1Range.start + v, P.seq1Range.endExclusive),
                new x.OffsetRange(E.seq2Range.start + v, P.seq2Range.endExclusive)
              );
              continue;
            }
            l > 0 && (E = E.delta(l));
      ...
      function c(s, o, u, S, L) {
        ...
        for (
          ...
          u.isStronglyEqual(s.seq2Range.start - P, s.seq2Range.endExclusive - P) &&
          P < 100;
        ...
        for (
          ...
          u.isStronglyEqual(s.seq2Range.start + E, s.seq2Range.endExclusive + E) &&
          E < 100;
      ...
      function m(s, o, u) {
        ...
        function P(v, l) {
          ...
          for (; S.length > 0; ) {
            const C = S[0];
            if (!(C.seq1Range.intersects(w.seq1Range) || C.seq2Range.intersects(w.seq2Range)))
              break;
          ...
          (y + _ < ((w.seq1Range.length + w.seq2Range.length) * 2) / 3 && L.push(w),
      ...
      function e(s, o) {
        ...
        for (; s.length > 0 || o.length > 0; ) {
          const S = s[0],
            L = o[0];
          let N;
          (S && (!L || S.seq1Range.start < L.seq1Range.start) ? (N = s.shift()) : (N = o.shift()),
            u.length > 0 && u[u.length - 1].seq1Range.endExclusive >= N.seq1Range.start
        ...
        do {
          ...
          for (let v = 1; v < S.length; v++) {
            let g = function (M, y) {
              ...
              return (
                Math.pow(Math.pow($(D * 40 + T), 1.5) + Math.pow($(O * 40 + z), 1.5), 1.5) +
                  Math.pow(Math.pow($(j * 40 + F), 1.5) + Math.pow($(q * 40 + B), 1.5), 1.5) >
                (G ** 1.5) ** 1.5 * 1.3
              );
            };
            const l = S[v],
        ...
        return (
          (0, i.forEachWithNeighbors)(S, (E, v, l) => {
            ...
            const _ = A.SequenceDiff.fromOffsetPairs(
              ...
              C = b.intersect(_);
            P.length > 0 && C.getStarts().equals(P[P.length - 1].getEndExclusives())
...
`);
    ...
    X(J[54], Z([0, 1, 5, 10, 16]), function (W, n, i, x, A) {
      ...
      class d {
        compute(p, c, a = x.InfiniteTimeout.instance, m) {
            ...
            for (let E = 0; E < c.length; E++) {
              ...
              p.getElement(P) === c.getElement(E)
                ? (P === 0 || E === 0 ? (b = 0) : (b = e.get(P - 1, E - 1)),
                  P > 0 && E > 0 && h.get(P - 1, E - 1) === 3 && (b += r.get(P - 1, E - 1)),
                  (b += m ? m(P, E) : 1))
                : (b = -1);
          ...
          function S(P, E) {
            ((P + 1 !== o || E + 1 !== u) &&
              s.push(new x.SequenceDiff(new i.OffsetRange(P + 1, o), new i.OffsetRange(E + 1, u))),
              (o = P),
              (u = E));
          }
          let L = p.length - 1,
            N = c.length - 1;
          for (; L >= 0 && N >= 0; )
            h.get(L, N) === 3 ? (S(L, N), L--, N--) : h.get(L, N) === 1 ? L-- : N--;
    ...
    X(J[33], Z([0, 1, 15, 5, 4, 2, 16]), function (W, n, i, x, A, d, f) {
      ...
      class p {
        ...
        extendToFullLines(r) {
          const s =
              (0, i.findLastMonotonous)(this.firstElementOffsetByLineIdx, (u) => u <= r.start) ?? 0,
            o =
      ...
      class p {
        ...
        toRangeMapping() {
          ...
          if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
            ...
            return new e(
              ...
              new d.Range(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1)
            );
          } else
            return new e(
              new d.Range(
        ...
        toRangeMapping2(r, s) {
          ...
          if (!this.original.isEmpty && !this.modified.isEmpty)
            return new e(
              d.Range.fromPositions(
                ...
                c(
                  new A.Position(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER),
                  r
                )
              ),
              d.Range.fromPositions(
                ...
                c(
                  new A.Position(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER),
                  s
                )
              )
            );
          if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1)
            return new e(
              d.Range.fromPositions(
                c(new A.Position(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), r),
                c(
                  new A.Position(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER),
                  r
                )
              ...
              d.Range.fromPositions(
                c(new A.Position(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), s),
                c(
                  new A.Position(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER),
                  s
                )
          ...
          for (let s = 1; s < r.length; s++) {
            ...
            if (
              !(
                ...
                o.modifiedRange.getEndPosition().isBeforeOrEqual(u.modifiedRange.getStartPosition())
              )
            )
...
`).length >= 15 && r(C, (D) => D.length >= 2) >= 2
        ...
        function s(N, P, E, v) {
          const l = [],
            b = N.filter((M) => M.modified.isEmpty && M.original.length >= 3).map(
              (M) => new a.LineRangeFragment(M.original, P, M)
            ),
            g = new Set(
        ...
        function o(N, P, E, v, l, b) {
          ...
          for (const R of N) {
            ...
            for (
              ...
              (w.forEach(O, ({ range: F }) => {
                for (const B of D)
                  if (
                    B.originalLineRange.endLineNumberExclusive + 1 === F.endLineNumberExclusive &&
          ...
          M.sort(
            (0, A.reverseOrder)(
              (0, A.compareBy)((R) => R.modifiedLineRange.length, A.numberComparator)
            )
          );
          ...
          for (let R = 0; R < g.length; R++) {
            const D = g[R],
              ...
              j = C.findLastMonotonous(
                ($) => $.original.startLineNumber < D.original.endLineNumberExclusive
              ),
              F = (0, d.findLastMonotonous)(
                N,
                ($) => $.modified.startLineNumber < D.modified.endLineNumberExclusive
              ),
              q = Math.max(
                j.original.endLineNumberExclusive - D.original.endLineNumberExclusive,
                F.modified.endLineNumberExclusive - D.modified.endLineNumberExclusive
              );
            let B;
            for (B = 0; B < z; B++) {
            ...
            B > 0 &&
              (_.addRange(
                new p.LineRange(D.original.startLineNumber - B, D.original.startLineNumber)
              ),
              y.addRange(
                new p.LineRange(D.modified.startLineNumber - B, D.modified.startLineNumber)
              ));
            let G;
            for (G = 0; G < q; G++) {
        ...
        function u(N, P, E) {
          ...
          const l = new m.MyersDiffAlgorithm().compute(
            new c.LinesSliceCharSequence([N], new e.Range(1, 1, 1, N.length), !1),
            new c.LinesSliceCharSequence([P], new e.Range(1, 1, 1, P.length), !1),
            E
          );
          let b = 0;
        ...
        function S(N) {
          ...
          for (let E = 1; E < N.length; E++) {
            const v = P[P.length - 1],
              l = N[E],
              b = l.original.startLineNumber - v.original.endLineNumberExclusive,
            ...
            (P = P.filter((v) => {
              const l =
                  E.findLastMonotonous(
                    (w) => w.original.startLineNumber < v.original.endLineNumberExclusive
                  ) || new x.LineRangeMapping(new p.LineRange(1, 1), new p.LineRange(1, 1)),
                b = (0, d.findLastMonotonous)(
                  N,
                  (w) => w.modified.startLineNumber < v.modified.endLineNumberExclusive
                );
              return l !== b;
            })),
            P
    ...
    X(
      ...
      function (W, n, i, x, A, d, f, p, c, a, m, e, h, r, s, o) {
        ...
        class u {
          constructor() {
            ((this.dynamicProgrammingDiffing = new c.DynamicProgrammingDiffing()),
              (this.myersDiffingAlgorithm = new a.MyersDiffAlgorithm()));
          }
          computeDiff(E, v, l) {
            if (E.length <= 1 && (0, i.equals)(E, v, ($, U) => $ === U))
              return new s.LinesDiff([], [], !1);
            if ((E.length === 1 && E[0].length === 0) || (v.length === 1 && v[0].length === 0))
          ...
          computeMoves(E, v, l, b, g, w, M) {
            return (0, m.computeMovedLines)(E, v, l, b, g, w).map((C) => {
              const R = this.refineDiff(
                  v,
                  l,
                  new p.SequenceDiff(C.original.toOffsetRange(), C.modified.toOffsetRange()),
                  w,
                  M
                ),
          ...
          refineDiff(E, v, l, b, g) {
            ...
            const T = D.map(
              (O) =>
                new o.RangeMapping(y.translateRange(O.seq1Range), _.translateRange(O.seq2Range))
            );
        ...
        function S(P, E, v, l = !1) {
          ...
          for (const g of (0, i.groupAdjacentBy)(
            P.map((w) => L(w, E, v)),
            (w, M) => w.original.overlapOrTouch(M.original) || w.modified.overlapOrTouch(M.modified)
          )) {
            const w = g[0],
              M = g[g.length - 1];
            b.push(
          ...
          return (
            (0, x.assertFn)(() =>
              !l &&
              b.length > 0 &&
              (b[0].modified.startLineNumber !== b[0].original.startLineNumber ||
                ...
                : (0, x.checkAdjacentItems)(
                    b,
                    (g, w) =>
                      w.original.startLineNumber - g.original.endLineNumberExclusive ===
                        w.modified.startLineNumber - g.modified.endLineNumberExclusive &&
                      g.original.endLineNumberExclusive < w.original.startLineNumber &&
                      g.modified.endLineNumberExclusive < w.modified.startLineNumber
                  )
            ),
            b
          );
        ...
        function L(P, E, v) {
          ...
          (P.modifiedRange.endColumn === 1 &&
            ...
            P.originalRange.startLineNumber + l <= P.originalRange.endLineNumber &&
            P.modifiedRange.startLineNumber + l <= P.modifiedRange.endLineNumber &&
            (b = -1),
            P.modifiedRange.startColumn - 1 >= v[P.modifiedRange.startLineNumber - 1].length &&
              P.originalRange.startColumn - 1 >= E[P.originalRange.startLineNumber - 1].length &&
              P.originalRange.startLineNumber <= P.originalRange.endLineNumber + b &&
              P.modifiedRange.startLineNumber <= P.modifiedRange.endLineNumber + b &&
              (l = 1));
        ...
        function N(P) {
          return new o.LineRangeMapping(
            new A.LineRange(P.seq1Range.start + 1, P.seq1Range.endExclusive + 1),
            new A.LineRange(P.seq2Range.start + 1, P.seq2Range.endExclusive + 1)
          );
        }
      }
    ),
    X(J[57], Z([0, 1, 24, 34, 17, 6, 2, 12, 13]), function (W, n, i, x, A, d, f, p, c) {
        ...
        computeDiff(v, l, b) {
          ...
          for (const _ of w.changes) {
            ...
            _.originalEndLineNumber === 0
              ? (C = new c.LineRange(_.originalStartLineNumber + 1, _.originalStartLineNumber + 1))
              : (C = new c.LineRange(_.originalStartLineNumber, _.originalEndLineNumber + 1));
            let R;
            _.modifiedEndLineNumber === 0
              ? (R = new c.LineRange(_.modifiedStartLineNumber + 1, _.modifiedStartLineNumber + 1))
              : (R = new c.LineRange(_.modifiedStartLineNumber, _.modifiedEndLineNumber + 1));
            ...
            (y &&
              (y.modified.endLineNumberExclusive === D.modified.startLineNumber ||
                y.original.endLineNumberExclusive === D.original.startLineNumber) &&
              ((D = new A.DetailedLineRangeMapping(
                y.original.join(D.original),
                y.modified.join(D.modified),
                y.innerChanges && D.innerChanges ? y.innerChanges.concat(D.innerChanges) : void 0
              )),
              M.pop()),
              M.push(D),
              (y = D));
          ...
          return (
            (0, p.assertFn)(() =>
              (0, p.checkAdjacentItems)(
                M,
                (_, C) =>
                  C.original.startLineNumber - _.original.endLineNumberExclusive ===
                    C.modified.startLineNumber - _.modified.endLineNumberExclusive &&
                  _.original.endLineNumberExclusive < C.original.startLineNumber &&
                  _.modified.endLineNumberExclusive < C.modified.startLineNumber
              )
            ),
      ...
      class h {
        ...
        getElements() {
          ...
          for (let l = 0, b = this.lines.length; l < b; l++)
            v[l] = this.lines[l].substring(this._startColumns[l] - 1, this._endColumns[l] - 1);
          return v;
        }
        getStrictElement(v) {
          return this.lines[v];
        ...
        getEndLineNumber(v) {
          return v === -1
            ...
            : (this._assertIndex(v, this._lineNumbers),
              this._charCodes[v] === 10 ? this._lineNumbers[v] + 1 : this._lineNumbers[v]);
        }
        getStartColumn(v) {
      ...
      function o(E) {
        ...
        for (let b = 1, g = E.length; b < g; b++) {
          ...
          Math.min(M, y) < a
            ? ((l.originalLength = w.originalStart + w.originalLength - l.originalStart),
              (l.modifiedLength = w.modifiedStart + w.modifiedLength - l.modifiedStart))
            : (v.push(w), (l = w));
        }
        return v;
      }
          ...
          if (
            (l.originalLength === 0
              ...
              : ((_ = b.getStartLineNumber(l.originalStart)),
                (C = b.getEndLineNumber(l.originalStart + l.originalLength - 1))),
            l.modifiedLength === 0
              ? ((R = g.getStartLineNumber(l.modifiedStart) - 1), (D = 0))
              : ((R = g.getStartLineNumber(l.modifiedStart)),
                (D = g.getEndLineNumber(l.modifiedStart + l.modifiedLength - 1))),
            M &&
              l.originalLength > 0 &&
              l.originalLength < 20 &&
              l.modifiedLength > 0 &&
      ...
      class S {
        constructor(v, l, b) {
          ((this.shouldComputeCharChanges = b.shouldComputeCharChanges),
            ...
            (this.continueCharDiff = P(
              b.maxComputationTime === 0 ? 0 : Math.min(b.maxComputationTime, 5e3)
            )));
        }
        computeDiff() {
              ...
              if (T !== O) {
                {
                  ...
                  (z > 1 || j > 1) &&
                    this._pushTrimWhitespaceCharChange(g, w + 1, 1, z, M + 1, 1, j);
                }
                {
                  let z = N(T, 1),
                    j = N(O, 1);
                  ...
                  (z < F || j < q) &&
                    this._pushTrimWhitespaceCharChange(g, w + 1, z, F, M + 1, j, q);
                }
              }
              (w++, M++);
            }
        ...
        _pushTrimWhitespaceCharChange(v, l, b, g, w, M, y) {
          ...
          let _;
          (this.shouldComputeCharChanges && (_ = [new s(l, b, l, g, w, M, w, y)]),
          ...
          return C.originalEndLineNumber === 0 || C.modifiedEndLineNumber === 0
            ...
            : C.originalEndLineNumber === l && C.modifiedEndLineNumber === w
              ? (this.shouldComputeCharChanges &&
                ...
                !0)
              : C.originalEndLineNumber + 1 === l && C.modifiedEndLineNumber + 1 === w
    ...
    X(J[59], Z([0, 1, 40]), function (W, n, i) {
      ...
      function c(h, r, s) {
        ...
        const u = r[0].values(),
          S = x(u),
          L = new i.Color(new i.HSLA(S[0], S[1] / 100, S[2] / 100, s ? S[3] : 1));
      ...
      function e(h) {
        return !h || typeof h.getValue != 'function' || typeof h.positionAt != 'function'
          ? []
          : m(h);
      }
    }),
      ...
      class f {
        ...
        constructor(s) {
          ((this._textModelResolvedOptionsBrand = void 0),
            ...
            (this.bracketPairColorizationOptions = s.bracketPairColorizationOptions));
        }
        equals(s) {
          return (
            ...
            this.trimAutoWhitespace === s.trimAutoWhitespace &&
            (0, i.equals)(this.bracketPairColorizationOptions, s.bracketPairColorizationOptions)
          );
        }
        createChangeEvent(s) {
          return {
    ...
    X(J[63], Z([0, 1, 7, 28]), function (W, n, i, x) {
      ...
      class A {
        ...
        insertValues(c, a) {
          ...
          return h === 0
            ...
            : ((this.values = new Uint32Array(m.length + h)),
              ...
              this.values.set(a, c),
              c - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = c - 1),
        ...
        _getPrefixSum(c) {
          ...
          return (
            (this.prefixSumValidIndex[0] = Math.max(this.prefixSumValidIndex[0], c)),
            this.prefixSum[c]
          );
        }
        getIndexOf(c) {
...
`) >= 0);
          ...
          return (
            ...
            new f.SearchData(
              N,
              this.wordSeparators ? (0, x.getMapForWordSeparators)(this.wordSeparators, []) : null,
      ...
      class h {
        static findMatches(L, N, P, E, v) {
          ...
          return l
            ? l.regex.multiline
              ? this._doFindMatchesMultiline(L, P, new u(l.wordSeparators, l.regex), E, v)
...
`
          ...
          for (P.reset(0); (y = P.next(b)); )
            if (
              ((w[M++] = m(this._getMultilineMatchRange(L, l, b, g, y.index, y[0]), y, E)), M >= v)
            )
              return w;
          return w;
        }
        static _doFindMatchesLineByLine(L, N, P, E, v) {
          ...
          if (N.startLineNumber === N.endLineNumber) {
            ...
            return (
              (b = this._findMatchesInLine(P, w, N.startLineNumber, N.startColumn - 1, b, l, E, v)),
              l
            );
          }
          ...
          for (let w = N.startLineNumber + 1; w < N.endLineNumber && b < v; w++)
            b = this._findMatchesInLine(P, L.getLineContent(w), w, 0, b, l, E, v);
          if (b < v) {
        ...
        static _findMatchesInLine(L, N, P, E, v, l, b, g) {
          ...
          if (!b && L.simpleSearch) {
            ...
            for (; (D = N.indexOf(_, D + C)) !== -1; )
              if (
                (!w || o(w, N, R, D, C)) &&
                ((l[v++] = new f.FindMatch(new d.Range(P, D + 1 + E, P, D + 1 + C + E), null)),
                v >= g)
              )
                return v;
            return v;
          ...
          do
            if (
              ...
              y &&
                ((l[v++] = m(
                  new d.Range(P, y.index + 1 + E, P, y.index + 1 + y[0].length + E),
                  y,
                  b
                )),
                v >= g))
        ...
        static _doFindNextMatchMultiline(L, N, P, E) {
          const v = new A.Position(N.lineNumber, 1),
            l = L.getOffsetAt(v),
            b = L.getLineCount(),
            g = L.getValueInRange(new d.Range(v.lineNumber, v.column, b, L.getLineMaxColumn(b)), 1),
            w =
              L.getEOL() ===
              `\r
`
        ...
        static _doFindPreviousMatchMultiline(L, N, P, E) {
          ...
          return N.lineNumber !== l || N.column !== L.getLineMaxColumn(l)
            ? this._doFindPreviousMatchMultiline(L, new A.Position(l, L.getLineMaxColumn(l)), P, E)
            : null;
        }
        ...
        static _findLastMatchInLine(L, N, P, E) {
          ...
          for (L.reset(0); (l = L.next(N)); )
            v = m(new d.Range(P, l.index + 1, P, l.index + 1 + l[0].length), l, E);
          return v;
        }
      }
      n.TextModelSearch = h;
          ...
          e: for (let M = o, y = u; M <= y; M++) {
            ...
            do
              if (((l = P.next(_)), l)) {
                ...
                if (z !== 0) {
                  if (
                    (z === 3 ? b++ : z === 2 ? g++ : z === 1 ? w++ : (0, d.assertNever)(z),
                    E.length >= 1e3)
                  ) {
                    v = !0;
                    break e;
      ...
      class a {
        ...
        getCandidateCodePoints() {
          ...
          if (this.options.ambiguousCharacters)
            for (const r of this.ambiguousCharacters.getConfusableCodePoints()) h.add(r);
        ...
        shouldHighlightNonBasicASCII(h, r) {
          ...
          return !o && u
            ...
            : this.options.invisibleCharacters &&
              ...
              ? 2
              : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(s)
                ? 3
                : 0;
        }
      }
...
` ||
    ...
    X(J[69], Z([0, 1]), function (W, n) {
      ...
      (function (t) {
        ((t[(t.acceptSuggestionOnCommitCharacter = 0)] = 'acceptSuggestionOnCommitCharacter'),
          ...
          (t[(t.revealHorizontalRightPadding = 101)] = 'revealHorizontalRightPadding'),
          ...
          (t[(t.suggestOnTriggerCharacters = 122)] = 'suggestOnTriggerCharacters'),
          ...
          (t[(t.wordWrapBreakAfterCharacters = 134)] = 'wordWrapBreakAfterCharacters'),
          (t[(t.wordWrapBreakBeforeCharacters = 135)] = 'wordWrapBreakBeforeCharacters'),
          ...
          (t[(t.colorDecoratorsActivatedOn = 149)] = 'colorDecoratorsActivatedOn'),
    ...
    X(J[11], Z([0, 1, 36]), function (W, n, i) {
      ...
      typeof L.vscode < 'u' && typeof L.vscode.process < 'u'
        ? (N = L.vscode.process)
        : typeof process < 'u' && typeof process?.versions?.node == 'string' && (N = process);
      ...
      (A ? (v = 1) : x ? (v = 3) : d && (v = 2),
        ...
        (n.userAgent = S),
        (n.language = s),
        (n.setTimeout0IsFaster = typeof L.postMessage == 'function' && !L.importScripts),
        (n.setTimeout0 = (() => {
    ...
    X(J[71], Z([0, 1, 23, 3, 9, 8, 11, 45]), function (W, n, i, x, A, d, f, p) {
      ...
      class s {
        ...
        cancel() {
          (this.cancelTimeout(),
            this.completionPromise &&
              (this.doReject?.(new x.CancellationError()), (this.completionPromise = null)));
        }
        cancelTimeout() {
      ...
      class N {
        constructor(C, R) {
          ((this._isDisposed = !1),
            (this._token = -1),
            typeof C == 'function' && typeof R == 'number' && this.setIfNotSet(C, R));
        }
        dispose() {
        ...
        cancelAndSet(C, R) {
          if (this._isDisposed)
            throw new x.BugIndicatingError("Calling 'cancelAndSet' on a disposed TimeoutTimer");
          (this.cancel(),
        ...
        setIfNotSet(C, R) {
          if (this._isDisposed)
            throw new x.BugIndicatingError("Calling 'setIfNotSet' on a disposed TimeoutTimer");
          this._token === -1 &&
            (this._token = setTimeout(() => {
              ((this._token = -1), C());
            }, R));
      ...
      class P {
        ...
        cancelAndSet(C, R, D = globalThis) {
          if (this.isDisposed)
            throw new x.BugIndicatingError("Calling 'cancelAndSet' on a disposed IntervalTimer");
          this.cancel();
      ...
      class w {
        ...
        emitMany(C) {
          this._state === 0 &&
            ((this._results = this._results.concat(C)), this._onStateChanged.fire());
        }
        resolve() {
              ...
              if (C === 2) {
                if (
                  ...
                  if (M.length > 2) {
                    ...
                    (T === -1
                      ? ((M = ''), (y = 0))
                      : ((M = M.slice(0, T)), (y = M.length - 1 - M.lastIndexOf(g))),
                      (_ = D),
                      (C = 0));
                    continue;
                  } else if (M.length !== 0) {
                ...
                (M.length > 0 ? (M += `${g}${l.slice(_ + 1, D)}`) : (M = l.slice(_ + 1, D)),
                  (y = D - _ - 1));
            ((_ = D), (C = 0));
          } else R === p && C !== -1 ? ++C : (C = -1);
        }
      ...
      n.win32 = {
          ...
          for (let M = l.length - 1; M >= -1; M--) {
            ...
            if (M >= 0) {
              ...
              b.length === 0
                ...
                : ((y = i.env[`=${b}`] || i.cwd()),
                  (y === void 0 ||
                    (y.slice(0, 2).toLowerCase() !== b.toLowerCase() && y.charCodeAt(2) === a)) &&
                    (y = `${b}\\`));
            const _ = y.length;
            let C = 0,
              R = '',
            ...
            if (_ === 1) u(T) && ((C = 1), (D = !0));
              ...
              L(T) &&
                y.charCodeAt(1) === m &&
                ((R = y.slice(0, 2)), (C = 2), _ > 2 && u(y.charCodeAt(2)) && ((D = !0), (C = 3)));
            if (R.length > 0)
              if (b.length > 0) {
        ...
        normalize(l) {
          ...
          if (u(y))
            ...
            L(y) &&
              l.charCodeAt(1) === m &&
              ((w = l.slice(0, 2)), (g = 2), b > 2 && u(l.charCodeAt(2)) && ((M = !0), (g = 3)));
        ...
        relative(l, b) {
          ...
          if (z !== T) {
            ...
            (_ > T && (l.charCodeAt(M + z) === a ? (O = z) : z === 2 && (O = 3)),
              O === -1 && (O = 0));
          }
          let j = '';
          for (z = M + O + 1; z <= y; ++z)
            (z === y || l.charCodeAt(z) === a) && (j += j.length === 0 ? '..' : '\\..');
          return (
            (C += O),
            j.length > 0 ? `${j}${w.slice(C, R)}` : (w.charCodeAt(C) === a && ++C, w.slice(C, R))
          );
        },
        toNamespacedPath(l) {
          ...
          } else if (L(b.charCodeAt(0)) && b.charCodeAt(1) === m && b.charCodeAt(2) === a)
            return `\\\\?\\${b}`;
          return l;
        },
        dirname(l) {
          ...
          if (u(M)) {
            ...
            L(M) && l.charCodeAt(1) === m && ((g = b > 2 && u(l.charCodeAt(2)) ? 3 : 2), (w = g));
          let y = -1,
            _ = !0;
          for (let C = b - 1; C >= w; --C)
            if (u(l.charCodeAt(C))) {
        ...
        basename(l, b) {
          ...
          let g = 0,
            ...
            y;
          if (
            (l.length >= 2 && L(l.charCodeAt(0)) && l.charCodeAt(1) === m && (g = 2),
            ...
            for (y = l.length - 1; y >= g; --y) {
              ...
              if (u(R)) {
                ...
                (C === -1 && ((M = !1), (C = y + 1)),
                  _ >= 0 && (R === b.charCodeAt(_) ? --_ === -1 && (w = y) : ((_ = -1), (w = C))));
            }
        ...
        extname(l) {
          ...
          for (let C = l.length - 1; C >= b; --C) {
            ...
            (M === -1 && ((y = !1), (M = C + 1)),
              R === p ? (g === -1 ? (g = C) : _ !== 1 && (_ = 1)) : g !== -1 && (_ = -1));
          }
          return g === -1 || M === -1 || _ === 0 || (_ === 1 && g === M - 1 && g === w + 1)
            ? ''
            : l.slice(g, M);
        },
        format: E.bind(null, '\\'),
        parse(l) {
          ...
          for (; D >= w; --D) {
            ...
            (C === -1 && ((R = !1), (C = D + 1)),
              M === p ? (y === -1 ? (y = D) : T !== 1 && (T = 1)) : y !== -1 && (T = -1));
          }
          return (
            C !== -1 &&
              (y === -1 || T === 0 || (T === 1 && y === C - 1 && y === _ + 1)
                ? (b.base = b.name = l.slice(_, C))
                : ((b.name = l.slice(_, y)), (b.base = l.slice(_, C)), (b.ext = l.slice(y, C)))),
      ...
      ((n.posix = {
        resolve(...l) {
          ...
          for (let w = l.length - 1; w >= -1 && !g; w--) {
            const M = w >= 0 ? l[w] : v();
            (s(M, `paths[${w}]`),
              M.length !== 0 && ((b = `${M}/${b}`), (g = M.charCodeAt(0) === c)));
          }
        ...
        relative(l, b) {
          if (
            (s(l, 'from'),
            s(b, 'to'),
            l === b || ((l = n.posix.resolve(l)), (b = n.posix.resolve(b)), l === b))
          )
            return '';
          const g = 1,
            w = l.length,
          ...
          let T = '';
          for (D = g + R + 1; D <= w; ++D)
            (D === w || l.charCodeAt(D) === c) && (T += T.length === 0 ? '..' : '/..');
        ...
        extname(l) {
          ...
          for (let _ = l.length - 1; _ >= 0; --_) {
            ...
            (w === -1 && ((M = !1), (w = _ + 1)),
              C === p ? (b === -1 ? (b = _) : y !== 1 && (y = 1)) : b !== -1 && (y = -1));
          }
          return b === -1 || w === -1 || y === 0 || (y === 1 && b === w - 1 && b === g + 1)
            ? ''
            : l.slice(b, w);
        },
        format: E.bind(null, '/'),
        parse(l) {
          ...
          for (; R >= w; --R) {
            ...
            (_ === -1 && ((C = !1), (_ = R + 1)),
              T === p ? (M === -1 ? (M = R) : D !== 1 && (D = 1)) : M !== -1 && (D = -1));
          }
          if (_ !== -1) {
            const T = y === 0 && g ? 1 : y;
            M === -1 || D === 0 || (D === 1 && M === _ - 1 && M === y + 1)
              ? (b.base = b.name = l.slice(T, _))
              : ((b.name = l.slice(T, M)), (b.base = l.slice(T, _)), (b.ext = l.slice(M, _)));
          }
    ...
    X(J[14], Z([0, 1, 37, 11]), function (W, n, i, x) {
      ...
      class r {
        ...
        static parse(g, w = !1) {
          const M = h.exec(g);
          return M
            ? new o(M[2] || m, l(M[4] || m), l(M[5] || m), l(M[7] || m), l(M[9] || m), w)
            : new o(m, m, m, m, m);
        }
        static file(g) {
          let w = m;
      ...
      class o extends r {
        ...
        toString(g = !1) {
          return g
            ? P(this, !0)
            : (this._formatted || (this._formatted = P(this, !1)), this._formatted);
        }
        toJSON() {
          const g = { $mid: 1 };
          return (
      ...
      function S(b, g, w) {
        ...
        for (let _ = 0; _ < b.length; _++) {
          ...
          if (
            ...
            (y !== -1 && ((M += encodeURIComponent(b.substring(y, _))), (y = -1)),
              M !== void 0 && (M += b.charAt(_)));
          else {
            M === void 0 && (M = b.substr(0, _));
            const R = u[C];
            R !== void 0
              ? (y !== -1 && ((M += encodeURIComponent(b.substring(y, _))), (y = -1)), (M += R))
              : y === -1 && (y = _);
          }
        }
        ...
        if ((y && ((M += y), (M += ':')), (_ || y === 'file') && ((M += e), (M += e)), _)) {
          ...
          if (T !== -1) {
            ...
            ((_ = _.substr(T + 1)),
              ...
              T === -1
                ? (M += w(O, !1, !1))
                : ((M += w(O.substr(0, T), !1, !1)), (M += ':'), (M += w(O.substr(T + 1), !1, !0))),
              (M += '@'));
          }
          ((_ = _.toLowerCase()),
            (T = _.lastIndexOf(':')),
    ...
    X(J[38], Z([0, 1, 3, 11, 6, 14, 37]), function (W, n, i, x, A, d, f) {
      ...
      (function (r) {
        ((r.inMemory = 'inmemory'),
          ...
          (r.vscodeNotebookCellMetadataDiff = 'vscode-notebook-cell-metadata-diff'),
      ...
      class e {
        ...
        uriToBrowserUri(s) {
          return s.scheme === p.vscodeRemote
            ...
            : s.scheme === p.file &&
                (x.isNative ||
                  x.webWorkerOrigin === `${p.vscodeFileResource}://${e.FALLBACK_AUTHORITY}`)
              ? s.with({
    ...
    X(J[76], Z([0, 1, 3, 9, 8, 38, 11, 6]), function (W, n, i, x, A, d, f, p) {
              ...
              typeof _ == 'string' &&
                ...
                (E(_)
                  ...
                  : P(_)
                    ...
                    : _.charCodeAt(0) === 36 &&
                      (y[_] = async (...C) => (await w?.(), this.sendMessage(g, _, C)))),
              y[_]
            ),
          };
          ...
          this._handler.handleMessage(g.channel, g.method, g.args).then(
            ...
            (y) => {
              (y.detail instanceof Error &&
                ...
                this._send(
                  new s(this._workerId, w, void 0, (0, i.transformErrorForSerialization)(y))
                ));
            }
          );
        }
      ...
      class N extends A.Disposable {
        constructor(g, w) {
          ...
          (typeof y < 'u' && typeof y.getConfig == 'function'
            ? (M = y.getConfig())
            : typeof globalThis.requirejs < 'u' && (M = globalThis.requirejs.s.contexts._.config),
            (this._onModuleLoaded = this._protocol.sendMessage(a, m, [
              this._worker.getId(),
              JSON.parse(JSON.stringify(M)),
              w.amdModuleId,
            ])),
            (this.proxy = this._protocol.createProxyToRemoteChannel(a, async () => {
        ...
        _handleMessage(g, w, M) {
          ...
          if (typeof y[w] != 'function')
            return Promise.reject(new Error(`Missing method ${w} on main thread channel ${g}`));
          try {
        ...
        _handleEvent(g, w, M) {
          ...
          if (E(w)) {
            ...
            if (typeof _ != 'function')
              throw new Error(`Missing dynamic event ${w} on main thread channel ${g}.`);
            return _;
          }
          if (P(w)) {
            const _ = y[w];
            if (typeof _ != 'function')
              throw new Error(`Missing event ${w} on main thread channel ${g}.`);
            return _;
          }
      ...
      class v {
        ...
        _handleMessage(g, w, M) {
          ...
          if (typeof y[w] != 'function')
            return Promise.reject(new Error(`Missing method ${w} on worker thread channel ${g}`));
          try {
            return Promise.resolve(y[w].apply(y, M));
          } catch (_) {
            return Promise.reject(_);
        ...
        async initialize(g, w, M) {
          ...
          if (
            (w &&
              ...
              typeof w.paths < 'u' && typeof w.paths.vs < 'u' && delete w.paths.vs,
            ...
            return new Promise((_, C) => {
              ...
              if (((this._requestHandler = _.create(this)), !this._requestHandler))
    ...
    X(J[73], Z([0, 1, 47, 14, 2, 70, 36]), function (W, n, i, x, A, d, f) {
      ...
      function S(y) {
        return (
          ...
          (A.Range.isIRange(y.originSelectionRange) || A.Range.isIRange(y.targetSelectionRange))
        );
      }
      n.symbolKindNames = {
    ...
    X(J[75], Z([0, 1, 71, 8, 14, 4, 2, 31, 64]), function (W, n, i, x, A, d, f, p, c) {
        ...
        ensureSyncedResources(r, s = !1) {
          for (const o of r) {
            ...
            (this._syncedModels[u] || this._beginModelSync(o, s),
              this._syncedModels[u] && (this._syncedModelsLastUsedTime[u] = new Date().getTime()));
          }
        }
        _checkStopModelSync() {
          ...
          for (const o in this._syncedModelsLastUsedTime)
            r - this._syncedModelsLastUsedTime[o] > n.STOP_SYNC_MODEL_DELTA_TIME_MS && s.push(o);
      ...
      class e extends c.MirrorTextModel {
            ...
            *[Symbol.iterator]() {
              for (;;)
                if (L < N.length) {
                  ...
                  ((L += 1), yield P);
                } else if (u < s.length) ((S = s[u]), (N = o(S, r)), (L = 0), (u += 1));
                else break;
            },
          };
        }
        ...
        getValueInRange(r) {
          if (((r = this._validateRange(r)), r.startLineNumber === r.endLineNumber))
            return this._lines[r.startLineNumber - 1].substring(r.startColumn - 1, r.endColumn - 1);
          const s = this._eol,
        ...
        _validatePosition(r) {
          ...
          if (s < 1) ((s = 1), (o = 1), (u = !0));
            ...
            ((s = this._lines.length), (o = this._lines[s - 1].length + 1), (u = !0));
          else {
        ...
        class S {
          ...
          async $computeMoreMinimalEdits(E, v, l) {
            ...
            for (let y = 1; y < v.length; y++)
              x.Range.getEndPosition(v[M].range).equals(x.Range.getStartPosition(v[y].range))
            ...
            e: for (const y of E) {
              ...
              if (_) {
                for (const C of _.words(w))
                  if (!(C === v || !isNaN(Number(C))) && (M.add(C), M.size > L._suggestionsLimit))
                    break e;
              }
            }
