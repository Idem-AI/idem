...
define('vs/language/html/htmlWorker', ['require', 'require'], (require) => {
  ...
  var moduleExports = (() => {
    ...
    var In = (t, n) => {
        for (var o in n) Fe(t, o, { get: n[o], enumerable: !0 });
      },
      Wn = (t, n, o, a) => {
        if ((n && typeof n == 'object') || typeof n == 'function')
          for (let e of zn(n))
            !Hn.call(t, e) &&
              e !== o &&
              Fe(t, e, { get: () => n[e], enumerable: !(a = Rn(n, e)) || a.enumerable });
        return t;
      };
    var Un = (t) => Wn(Fe({}, '__esModule', { value: !0 }), t);
    var Ei = {};
    In(Ei, { HTMLWorker: () => Ne, create: () => Di });
    var On;
    function J(...t) {
      let n = t[0],
        o,
        ...
        e;
      if (typeof n == 'string')
        ((o = n), (a = n), t.splice(0, 1), (e = !t || typeof t[0] != 'object' ? t : t[0]));
      else if (n instanceof Array) {
        let u = t.slice(1);
        if (n.length !== u.length + 1)
          throw new Error('expected a string as the first argument to l10n.t');
        let c = n[0];
        for (let i = 1; i < n.length; i++) c += `{${i - 1}}` + n[i];
        return J(c, ...u);
      } else
        ((a = n.message),
          (o = a),
          n.comment &&
            n.comment.length > 0 &&
            (o += `/${Array.isArray(n.comment) ? n.comment.join('') : n.comment}`),
          (e = n.args ?? {}));
      let r = On?.[o];
      return r
        ? typeof r == 'string'
    ...
    var Bn = /{([^}]+)}/g;
    function Te(t, n) {
      return Object.keys(n).length === 0 ? t : t.replace(Bn, (o, a) => n[a] ?? o);
    }
    var qe;
    (function (t) {
      function n(o) {
    ...
    (function (t) {
      ...
      function n(o) {
        return typeof o == 'number' && t.MIN_VALUE <= o && o <= t.MAX_VALUE;
      }
      t.is = n;
    })(kt || (kt = {}));
    var ke;
    ...
    (function (t) {
      function n(a, e) {
        return (
          a === Number.MAX_VALUE && (a = ke.MAX_VALUE),
          e === Number.MAX_VALUE && (e = ke.MAX_VALUE),
          { line: a, character: e }
        );
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.objectLiteral(e) && w.uinteger(e.line) && w.uinteger(e.character);
      }
      t.is = o;
    })(q || (q = {}));
    var W;
    (function (t) {
      function n(a, e, r, u) {
        if (w.uinteger(a) && w.uinteger(e) && w.uinteger(r) && w.uinteger(u))
          return { start: q.create(a, e), end: q.create(r, u) };
        if (q.is(a) && q.is(e)) return { start: a, end: e };
        throw new Error(`Range#create called with invalid arguments[${a}, ${e}, ${r}, ${u}]`);
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.objectLiteral(e) && q.is(e.start) && q.is(e.end);
      }
      t.is = o;
    })(W || (W = {}));
    var me;
    (function (t) {
      function n(a, e) {
        return { uri: a, range: e };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.objectLiteral(e) && W.is(e.range) && (w.string(e.uri) || w.undefined(e.uri));
      }
      t.is = o;
    })(me || (me = {}));
    var St;
    (function (t) {
      function n(a, e, r, u) {
        return { targetUri: a, targetRange: e, targetSelectionRange: r, originSelectionRange: u };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return (
          w.objectLiteral(e) &&
          W.is(e.targetRange) &&
          w.string(e.targetUri) &&
          W.is(e.targetSelectionRange) &&
          (W.is(e.originSelectionRange) || w.undefined(e.originSelectionRange))
        );
      }
      t.is = o;
    })(St || (St = {}));
    ...
    (function (t) {
      function n(a, e, r, u) {
        return { red: a, green: e, blue: r, alpha: u };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return (
          w.objectLiteral(e) &&
          w.numberRange(e.red, 0, 1) &&
          w.numberRange(e.green, 0, 1) &&
          w.numberRange(e.blue, 0, 1) &&
          w.numberRange(e.alpha, 0, 1)
        );
      }
      t.is = o;
    })(Se || (Se = {}));
    ...
    (function (t) {
      function n(a, e) {
        return { range: a, color: e };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.objectLiteral(e) && W.is(e.range) && Se.is(e.color);
      }
      t.is = o;
    })(Ge || (Ge = {}));
    var Ve;
    (function (t) {
      function n(a, e, r) {
        return { label: a, textEdit: e, additionalTextEdits: r };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return (
          w.objectLiteral(e) &&
          w.string(e.label) &&
          (w.undefined(e.textEdit) || G.is(e)) &&
          (w.undefined(e.additionalTextEdits) || w.typedArray(e.additionalTextEdits, G.is))
        );
      }
      t.is = o;
    })(Ve || (Ve = {}));
    ...
    var $e;
    (function (t) {
      function n(a, e, r, u, c, i) {
        let s = { startLine: a, endLine: e };
        return (
          w.defined(r) && (s.startCharacter = r),
          w.defined(u) && (s.endCharacter = u),
          w.defined(c) && (s.kind = c),
          w.defined(i) && (s.collapsedText = i),
          s
        );
      }
      t.create = n;
      function o(a) {
        ...
        return (
          w.objectLiteral(e) &&
          w.uinteger(e.startLine) &&
          w.uinteger(e.startLine) &&
          (w.undefined(e.startCharacter) || w.uinteger(e.startCharacter)) &&
          (w.undefined(e.endCharacter) || w.uinteger(e.endCharacter)) &&
          (w.undefined(e.kind) || w.string(e.kind))
        );
      }
      t.is = o;
    })($e || ($e = {}));
    ...
    (function (t) {
      function n(a, e) {
        return { location: a, message: e };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.defined(e) && me.is(e.location) && w.string(e.message);
      }
      t.is = o;
    })(Je || (Je = {}));
    var At;
    ...
    (function (t) {
      function n(o) {
        let a = o;
        return w.objectLiteral(a) && w.string(a.href);
      }
      t.is = n;
    })(Dt || (Dt = {}));
    var fe;
    (function (t) {
      function n(a, e, r, u, c, i) {
        let s = { range: a, message: e };
        return (
          w.defined(r) && (s.severity = r),
          w.defined(u) && (s.code = u),
          w.defined(c) && (s.source = c),
          w.defined(i) && (s.relatedInformation = i),
          s
        );
      }
      t.create = n;
      function o(a) {
        ...
        return (
          ...
          W.is(r.range) &&
          w.string(r.message) &&
          (w.number(r.severity) || w.undefined(r.severity)) &&
          (w.integer(r.code) || w.string(r.code) || w.undefined(r.code)) &&
          (w.undefined(r.codeDescription) ||
            w.string((e = r.codeDescription) === null || e === void 0 ? void 0 : e.href)) &&
          (w.string(r.source) || w.undefined(r.source)) &&
          (w.undefined(r.relatedInformation) || w.typedArray(r.relatedInformation, Je.is))
        );
      }
      t.is = o;
    })(fe || (fe = {}));
    ...
    (function (t) {
      function n(a, e, ...r) {
        let u = { title: a, command: e };
        return (w.defined(r) && r.length > 0 && (u.arguments = r), u);
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.defined(e) && w.string(e.title) && w.string(e.command);
      }
      t.is = o;
    })(ne || (ne = {}));
    var G;
    (function (t) {
      function n(r, u) {
        return { range: r, newText: u };
      }
      t.replace = n;
      function o(r, u) {
        return { range: { start: r, end: r }, newText: u };
      }
      t.insert = o;
      function a(r) {
      ...
      function e(r) {
        let u = r;
        return w.objectLiteral(u) && w.string(u.newText) && W.is(u.range);
      }
      t.is = e;
    })(G || (G = {}));
    var Xe;
    (function (t) {
      function n(a, e, r) {
        let u = { label: a };
        return (e !== void 0 && (u.needsConfirmation = e), r !== void 0 && (u.description = r), u);
      }
      t.create = n;
      function o(a) {
        let e = a;
        return (
          w.objectLiteral(e) &&
          w.string(e.label) &&
          (w.boolean(e.needsConfirmation) || e.needsConfirmation === void 0) &&
          (w.string(e.description) || e.description === void 0)
        );
      }
      t.is = o;
    })(Xe || (Xe = {}));
    ...
    (function (t) {
      function n(r, u, c) {
        return { range: r, newText: u, annotationId: c };
      }
      t.replace = n;
      function o(r, u, c) {
        return { range: { start: r, end: r }, newText: u, annotationId: c };
      }
      t.insert = o;
      function a(r, u) {
        return { range: r, newText: '', annotationId: u };
      }
      t.del = a;
      function e(r) {
        let u = r;
        return G.is(u) && (Xe.is(u.annotationId) || se.is(u.annotationId));
      }
      t.is = e;
    })(Et || (Et = {}));
    var Ye;
    (function (t) {
      function n(a, e) {
        return { textDocument: a, edits: e };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.defined(e) && et.is(e.textDocument) && Array.isArray(e.edits);
      }
      t.is = o;
    })(Ye || (Ye = {}));
    var Qe;
    (function (t) {
      function n(a, e, r) {
        let u = { kind: 'create', uri: a };
        return (
          e !== void 0 &&
            (e.overwrite !== void 0 || e.ignoreIfExists !== void 0) &&
            (u.options = e),
          r !== void 0 && (u.annotationId = r),
          u
        );
      }
      t.create = n;
      function o(a) {
        ...
        return (
          ...
          w.string(e.uri) &&
          (e.options === void 0 ||
            ((e.options.overwrite === void 0 || w.boolean(e.options.overwrite)) &&
              (e.options.ignoreIfExists === void 0 || w.boolean(e.options.ignoreIfExists)))) &&
          (e.annotationId === void 0 || se.is(e.annotationId))
        );
      }
      t.is = o;
    })(Qe || (Qe = {}));
    ...
    (function (t) {
      function n(a, e, r, u) {
        let c = { kind: 'rename', oldUri: a, newUri: e };
        return (
          r !== void 0 &&
            (r.overwrite !== void 0 || r.ignoreIfExists !== void 0) &&
            (c.options = r),
          u !== void 0 && (c.annotationId = u),
          c
        );
      }
      t.create = n;
    ...
    (function (t) {
      ...
      function o(a) {
        ...
        return (
          ...
          w.string(e.uri) &&
          (e.options === void 0 ||
            ((e.options.recursive === void 0 || w.boolean(e.options.recursive)) &&
              (e.options.ignoreIfNotExists === void 0 ||
                w.boolean(e.options.ignoreIfNotExists)))) &&
          (e.annotationId === void 0 || se.is(e.annotationId))
        );
      }
      t.is = o;
    ...
    (function (t) {
      function n(o) {
        ...
        return (
          a &&
          (a.changes !== void 0 || a.documentChanges !== void 0) &&
          (a.documentChanges === void 0 ||
            a.documentChanges.every((e) =>
              w.string(e.kind) ? Qe.is(e) || Ze.is(e) || Ke.is(e) : Ye.is(e)
            ))
        );
      }
      t.is = n;
    ...
    (function (t) {
      ...
      function o(a) {
        let e = a;
        return w.defined(e) && w.string(e.uri);
      }
      t.is = o;
    })(Ct || (Ct = {}));
    var Lt;
    (function (t) {
      function n(a, e) {
        return { uri: a, version: e };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.defined(e) && w.string(e.uri) && w.integer(e.version);
      }
      t.is = o;
    })(Lt || (Lt = {}));
    var et;
    (function (t) {
      ...
      function o(a) {
        let e = a;
        return w.defined(e) && w.string(e.uri) && (e.version === null || w.integer(e.version));
      }
      t.is = o;
    })(et || (et = {}));
    var Mt;
    (function (t) {
      function n(a, e, r, u) {
        return { uri: a, languageId: e, version: r, text: u };
      }
      t.create = n;
      function o(a) {
        let e = a;
    ...
    (function (t) {
      ...
      function n(o) {
        let a = o;
        return a === t.PlainText || a === t.Markdown;
      }
      t.is = n;
    })(Q || (Q = {}));
    var le;
    (function (t) {
      function n(o) {
        let a = o;
        return w.objectLiteral(o) && Q.is(a.kind) && w.string(a.value);
      }
      t.is = n;
    })(le || (le = {}));
    var $;
    ...
    (function (t) {
      function n(a, e, r) {
        return { newText: a, insert: e, replace: r };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return e && w.string(e.newText) && W.is(e.insert) && W.is(e.replace);
      }
      t.is = o;
    })(nt || (nt = {}));
    var it;
    ...
    (function (t) {
      function n(o) {
        ...
        return (
          a &&
          (w.string(a.detail) || a.detail === void 0) &&
          (w.string(a.description) || a.description === void 0)
        );
      }
      t.is = n;
    })(Rt || (Rt = {}));
    ...
    (function (t) {
      ...
      function o(a) {
        let e = a;
        return w.string(e) || (w.objectLiteral(e) && w.string(e.language) && w.string(e.value));
      }
      t.is = o;
    })(ge || (ge = {}));
    var ot;
    (function (t) {
      function n(o) {
        ...
        return (
          !!a &&
          w.objectLiteral(a) &&
          (le.is(a.contents) || ge.is(a.contents) || w.typedArray(a.contents, ge.is)) &&
          (o.range === void 0 || W.is(o.range))
        );
      }
      t.is = n;
    })(ot || (ot = {}));
    ...
    (function (t) {
      function n(o, a) {
        return a ? { label: o, documentation: a } : { label: o };
      }
      t.create = n;
    })(zt || (zt = {}));
    var Ht;
    (function (t) {
      function n(o, a, ...e) {
        let r = { label: o };
        return (
          w.defined(a) && (r.documentation = a),
          w.defined(e) ? (r.parameters = e) : (r.parameters = []),
          r
        );
      }
      t.create = n;
    ...
    var we;
    (function (t) {
      function n(o, a, e, r, u) {
        let c = { name: o, kind: a, location: { uri: r, range: e } };
        return (u && (c.containerName = u), c);
      }
      t.create = n;
    })(we || (we = {}));
    var Wt;
    (function (t) {
      function n(o, a, e, r) {
        return r !== void 0
          ? { name: o, kind: a, location: { uri: e, range: r } }
          : { name: o, kind: a, location: { uri: e } };
      }
      t.create = n;
    })(Wt || (Wt = {}));
    var _e;
    (function (t) {
      function n(a, e, r, u, c, i) {
        let s = { name: a, detail: e, kind: r, range: u, selectionRange: c };
        return (i !== void 0 && (s.children = i), s);
      }
      t.create = n;
      function o(a) {
        let e = a;
        return (
          ...
          w.number(e.kind) &&
          W.is(e.range) &&
          W.is(e.selectionRange) &&
          (e.detail === void 0 || w.string(e.detail)) &&
          (e.deprecated === void 0 || w.boolean(e.deprecated)) &&
    ...
    (function (t) {
      function n(a, e, r) {
        let u = { diagnostics: a };
        return (e != null && (u.only = e), r != null && (u.triggerKind = r), u);
      }
      t.create = n;
      function o(a) {
        let e = a;
        return (
          w.defined(e) &&
          w.typedArray(e.diagnostics, fe.is) &&
          (e.only === void 0 || w.typedArray(e.only, w.string)) &&
          (e.triggerKind === void 0 ||
            e.triggerKind === xe.Invoked ||
            e.triggerKind === xe.Automatic)
        );
      }
      t.is = o;
    })(Ot || (Ot = {}));
    ...
    (function (t) {
      ...
      function o(a) {
        ...
        return (
          e &&
          w.string(e.title) &&
          (e.diagnostics === void 0 || w.typedArray(e.diagnostics, fe.is)) &&
          (e.kind === void 0 || w.string(e.kind)) &&
          (e.edit !== void 0 || e.command !== void 0) &&
          (e.command === void 0 || ne.is(e.command)) &&
          (e.isPreferred === void 0 || w.boolean(e.isPreferred)) &&
    ...
    (function (t) {
      function n(a, e) {
        let r = { range: a };
        return (w.defined(e) && (r.data = e), r);
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.defined(e) && W.is(e.range) && (w.undefined(e.command) || ne.is(e.command));
      }
      t.is = o;
    })(Nt || (Nt = {}));
    var lt;
    (function (t) {
      function n(a, e) {
        return { tabSize: a, insertSpaces: e };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.defined(e) && w.uinteger(e.tabSize) && w.boolean(e.insertSpaces);
      }
      t.is = o;
    })(lt || (lt = {}));
    var ut;
    (function (t) {
      function n(a, e, r) {
        return { range: a, target: e, data: r };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.defined(e) && W.is(e.range) && (w.undefined(e.target) || w.string(e.target));
      }
      t.is = o;
    })(ut || (ut = {}));
    var ce;
    (function (t) {
      function n(a, e) {
        return { range: a, parent: e };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.objectLiteral(e) && W.is(e.range) && (e.parent === void 0 || t.is(e.parent));
      }
      t.is = o;
    })(ce || (ce = {}));
    var Ft;
    ...
    (function (t) {
      function n(o) {
        ...
        return (
          w.objectLiteral(a) &&
          (a.resultId === void 0 || typeof a.resultId == 'string') &&
          Array.isArray(a.data) &&
          (a.data.length === 0 || typeof a.data[0] == 'number')
        );
      }
      t.is = n;
    })(qt || (qt = {}));
    ...
    (function (t) {
      function n(a, e) {
        return { range: a, text: e };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return e != null && W.is(e.range) && w.string(e.text);
      }
      t.is = o;
    })(jt || (jt = {}));
    var Gt;
    (function (t) {
      function n(a, e, r) {
        return { range: a, variableName: e, caseSensitiveLookup: r };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return (
          e != null &&
          W.is(e.range) &&
          w.boolean(e.caseSensitiveLookup) &&
          (w.string(e.variableName) || e.variableName === void 0)
        );
      }
      t.is = o;
    })(Gt || (Gt = {}));
    ...
    (function (t) {
      function n(a, e) {
        return { range: a, expression: e };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return e != null && W.is(e.range) && (w.string(e.expression) || e.expression === void 0);
      }
      t.is = o;
    })(Vt || (Vt = {}));
    var $t;
    (function (t) {
      function n(a, e) {
        return { frameId: a, stoppedLocation: e };
      }
      t.create = n;
      function o(a) {
        let e = a;
        return w.defined(e) && W.is(a.stoppedLocation);
      }
      t.is = o;
    })($t || ($t = {}));
    var ct;
    ...
    (function (t) {
      ...
      function o(a) {
        ...
        return (
          w.objectLiteral(e) &&
          (e.tooltip === void 0 || w.string(e.tooltip) || le.is(e.tooltip)) &&
          (e.location === void 0 || me.is(e.location)) &&
          (e.command === void 0 || ne.is(e.command))
        );
      }
      t.is = o;
    ...
    (function (t) {
      function n(a, e, r) {
        let u = { position: a, label: e };
        return (r !== void 0 && (u.kind = r), u);
      }
      t.create = n;
      function o(a) {
        let e = a;
        return (
          (w.objectLiteral(e) &&
            q.is(e.position) &&
            (w.string(e.label) || w.typedArray(e.label, ht.is)) &&
            (e.kind === void 0 || ct.is(e.kind)) &&
            e.textEdits === void 0) ||
          (w.typedArray(e.textEdits, G.is) &&
            (e.tooltip === void 0 || w.string(e.tooltip) || le.is(e.tooltip)) &&
            (e.paddingLeft === void 0 || w.boolean(e.paddingLeft)) &&
            (e.paddingRight === void 0 || w.boolean(e.paddingRight)))
        );
      }
      t.is = o;
    })(Jt || (Jt = {}));
    ...
    (function (t) {
      function n(o, a, e, r) {
        return { insertText: o, filterText: a, range: e, command: r };
      }
      t.create = n;
    })(Yt || (Yt = {}));
    var Qt;
    ...
    (function (t) {
      function n(o, a) {
        return { triggerKind: o, selectedCompletionInfo: a };
      }
      t.create = n;
    })(en || (en = {}));
    var tn;
    (function (t) {
      function n(o) {
        let a = o;
        return w.objectLiteral(a) && je.is(a.uri) && w.string(a.name);
      }
      t.is = n;
    })(tn || (tn = {}));
    var nn;
    (function (t) {
      ...
      function o(r) {
        ...
        return !!(
          w.defined(u) &&
          w.string(u.uri) &&
          (w.undefined(u.languageId) || w.string(u.languageId)) &&
          w.uinteger(u.lineCount) &&
          w.func(u.getText) &&
          w.func(u.positionAt) &&
          w.func(u.offsetAt)
        );
      ...
      function a(r, u) {
        let c = r.getText(),
          i = e(u, (l, h) => {
            let p = l.range.start.line - h.range.start.line;
            return p === 0 ? l.range.start.character - h.range.start.character : p;
          }),
          s = c.length;
        for (let l = i.length - 1; l >= 0; l--) {
          let h = i[l],
            p = r.offsetAt(h.range.start),
            m = r.offsetAt(h.range.end);
          if (m <= s) c = c.substring(0, p) + h.newText + c.substring(m, c.length);
      ...
      function e(r, u) {
        ...
        let l = 0,
          h = 0,
          p = 0;
        for (; l < i.length && h < s.length; )
          u(i[l], s[h]) <= 0 ? (r[p++] = i[l++]) : (r[p++] = s[h++]);
        for (; l < i.length; ) r[p++] = i[l++];
        for (; h < s.length; ) r[p++] = s[h++];
        return r;
      }
    })(nn || (nn = {}));
    var dt = class {
        ...
        getText(n) {
          if (n) {
            let o = this.offsetAt(n.start),
              a = this.offsetAt(n.end);
            return this._content.substring(o, a);
          }
          return this._content;
        }
        update(n, o) {
          ((this._content = n.text), (this._version = o), (this._lineOffsets = void 0));
        }
        getLineOffsets() {
...
` &&
            ...
            (a && o.length > 0 && n.push(o.length), (this._lineOffsets = n));
          }
        ...
        positionAt(n) {
          ...
          let o = this.getLineOffsets(),
            a = 0,
            e = o.length;
          if (e === 0) return q.create(0, n);
          for (; a < e; ) {
            let u = Math.floor((a + e) / 2);
            o[u] > n ? (e = u) : (a = u + 1);
          }
          let r = a - 1;
          return q.create(r, n - o[r]);
        }
        offsetAt(n) {
          let o = this.getLineOffsets();
          if (n.line >= o.length) return this._content.length;
          if (n.line < 0) return 0;
          let a = o[n.line],
            e = n.line + 1 < o.length ? o[n.line + 1] : this._content.length;
          return Math.max(Math.min(a + n.character, e), a);
        }
        get lineCount() {
    ...
    (function (t) {
      ...
      t.boolean = e;
      function r(m) {
        return n.call(m) === '[object String]';
      }
      t.string = r;
      function u(m) {
        return n.call(m) === '[object Number]';
      }
      t.number = u;
      function c(m, A, b) {
        return n.call(m) === '[object Number]' && A <= m && m <= b;
      }
      t.numberRange = c;
      function i(m) {
        return n.call(m) === '[object Number]' && -2147483648 <= m && m <= 2147483647;
      }
      t.integer = i;
      function s(m) {
        return n.call(m) === '[object Number]' && 0 <= m && m <= 2147483647;
      }
      t.uinteger = s;
      function l(m) {
    ...
    var De = class t {
        ...
        update(n, o) {
          for (let a of n)
            if (t.isIncremental(a)) {
              let e = an(a.range),
                r = this.offsetAt(e.start),
                u = this.offsetAt(e.end);
              this._content =
                this._content.substring(0, r) +
                a.text +
                this._content.substring(u, this._content.length);
              let c = Math.max(e.start.line, 0),
                i = Math.max(e.end.line, 0),
                s = this._lineOffsets,
                l = rn(a.text, !1, r);
              if (i - c === l.length) for (let p = 0, m = l.length; p < m; p++) s[p + c + 1] = l[p];
              else
                l.length < 1e4
                  ? s.splice(c + 1, i - c, ...l)
                  : (this._lineOffsets = s = s.slice(0, c + 1).concat(l, s.slice(i + 1)));
              let h = a.text.length - (u - r);
              if (h !== 0) for (let p = c + 1 + l.length, m = s.length; p < m; p++) s[p] = s[p] + h;
            } else if (t.isFull(a)) ((this._content = a.text), (this._lineOffsets = void 0));
            else throw new Error('Unknown change event received');
          this._version = o;
        }
        getLineOffsets() {
          return (
            this._lineOffsets === void 0 && (this._lineOffsets = rn(this._content, !0)),
            this._lineOffsets
          );
        }
        positionAt(n) {
          ...
          let o = this.getLineOffsets(),
            a = 0,
            e = o.length;
          if (e === 0) return { line: 0, character: n };
          for (; a < e; ) {
            let u = Math.floor((a + e) / 2);
            o[u] > n ? (e = u) : (a = u + 1);
          }
          let r = a - 1;
          return { line: r, character: n - o[r] };
        }
        offsetAt(n) {
          let o = this.getLineOffsets();
          if (n.line >= o.length) return this._content.length;
        ...
        static isFull(n) {
          let o = n;
          return (
            o != null && typeof o.text == 'string' && o.range === void 0 && o.rangeLength === void 0
          );
        }
      },
      ve;
    (function (t) {
      function n(e, r, u, c) {
        return new De(e, r, u, c);
      }
      t.create = n;
      function o(e, r, u) {
        if (e instanceof De) return (e.update(r, u), e);
      ...
      function a(e, r) {
        let u = e.getText(),
          ...
          s = [];
        for (let l of c) {
          let h = e.offsetAt(l.range.start);
          if (h < i) throw new Error('Overlapping edit');
          (h > i && s.push(u.substring(i, h)),
            l.newText.length && s.push(l.newText),
            (i = e.offsetAt(l.range.end)));
        }
        return (s.push(u.substr(i)), s.join(''));
      }
      t.applyEdits = a;
    })(ve || (ve = {}));
    function pt(t, n) {
      ...
      let r = 0,
        u = 0,
        c = 0;
      for (; r < a.length && u < e.length; )
        n(a[r], e[u]) <= 0 ? (t[c++] = a[r++]) : (t[c++] = e[u++]);
      for (; r < a.length; ) t[c++] = a[r++];
      for (; u < e.length; ) t[c++] = e[u++];
      return t;
    }
    function rn(t, n, o = 0) {
      let a = n ? [o] : [];
      for (let e = 0; e < t.length; e++) {
        ...
        (r === 13 || r === 10) &&
          (r === 13 && e + 1 < t.length && t.charCodeAt(e + 1) === 10 && e++, a.push(o + e + 1));
      }
      return a;
    }
    function an(t) {
      let n = t.start,
        o = t.end;
      return n.line > o.line || (n.line === o.line && n.character > o.character)
        ? { start: o, end: n }
        : t;
    }
    function Nn(t) {
      let n = an(t.range);
      return n !== t.range ? { newText: t.newText, range: n } : t;
    }
    var S;
    (function (t) {
    ...
    (function (t) {
      t.LATEST = {
        textDocument: {
          completion: { completionItem: { documentationFormat: [Q.Markdown, Q.PlainText] } },
          hover: { contentFormat: [Q.Markdown, Q.PlainText] },
        },
      };
    })(on || (on = {}));
    var Ee;
    ...
    var ft = class {
        constructor(n, o) {
          ((this.source = n), (this.len = n.length), (this.position = o));
        }
        eos() {
        ...
        advanceIfChar(n) {
          return n === this.source.charCodeAt(this.position) ? (this.position++, !0) : !1;
        }
        advanceIfChars(n) {
          let o;
          if (this.position + n.length > this.source.length) return !1;
          for (o = 0; o < n.length; o++)
            if (this.source.charCodeAt(this.position + o) !== n[o]) return !1;
          return (this.advance(o), !0);
        }
        advanceIfRegExp(n) {
          let a = this.source.substr(this.position).match(n);
          return a ? ((this.position = this.position + a.index + a[0].length), a[0]) : '';
        }
        advanceUntilRegExp(n) {
          let a = this.source.substr(this.position).match(n);
          return a ? ((this.position = this.position + a.index), a[0]) : (this.goToEnd(), '');
        }
        advanceUntilChar(n) {
          for (; this.position < this.source.length; ) {
            if (this.source.charCodeAt(this.position) === n) return !0;
            this.advance(1);
          }
          return !1;
        }
        advanceUntilChars(n) {
          for (; this.position + n.length <= this.source.length; ) {
            let o = 0;
            for (; o < n.length && this.source.charCodeAt(this.position + o) === n[o]; o++);
            if (o === n.length) return !0;
            this.advance(1);
          }
        ...
        skipWhitespace() {
          return (
            this.advanceWhileChar((o) => o === $n || o === Jn || o === jn || o === Vn || o === Gn) >
            0
          );
        }
        advanceWhileChar(n) {
          let o = this.position;
          for (; this.position < this.len && n(this.source.charCodeAt(this.position)); )
            this.position++;
      ...
      $n = 32,
      Jn = 9,
      Xn = { 'text/x-handlebars-template': !0, 'text/html': !0 };
    function V(t, n = 0, o = H.WithinContent, a = !1) {
      let e = new ft(t, n),
        r = o,
        u = 0,
        c = S.Unknown,
      ...
      function D() {
        ...
        return I !== S.EOS &&
          y === e.pos() &&
          !(a && (I === S.StartTagClose || I === S.EndTagClose))
          ? (console.warn(
      ...
      function T() {
        let y = e.pos();
        if (e.eos()) return b(y, S.EOS);
        let L;
        switch (r) {
          case H.WithinComment:
            return e.advanceIfChars([he, he, ee])
              ? ((r = H.WithinContent), b(y, S.EndCommentTag))
              : (e.advanceUntilChars([he, he, ee]), b(y, S.Comment));
          case H.WithinDoctype:
            return e.advanceIfChar(ee)
              ? ((r = H.WithinContent), b(y, S.EndDoctypeTag))
              : (e.advanceUntilChar(ee), b(y, S.Doctype));
          case H.WithinContent:
            if (e.advanceIfChar(Ce)) {
              if (!e.eos() && e.peekChar() === sn) {
                if (e.advanceIfChars([sn, he, he]))
                  return ((r = H.WithinComment), b(y, S.StartCommentTag));
                if (e.advanceIfRegExp(/^!doctype/i))
                  return ((r = H.WithinDoctype), b(y, S.StartDoctypeTag));
              }
              return e.advanceIfChar(mt)
                ? ((r = H.AfterOpeningEndTag), b(y, S.EndTagOpen))
                : ((r = H.AfterOpeningStartTag), b(y, S.StartTagOpen));
            }
            return (e.advanceUntilChar(Ce), b(y, S.Content));
          case H.AfterOpeningEndTag:
            return m().length > 0
              ? ((r = H.WithinEndTag), b(y, S.EndTag))
              : e.skipWhitespace()
                ? b(y, S.Whitespace, J('Tag name must directly follow the open bracket.'))
                : ((r = H.WithinEndTag),
                  e.advanceUntilChar(ee),
                  y < e.pos() ? b(y, S.Unknown, J('End tag name expected.')) : T());
          case H.WithinEndTag:
            if (e.skipWhitespace()) return b(y, S.Whitespace);
            if (e.advanceIfChar(ee)) return ((r = H.WithinContent), b(y, S.EndTagClose));
            if (a && e.peekChar() === Ce)
              return ((r = H.WithinContent), b(y, S.EndTagClose, J('Closing bracket missing.')));
            L = J('Closing bracket expected.');
            break;
          case H.AfterOpeningStartTag:
            return (
              ...
              (h = void 0),
              l.length > 0
                ? ((s = !1), (r = H.WithinTag), b(y, S.StartTag))
                : e.skipWhitespace()
                  ? b(y, S.Whitespace, J('Tag name must directly follow the open bracket.'))
                  : ((r = H.WithinTag),
                    e.advanceUntilChar(ee),
                    y < e.pos() ? b(y, S.Unknown, J('Start tag name expected.')) : T())
            );
          case H.WithinTag:
            return e.skipWhitespace()
              ? ((s = !0), b(y, S.Whitespace))
              : s && ((h = A()), h.length > 0)
                ? ((r = H.AfterAttributeName), (s = !1), b(y, S.AttributeName))
                : e.advanceIfChars([mt, ee])
                  ? ((r = H.WithinContent), b(y, S.StartTagSelfClose))
                  : e.advanceIfChar(ee)
                    ? (l === 'script'
                        ? p && Xn[p]
                          ? (r = H.WithinContent)
                          : (r = H.WithinScriptContent)
                        : l === 'style'
                          ? (r = H.WithinStyleContent)
                          : (r = H.WithinContent),
                      b(y, S.StartTagClose))
                    : a && e.peekChar() === Ce
                      ? ((r = H.WithinContent),
                        b(y, S.StartTagClose, J('Closing bracket missing.')))
                      : (e.advance(1), b(y, S.Unknown, J('Unexpected character in tag.')));
          case H.AfterAttributeName:
            return e.skipWhitespace()
              ? ((s = !0), b(y, S.Whitespace))
              : e.advanceIfChar(Fn)
                ? ((r = H.BeforeAttributeValue), b(y, S.DelimiterAssign))
                : ((r = H.WithinTag), T());
          case H.BeforeAttributeValue:
            if (e.skipWhitespace()) return b(y, S.Whitespace);
            let N = e.advanceIfRegExp(/^[^\s"'`=<>]+/);
            if (
              N.length > 0 &&
              (e.peekChar() === ee &&
                e.peekChar(-1) === mt &&
                (e.goBack(1), (N = N.substring(0, N.length - 1))),
              h === 'type' && (p = N),
              N.length > 0)
            )
              return ((r = H.WithinTag), (s = !1), b(y, S.AttributeValue));
            let F = e.peekChar();
            return F === qn || F === Pn
              ? (e.advance(1),
                e.advanceUntilChar(F) && e.advance(1),
                h === 'type' && (p = e.getSource().substring(y + 1, e.pos() - 1)),
                (r = H.WithinTag),
                (s = !1),
                b(y, S.AttributeValue))
              : ((r = H.WithinTag), (s = !1), T());
          case H.WithinScriptContent:
            let f = 1;
            for (; !e.eos(); ) {
              let d = e.advanceIfRegExp(/<!--|-->|<\/?script\s*\/?>?/i);
              if (d.length === 0) return (e.goToEnd(), b(y, S.Script));
              if (d === '<!--') f === 1 && (f = 2);
              else if (d === '-->') f = 1;
              else if (d[1] !== '/') f === 2 && (f = 3);
              else if (f === 3) f = 2;
            ...
            return ((r = H.WithinContent), y < e.pos() ? b(y, S.Script) : T());
          case H.WithinStyleContent:
            return (
              e.advanceUntilRegExp(/<\/style/i),
              (r = H.WithinContent),
              y < e.pos() ? b(y, S.Styles) : T()
            );
        }
        return (e.advance(1), (r = H.WithinContent), b(y, S.Unknown, L));
      }
      return {
        scan: D,
        getTokenType: () => c,
        getTokenOffset: () => u,
        getTokenLength: () => e.pos() - u,
        getTokenEnd: () => e.pos(),
        getTokenText: () => e.getSource().substring(u, e.pos()),
        getScannerState: () => r,
        getTokenError: () => i,
      };
    }
    ...
    var Le = class {
        ...
        isSameTag(n) {
          return this.tag === void 0
            ? n === void 0
            : n !== void 0 && this.tag.length === n.length && this.tag.toLowerCase() === n;
        }
        get firstChild() {
        ...
        findNodeBefore(n) {
          let o = gt(this.children, (a) => n <= a.start) - 1;
          if (o >= 0) {
            let a = this.children[o];
            if (n > a.start) {
              if (n < a.end) return a.findNodeBefore(n);
              let e = a.lastChild;
              return e && e.end === a.end ? a.findNodeBefore(n) : a;
            }
          }
          return this;
        }
        findNodeAt(n) {
          ...
          if (o >= 0) {
            let a = this.children[o];
            if (n > a.start && n <= a.end) return a.findNodeAt(n);
          }
          return this;
        }
      },
      Me = class {
        ...
        parseDocument(n) {
          return this.parse(n.getText(), this.dataManager.getVoidElements(n.languageId));
        }
        parse(n, o) {
          let a = V(n, void 0, void 0, !0),
            e = new Le(0, n.length, [], void 0),
            r = e,
            u = -1,
            c,
            i = null,
          ...
          for (; s !== S.EOS; ) {
            switch (s) {
              case S.StartTagOpen:
                let l = new Le(a.getTokenOffset(), n.length, [], r);
                (r.children.push(l), (r = l));
                break;
              case S.StartTag:
                r.tag = a.getTokenText();
                break;
              case S.StartTagClose:
                r.parent &&
                  ((r.end = a.getTokenEnd()),
                  a.getTokenLength()
                    ? ((r.startTagEnd = a.getTokenEnd()),
                      r.tag &&
                        this.dataManager.isVoidElement(r.tag, o) &&
              ...
              case S.StartTagSelfClose:
                ...
                break;
              case S.EndTagOpen:
                ((u = a.getTokenOffset()), (c = void 0));
                break;
              case S.EndTag:
                c = a.getTokenText().toLowerCase();
                break;
              case S.EndTagClose:
                let h = r;
                for (; !h.isSameTag(c) && h.parent; ) h = h.parent;
                if (h.parent) {
                  for (; r !== h; ) ((r.end = u), (r.closed = !1), (r = r.parent));
                  ((r.closed = !0), (r.endTagStart = u), (r.end = a.getTokenEnd()), (r = r.parent));
                }
                break;
              case S.AttributeName: {
                i = a.getTokenText();
                let p = r.attributes;
                (p || (r.attributes = p = {}), (p[i] = null));
                break;
              }
              case S.AttributeValue: {
                let p = a.getTokenText(),
                  m = r.attributes;
                m && i && ((m[i] = p), (i = null));
                break;
              }
          ...
          for (; r.parent; ) ((r.end = n.length), (r.closed = !1), (r = r.parent));
          return {
            roots: e.children,
            findNodeBefore: e.findNodeBefore.bind(e),
            findNodeAt: e.findNodeAt.bind(e),
          };
        }
      };
    var ie = {
...
`,
    ...
    function Z(t, n) {
      ...
      for (let o = 0; o < n.length; o++) if (t[o] !== n[o]) return !1;
      return !0;
    }
    function un(t, n) {
      let o = t.length - n.length;
      return o > 0 ? t.lastIndexOf(n) === o : o === 0 ? t === n : !1;
    }
    function bt(t, n) {
      let o = '';
      for (; n > 0; ) ((n & 1) === 1 && (o += t), (t += t), (n = n >>> 1));
      return o;
    }
    var Qn = 97,
      Zn = 122,
    ...
    function re(t, n) {
      ...
      return (Qn <= o && o <= Zn) || (Kn <= o && o <= ei) || (ti <= o && o <= ni);
    }
    function de(t) {
      return typeof t < 'u';
    }
    ...
    var pe = class {
      ...
      constructor(n, o) {
        ((this.id = n),
          ...
          this._tags.forEach((a) => {
            this._tagMap[a.name.toLowerCase()] = a;
          }),
          o.valueSets &&
            o.valueSets.forEach((a) => {
              this._valueSetMap[a.name] = a.values;
            }));
      }
      getId() {
        return this.id;
      ...
      provideAttributes(n) {
        let o = [],
          ...
          e = this._tagMap[n.toLowerCase()];
        return (e && e.attributes.forEach(a), this._globalAttributes.forEach(a), o);
      }
      provideValues(n, o) {
        let a = [];
        o = o.toLowerCase();
        let e = (u) => {
            u.forEach((c) => {
              c.name.toLowerCase() === o &&
                (c.values &&
                  c.values.forEach((i) => {
                    a.push(i);
                  }),
                c.valueSet &&
                  this._valueSetMap[c.valueSet] &&
                  this._valueSetMap[c.valueSet].forEach((i) => {
                    a.push(i);
                  }));
            });
          },
          r = this._tagMap[n.toLowerCase()];
        return (r && e(r.attributes), e(this._globalAttributes), a);
      }
    };
    function te(t, n = {}, o) {
      let a = { kind: o ? 'markdown' : 'plaintext', value: '' };
      if (t.description && n.documentation !== !1) {
        let e = cn(t.description);
        e && (a.value += e.value);
      }
      if (
        (t.references &&
...
`),
          o
            ? (a.value += t.references.map((e) => `[${e.name}](${e.url})`).join(' | '))
            : (a.value += t.references.map((e) => `${e.name}: ${e.url}`).join(`
`))),
        a.value !== '')
      )
    ...
    var Re = class {
        constructor(n, o) {
          ((this.dataManager = n), (this.readDirectory = o), (this.atributeCompletions = []));
        }
        onHtmlAttributeValue(n) {
          this.dataManager.isPathAttribute(n.tag, n.attribute) && this.atributeCompletions.push(n);
        }
        async computeCompletions(n, o) {
          let a = { items: [], isIncomplete: !1 };
          for (let e of this.atributeCompletions) {
            let r = ai(n.getText(e.range));
            if (oi(r))
              if (r === '.' || r === '..') a.isIncomplete = !0;
              else {
                let u = si(e.value, r, e.range),
                  c = await this.providePathSuggestions(e.value, u, n, o);
                for (let i of c) a.items.push(i);
              }
          }
          return a;
        }
        async providePathSuggestions(n, o, a, e) {
          let r = n.substring(0, n.lastIndexOf('/') + 1),
            u = e.resolveReference(r || '.', a.uri);
          if (u)
            try {
              let c = [],
                i = await this.readDirectory(u);
              for (let [s, l] of i) s.charCodeAt(0) !== ri && c.push(li(s, l === Ee.Directory, o));
              return c;
            } catch {}
          return [];
        }
      ...
      ri = 46;
    function ai(t) {
      return Z(t, "'") || Z(t, '"') ? t.slice(1, -1) : t;
    }
    function oi(t) {
      return !(Z(t, 'http') || Z(t, 'https') || Z(t, '//'));
    }
    function si(t, n, o) {
      let a,
        e = t.lastIndexOf('/');
      if (e === -1) a = ui(o, 1, -1);
        ...
        let r = n.slice(e + 1),
          u = ye(o.end, -1 - r.length),
          c = r.indexOf(' '),
          i;
        (c !== -1 ? (i = ye(u, c)) : (i = ye(o.end, -1)), (a = W.create(u, i)));
      }
      return a;
    }
    function li(t, n, o) {
        ...
        ? ((t = t + '/'),
          {
            label: t,
            kind: $.Folder,
            textEdit: G.replace(o, t),
            command: { title: 'Suggest', command: 'editor.action.triggerSuggest' },
          })
        : { label: t, kind: $.File, textEdit: G.replace(o, t) };
    }
    function ye(t, n) {
      return q.create(t.line, t.character + n);
    }
    function ui(t, n, o) {
      let a = ye(t.start, n),
        e = ye(t.end, o);
    ...
    var ze = class {
      constructor(n, o) {
        ((this.lsOptions = n), (this.dataManager = o), (this.completionParticipants = []));
      }
      setCompletionParticipants(n) {
        this.completionParticipants = n || [];
      }
      async doComplete2(n, o, a, e, r) {
        if (!this.lsOptions.fileSystemProvider || !this.lsOptions.fileSystemProvider.readDirectory)
          return this.doComplete(n, o, a, r);
        let u = new Re(this.dataManager, this.lsOptions.fileSystemProvider.readDirectory),
          c = this.completionParticipants;
        this.completionParticipants = [u].concat(c);
        let i = this.doComplete(n, o, a, r);
        try {
          let s = await u.computeCompletions(n, e);
          return { isIncomplete: i.isIncomplete || s.isIncomplete, items: s.items.concat(i.items) };
        } finally {
          this.completionParticipants = c;
        }
      }
      doComplete(n, o, a, e) {
        let r = this._doComplete(n, o, a, e);
        return this.convertCompletionList(r);
      }
      _doComplete(n, o, a, e) {
        let r = { isIncomplete: !1, items: [] },
          u = this.completionParticipants,
          c = this.dataManager
            .getDataProviders()
            .filter((k) => k.isApplicable(n.languageId) && (!e || e[k.getId()] !== !1)),
          i = this.dataManager.getVoidElements(c),
          s = this.doesSupportMarkdown(),
          l = n.getText(),
          h = n.offsetAt(o),
          p = a.findNodeBefore(h);
        if (!p) return r;
        let m = V(l, p.start),
          A = '',
          b;
        function D(k, x = h) {
          return (k > h && (k = h), { start: n.positionAt(k), end: n.positionAt(x) });
        }
        function T(k, x) {
          let M = D(k, x);
          return (
            c.forEach((B) => {
              B.provideTags().forEach((O) => {
                r.items.push({
                  label: O.name,
                  kind: $.Property,
                  documentation: te(O, void 0, s),
                  textEdit: G.replace(M, O.name),
...
\r`.indexOf(M) >= 0
        ...
        function L(k, x, M = h) {
          let B = D(k, M),
            O = hn(l, M, H.WithinEndTag, S.EndTagClose) ? '' : '>',
            z = p;
          for (x && (z = z.parent); z; ) {
            let U = z.tag;
            if (U && (!z.closed || (z.endTagStart && z.endTagStart > h))) {
              let P = {
                  label: '/' + U,
                  kind: $.Property,
                  filterText: '/' + U,
                  textEdit: G.replace(B, '/' + U + O),
                  insertTextFormat: X.PlainText,
                },
                j = y(z.start),
                K = y(k - 1);
              if (j !== null && K !== null && j !== K) {
                let ae = j + '</' + U + O;
                ((P.textEdit = G.replace(D(k - 1 - K.length), ae)), (P.filterText = K + '</' + U));
              }
          ...
          return (
            x ||
              c.forEach((U) => {
                U.provideTags().forEach((P) => {
                  r.items.push({
                    label: '/' + P.name,
                    kind: $.Property,
                    documentation: te(P, void 0, s),
                    filterText: '/' + P.name + O,
                    textEdit: G.replace(B, '/' + P.name + O),
                    insertTextFormat: X.PlainText,
                  });
                });
              }),
        ...
        let I = (k, x) => {
          if (e && e.hideAutoCompleteProposals) return r;
          if (!this.dataManager.isVoidElement(x, i)) {
            let M = n.positionAt(k);
            r.items.push({
              label: '</' + x + '>',
              kind: $.Property,
              filterText: '</' + x + '>',
              textEdit: G.insert(M, '$0</' + x + '>'),
        ...
        function N(k, x) {
          return (T(k, x), L(k, !0, x), r);
        }
        function F() {
          let k = Object.create(null);
          return (
            p.attributeNames.forEach((x) => {
              k[x] = !0;
            }),
            k
          );
        ...
        function f(k, x = h) {
          let M = h;
          for (; M < x && l[M] !== '<'; ) M++;
          let B = l.substring(k, x),
            O = D(k, M),
            z = '';
          if (!hn(l, x, H.AfterAttributeName, S.DelimiterAssign)) {
            let P = e?.attributeDefaultValue ?? 'doublequotes';
            P === 'empty' ? (z = '=$1') : P === 'singlequotes' ? (z = "='$1'") : (z = '="$1"');
          }
          let U = F();
          return (
            (U[B] = !1),
            c.forEach((P) => {
              P.provideAttributes(A).forEach((j) => {
                if (U[j.name]) return;
                U[j.name] = !0;
                let K = j.name,
                  ae;
                (j.valueSet !== 'v' &&
                  ...
                  (j.valueSet || j.name === 'style') &&
                    (ae = { title: 'Suggest', command: 'editor.action.triggerSuggest' })),
                  r.items.push({
                    label: j.name,
                    kind: j.valueSet === 'handler' ? $.Function : $.Value,
                    documentation: te(j, void 0, s),
                    textEdit: G.replace(O, K),
                    insertTextFormat: X.Snippet,
                    command: ae,
                  }));
              });
        ...
        function d(k, x) {
          ...
          B[M] = `${M}$1="$2"`;
          function O(z) {
            (z.attributeNames.forEach((U) => {
              Z(U, M) && !B[U] && !x[U] && (B[U] = U + '="$1"');
            }),
              z.children.forEach((U) => O(U)));
          }
          (a && a.roots.forEach((z) => O(z)),
            Object.keys(B).forEach((z) =>
              r.items.push({
                label: z,
                kind: $.Value,
                textEdit: G.replace(k, B[z]),
                insertTextFormat: X.Snippet,
              })
            ));
        }
        function g(k, x = h) {
          ...
          if (h > k && h <= x && ci(l[k])) {
            ...
            let P = hi(l, h, z),
              j = di(l, h, U);
            ((M = D(P, j)), (O = h >= z && h <= U ? l.substring(z, h) : ''), (B = !1));
          } else ((M = D(k, x)), (O = l.substring(k, h)), (B = !0));
          if (u.length > 0) {
            let z = A.toLowerCase(),
              U = b.toLowerCase(),
              P = D(k, x);
          ...
          return (
            c.forEach((z) => {
              z.provideValues(A, b).forEach((U) => {
                let P = B ? '"' + U.name + '"' : U.name;
                r.items.push({
                  label: U.name,
                  filterText: P,
                  kind: $.Unit,
                  documentation: te(U, void 0, s),
                  textEdit: G.replace(M, P),
                  insertTextFormat: X.PlainText,
                });
              });
            }),
        ...
        function R(k) {
          return h === m.getTokenEnd() && ((E = m.scan()), E === k && m.getTokenOffset() === h)
            ? m.getTokenEnd()
            : h;
        }
        function v() {
          for (let k of u) k.onHtmlContent && k.onHtmlContent({ document: n, position: o });
          return _();
        }
        function _() {
          let k = h - 1,
          ...
          for (; k >= 0 && re(l, k); ) (k--, x--);
          if (k >= 0 && l[k] === '&') {
            let M = W.create(q.create(o.line, x - 1), o);
            for (let B in ie)
              if (un(B, ';')) {
                let O = '&' + B;
                r.items.push({
                  label: O,
                  kind: $.Keyword,
                  documentation: J("Character entity representing '{0}'", ie[B]),
                  textEdit: G.replace(M, O),
                  insertTextFormat: X.PlainText,
                });
              }
          }
        ...
        function C(k, x) {
          ...
          r.items.push({
            ...
            textEdit: G.replace(M, '!DOCTYPE html>'),
            insertTextFormat: X.PlainText,
          });
        }
        let E = m.scan();
        for (; E !== S.EOS && m.getTokenOffset() <= h; ) {
          switch (E) {
            case S.StartTagOpen:
              if (m.getTokenEnd() === h) {
                let k = R(S.StartTag);
                return (o.line === 0 && C(h, k), N(h, k));
              }
              break;
            case S.StartTag:
            ...
            case S.EndTag:
              if (h <= m.getTokenEnd()) {
                ...
                for (; k >= 0; ) {
                  let x = l.charAt(k);
                  if (x === '/') return L(k, !1, m.getTokenEnd());
                  if (!He(x)) break;
                  k--;
                }
              }
              break;
            case S.StartTagClose:
              if (h <= m.getTokenEnd() && A) return I(m.getTokenEnd(), A);
              break;
            case S.Content:
              if (h <= m.getTokenEnd()) return v();
              break;
            default:
              if (h <= m.getTokenEnd()) return r;
              break;
          }
          E = m.scan();
        }
      ...
      doQuoteComplete(n, o, a, e) {
        let r = n.offsetAt(o);
        if (r <= 0) return null;
        let u = e?.attributeDefaultValue ?? 'doublequotes';
        if (u === 'empty' || n.getText().charAt(r - 1) !== '=') return null;
        let i = u === 'doublequotes' ? '"$1"' : "'$1'",
          s = a.findNodeBefore(r);
        if (s && s.attributes && s.start < r && (!s.endTagStart || s.endTagStart > r)) {
          let l = V(n.getText(), s.start),
            h = l.scan();
          for (; h !== S.EOS && l.getTokenEnd() <= r; ) {
            if (h === S.AttributeName && l.getTokenEnd() === r - 1)
              return (
                (h = l.scan()),
                h !== S.DelimiterAssign ||
                ((h = l.scan()), h === S.Unknown || h === S.AttributeValue)
                  ? null
                  : i
              );
            h = l.scan();
      ...
      doTagComplete(n, o, a) {
        let e = n.offsetAt(o);
        if (e <= 0) return null;
        let r = n.getText().charAt(e - 1);
        if (r === '>') {
          let u = this.dataManager.getVoidElements(n.languageId),
            c = a.findNodeBefore(e);
          if (
            c &&
            c.tag &&
            !this.dataManager.isVoidElement(c.tag, u) &&
            c.start < e &&
            (!c.endTagStart || c.endTagStart > e)
          ) {
            let i = V(n.getText(), c.start),
              s = i.scan();
            for (; s !== S.EOS && i.getTokenEnd() <= e; ) {
              if (s === S.StartTagClose && i.getTokenEnd() === e) return `$0</${c.tag}>`;
              s = i.scan();
            }
          }
        } else if (r === '/') {
          let u = a.findNodeBefore(e);
          for (; u && u.closed && !(u.endTagStart && u.endTagStart > e); ) u = u.parent;
          if (u && u.tag) {
            let c = V(n.getText(), u.start),
              i = c.scan();
            for (; i !== S.EOS && c.getTokenEnd() <= e; ) {
              if (i === S.EndTagOpen && c.getTokenEnd() === e)
                return n.getText().charAt(e) !== '>' ? `${u.tag}>` : u.tag;
              i = c.scan();
            }
          }
        }
      ...
      doesSupportMarkdown() {
        if (!de(this.supportsMarkdown)) {
          if (!de(this.lsOptions.clientCapabilities))
            return ((this.supportsMarkdown = !0), this.supportsMarkdown);
          let n =
            this.lsOptions.clientCapabilities.textDocument?.completion?.completionItem
              ?.documentationFormat;
          this.supportsMarkdown = Array.isArray(n) && n.indexOf(Q.Markdown) !== -1;
        }
    ...
    var Ie = class {
      constructor(n, o) {
        ((this.lsOptions = n), (this.dataManager = o));
      }
      doHover(n, o, a, e) {
        let r = this.convertContents.bind(this),
          u = this.doesSupportMarkdown(),
          c = n.offsetAt(o),
          i = a.findNodeAt(c),
          s = n.getText();
        if (!i || !i.tag) return null;
        let l = this.dataManager.getDataProviders().filter((f) => f.isApplicable(n.languageId));
        function h(f, d, g) {
          for (let R of l) {
            let v = null;
            if (
              (R.provideTags().forEach((_) => {
                if (_.name.toLowerCase() === f.toLowerCase()) {
                  let C = te(_, e, u);
                  (C || (C = { kind: u ? 'markdown' : 'plaintext', value: '' }),
                    (v = { contents: C, range: d }));
                }
              }),
              v)
            )
              return ((v.contents = r(v.contents)), v);
          }
          return null;
        }
        function p(f, d, g) {
          for (let R of l) {
            let v = null;
            if (
              (R.provideAttributes(f).forEach((_) => {
                if (d === _.name && _.description) {
                  let C = te(_, e, u);
                  C ? (v = { contents: C, range: g }) : (v = null);
                }
              }),
              v)
            )
        ...
        function m(f, d, g, R) {
          for (let v of l) {
            let _ = null;
            if (
              (v.provideValues(f, d).forEach((C) => {
                if (g === C.name && C.description) {
                  let E = te(C, e, u);
                  E ? (_ = { contents: E, range: R }) : (_ = null);
                }
              }),
              _)
            )
              return ((_.contents = r(_.contents)), _);
          }
          return null;
        }
        function A(f, d) {
          ...
          for (let R in ie) {
            let v = null,
              _ = '&' + R;
            if (g === _) {
              let C = ie[R].charCodeAt(0).toString(16).toUpperCase(),
                E = 'U+';
              if (C.length < 4) {
                let x = 4 - C.length,
                  M = 0;
              ...
              E += C;
              let k = J("Character entity representing '{0}', unicode equivalent '{1}'", ie[R], E);
              k ? (v = { contents: k, range: d }) : (v = null);
            }
            if (v) return ((v.contents = r(v.contents)), v);
          }
          return null;
        }
        function b(f, d) {
          let g = V(n.getText(), d),
            R = g.scan();
          for (; R !== S.EOS && (g.getTokenEnd() < c || (g.getTokenEnd() === c && R !== f)); )
            R = g.scan();
          return R === f && c <= g.getTokenEnd()
            ? { start: n.positionAt(g.getTokenOffset()), end: n.positionAt(g.getTokenEnd()) }
            : null;
        }
        function D() {
          let f = c - 1,
          ...
          if (f >= 0 && s[f] === '&') {
            ...
            return (
              s[g] === ';'
                ? (v = W.create(q.create(o.line, d), q.create(o.line, R + 1)))
                : (v = W.create(q.create(o.line, d), q.create(o.line, R))),
              v
            );
          }
          return null;
        ...
        function T(f) {
          let d = c - 1,
            g = '&';
          for (; d >= 0 && re(f, d); ) d--;
          for (d = d + 1; re(f, d); ) ((g += f[d]), (d += 1));
          return ((g += ';'), g);
        }
        if (i.endTagStart && c >= i.endTagStart) {
          let f = b(S.EndTag, i.endTagStart);
          return f ? h(i.tag, f, !1) : null;
        }
        let y = b(S.StartTag, i.start);
        if (y) return h(i.tag, y, !0);
        let L = b(S.AttributeName, i.start);
        if (L) {
          let f = i.tag,
            d = n.getText(L);
          return p(f, d, L);
        ...
        function N(f, d) {
          let g = V(n.getText(), f),
            R = g.scan(),
            v;
          for (; R !== S.EOS && g.getTokenEnd() <= d; )
            ((R = g.scan()), R === S.AttributeName && (v = g.getTokenText()));
          return v;
        }
        let F = b(S.AttributeValue, i.start);
        if (F) {
          let f = i.tag,
            d = pi(n.getText(F)),
            g = N(i.start, n.offsetAt(F.start));
          if (g) return m(f, g, d, F);
        }
        return null;
      }
      convertContents(n) {
        if (!this.doesSupportMarkdown()) {
          ...
          if ('kind' in n) return { kind: 'plaintext', value: n.value };
          if (Array.isArray(n)) n.map((o) => (typeof o == 'string' ? o : o.value));
          else return n.value;
        }
        return n;
      }
      doesSupportMarkdown() {
        if (!de(this.supportsMarkdown)) {
          if (!de(this.lsOptions.clientCapabilities))
            return ((this.supportsMarkdown = !0), this.supportsMarkdown);
          let n = this.lsOptions.clientCapabilities?.textDocument?.hover?.contentFormat;
          this.supportsMarkdown = Array.isArray(n) && n.indexOf(Q.Markdown) !== -1;
        }
        return this.supportsMarkdown;
      }
      ...
      var t = [
          ...
          function (e) {
            ...
            ((r.prototype.clone_empty = function () {
              var i = new r(this.__parent);
              return (i.set_indent(this.__indent_count, this.__alignment_count), i);
            }),
              (r.prototype.item = function (i) {
                return i < 0 ? this.__items[this.__items.length + i] : this.__items[i];
              }),
              (r.prototype.has_match = function (i) {
                for (var s = this.__items.length - 1; s >= 0; s--)
                  if (this.__items[s].match(i)) return !0;
                return !1;
              }),
              (r.prototype.set_indent = function (i, s) {
                this.is_empty() &&
                  ((this.__indent_count = i || 0),
              ...
              (r.prototype._allow_wrap = function () {
                if (this._should_wrap()) {
                  ...
                  return (
                    i.set_indent(this.__wrap_point_indent_count, this.__wrap_point_alignment_count),
                    (i.__items = this.__items.slice(this.__wrap_point_index)),
                    (this.__items = this.__items.slice(0, this.__wrap_point_index)),
                    (i.__character_count +=
                      this.__character_count - this.__wrap_point_character_count),
                    (this.__character_count = this.__wrap_point_character_count),
                    i.__items[0] === ' ' && (i.__items.splice(0, 1), (i.__character_count -= 1)),
                    !0
                  );
                }
                return !1;
...
`);
                s !== -1
                  ? (this.__character_count = i.length - s)
                  : (this.__character_count += i.length);
              }),
              (r.prototype.pop = function () {
                var i = null;
                return (
                  this.is_empty() ||
                    ((i = this.__items.pop()), (this.__character_count -= i.length)),
                  i
                );
              }),
                ...
                return (
                  this.is_empty()
                    ? this.__parent.indent_empty_lines &&
                      (i = this.__parent.get_indent_string(this.__indent_count))
                    : ((i = this.__parent.get_indent_string(
                        this.__indent_count,
                        this.__alignment_count
                      )),
                      (i += this.__items.join(''))),
            ...
            function u(i, s) {
              ((this.__cache = ['']),
                (this.__indent_size = i.indent_size),
                (this.__indent_string = i.indent_char),
                i.indent_with_tabs ||
                  (this.__indent_string = new Array(i.indent_size + 1).join(i.indent_char)),
                (s = s || ''),
                i.indent_level > 0 &&
                  (s = new Array(i.indent_level + 1).join(this.__indent_string)),
                (this.__base_string = s),
                (this.__base_string_length = s.length));
            }
            ((u.prototype.get_indent_size = function (i, s) {
              var l = this.__base_string_length;
              return ((s = s || 0), i < 0 && (l = 0), (l += i * this.__indent_size), (l += s), l);
            }),
              (u.prototype.get_indent_string = function (i, s) {
                var l = this.__base_string;
                return (
                  (s = s || 0),
                  i < 0 && ((i = 0), (l = '')),
                  (s += i * this.__indent_size),
                  this.__ensure_cache(s),
                  (l += this.__cache[s]),
                  l
                );
              }),
              (u.prototype.__ensure_cache = function (i) {
                for (; i >= this.__cache.length; ) this.__add_column();
              }),
              (u.prototype.__add_column = function () {
                var i = this.__cache.length,
                  s = 0,
                  l = '';
                (this.__indent_size &&
                  i >= this.__indent_size &&
                  ((s = Math.floor(i / this.__indent_size)),
                  (i -= s * this.__indent_size),
                  (l = new Array(s + 1).join(this.__indent_string))),
                  i && (l += new Array(i + 1).join(' ')),
                  this.__cache.push(l));
              }));
            function c(i, s) {
              ((this.__indent_cache = new u(i, s)),
                (this.raw = !1),
                (this._end_with_newline = i.end_with_newline),
                (this.indent_size = i.indent_size),
                (this.wrap_line_length = i.wrap_line_length),
                (this.indent_empty_lines = i.indent_empty_lines),
                (this.__lines = []),
            ...
            ((c.prototype.__add_outputline = function () {
              ...
              (c.prototype.get_indent_string = function (i, s) {
                return this.__indent_cache.get_indent_string(i, s);
              }),
              (c.prototype.get_indent_size = function (i, s) {
                return this.__indent_cache.get_indent_size(i, s);
              }),
              (c.prototype.is_empty = function () {
                return !this.previous_line && this.current_line.is_empty();
              }),
              (c.prototype.add_new_line = function (i) {
                return this.is_empty() || (!i && this.just_added_newline())
                  ? !1
                  : (this.raw || this.__add_outputline(), !0);
              }),
              (c.prototype.get_code = function (i) {
                this.trim(!0);
...
` && (l = l.replace(/[\n]/g, i)),
              ...
              (c.prototype.set_indent = function (i, s) {
                return (
                  (i = i || 0),
                  (s = s || 0),
                  this.next_line.set_indent(i, s),
                  this.__lines.length > 1
                    ? (this.current_line.set_indent(i, s), !0)
                    : (this.current_line.set_indent(), !1)
                );
              }),
              (c.prototype.add_raw_token = function (i) {
                for (var s = 0; s < i.newlines; s++) this.__add_outputline();
                (this.current_line.set_indent(-1),
                  this.current_line.push(i.whitespace_before),
                  this.current_line.push(i.text),
                  (this.space_before_token = !1),
                  (this.non_breaking_space = !1),
                  (this.previous_token_wrapped = !1));
              }),
              (c.prototype.add_token = function (i) {
              ...
              (c.prototype.remove_indent = function (i) {
                for (var s = this.__lines.length; i < s; ) (this.__lines[i]._remove_indent(), i++);
                this.current_line._remove_wrap_indent();
              }),
              (c.prototype.trim = function (i) {
                for (
                  i = i === void 0 ? !1 : i, this.current_line.trim();
                  i && this.__lines.length > 1 && this.current_line.is_empty();
              ...
              (c.prototype.ensure_empty_line_above = function (i, s) {
                for (var l = this.__lines.length - 2; l >= 0; ) {
                  var h = this.__lines[l];
                  if (h.is_empty()) break;
                  if (h.item(0).indexOf(i) !== 0 && h.item(-1) !== s) {
                    (this.__lines.splice(l + 1, 0, new r(this)),
          ...
          function (e) {
            ...
            ((r.prototype._get_array = function (i, s) {
              var l = this.raw_options[i],
                h = s || [];
              return (
                typeof l == 'object'
                  ? l !== null && typeof l.concat == 'function' && (h = l.concat())
                  : typeof l == 'string' && (h = l.split(/[^a-zA-Z0-9_\/\-]+/)),
                h
              );
            }),
              (r.prototype._get_boolean = function (i, s) {
                var l = this.raw_options[i],
                  h = l === void 0 ? !!s : !!l;
                return h;
              }),
              (r.prototype._get_characters = function (i, s) {
                var l = this.raw_options[i],
                  h = s || '';
                return (
                  typeof l == 'string' &&
...
`
              ...
              (r.prototype._get_number = function (i, s) {
                var l = this.raw_options[i];
                ((s = parseInt(s, 10)), isNaN(s) && (s = 0));
                var h = parseInt(l, 10);
                return (isNaN(h) && (h = s), h);
              }),
              (r.prototype._get_selection = function (i, s, l) {
                var h = this._get_selection_list(i, s, l);
                if (h.length !== 1)
                  throw new Error(
...
You passed in: '` +
              ...
              (r.prototype._is_valid_selection = function (i, s) {
                return (
                  i.length &&
                  s.length &&
                  !i.some(function (l) {
            ...
            function u(i, s) {
              ...
              i = c(i);
              var h;
              for (h in i) h !== s && (l[h] = i[h]);
              if (s && i[s]) for (h in i[s]) l[h] = i[s][h];
              return l;
            }
            function c(i) {
              var s = {},
            ...
            ((e.exports.Options = r), (e.exports.normalizeOpts = c), (e.exports.mergeOpts = u));
          },
          ,
          function (e) {
            ...
            ((u.prototype.restart = function () {
              ...
              (u.prototype.next = function () {
                ...
                return (
                  this.hasNext() &&
                    ((c = this.__input.charAt(this.__position)), (this.__position += 1)),
                  c
                );
              }),
              (u.prototype.peek = function (c) {
                var i = null;
                return (
                  (c = c || 0),
                  (c += this.__position),
                  c >= 0 && c < this.__input_length && (i = this.__input.charAt(c)),
                  i
                );
              }),
              (u.prototype.__match = function (c, i) {
                c.lastIndex = i;
                var s = c.exec(this.__input);
                return (s && !(r && c.sticky) && s.index !== i && (s = null), s);
              }),
              (u.prototype.test = function (c, i) {
                return (
                  (i = i || 0),
                  (i += this.__position),
                  i >= 0 && i < this.__input_length ? !!this.__match(c, i) : !1
                );
              }),
              (u.prototype.testChar = function (c, i) {
                var s = this.peek(i);
                return ((c.lastIndex = 0), s !== null && c.test(s));
              }),
              (u.prototype.match = function (c) {
                var i = this.__match(c, this.__position);
                return (i ? (this.__position += i[0].length) : (i = null), i);
              }),
              (u.prototype.read = function (c, i, s) {
                var l = '',
                  h;
                return (
                  c && ((h = this.match(c)), h && (l += h[0])),
                  i && (h || !c) && (l += this.readUntil(i, s)),
                  l
                );
              }),
              (u.prototype.readUntil = function (c, i) {
                var s = '',
                  l = this.__position;
                c.lastIndex = this.__position;
                var h = c.exec(this.__input);
                return (
                  h ? ((l = h.index), i && (l += h[0].length)) : (l = this.__input_length),
                  (s = this.__input.substring(this.__position, l)),
                  (this.__position = l),
                  s
                );
              }),
              (u.prototype.readUntilAfter = function (c) {
                return this.readUntil(c, !0);
              }),
              (u.prototype.get_regexp = function (c, i) {
                var s = null,
                  l = 'g';
                return (
                  i && r && (l = 'y'),
                  typeof c == 'string' && c !== ''
                    ? (s = new RegExp(c, l))
                    : c && (s = new RegExp(c.source, l)),
                  s
                );
              }),
              (u.prototype.get_literal_regexp = function (c) {
                return RegExp(c.replace(/[-\/\\^$*+?.()|[\]{}]/g, '\\$&'));
              }),
              (u.prototype.peekUntilAfter = function (c) {
                var i = this.__position,
                  s = this.readUntilAfter(c);
                return ((this.__position = i), s);
              }),
              (u.prototype.lookBack = function (c) {
                var i = this.__position - 1;
                return i >= c.length && this.__input.substring(i - c.length, i).toLowerCase() === c;
              }),
              (e.exports.InputScanner = u));
          },
          ,
          ,
          ,
            ...
            function r(u, c) {
              ((u = typeof u == 'string' ? u : u.source),
                ...
                (this.__directives_block_pattern = new RegExp(
                  u + / beautify( \w+[:]\w+)+ /.source + c,
                  'g'
                )),
                (this.__directive_pattern = / (\w+)[:](\w+)/g),
                (this.__directives_end_ignore_pattern = new RegExp(
                  u + /\sbeautify\signore:end\s/.source + c,
                  'g'
                )));
            }
            ((r.prototype.get_directives = function (u) {
              if (!u.match(this.__directives_block_pattern)) return null;
              var c = {};
              this.__directive_pattern.lastIndex = 0;
              for (var i = this.__directive_pattern.exec(u); i; )
                ((c[i[1]] = i[2]), (i = this.__directive_pattern.exec(u)));
              return c;
            }),
              (r.prototype.readIgnored = function (u) {
...
`
              ...
              (y.prototype.eatWhitespace = function (L) {
                for (var I = A.test(this._input.peek()), N = 0; A.test(this._input.peek()); )
                  ((this._ch = this._input.next()),
                    L &&
                      this._ch ===
                        `
` &&
              ...
              (y.prototype.foundNestedPseudoClass = function () {
                for (var L = 0, I = 1, N = this._input.peek(I); N; ) {
                  if (N === '{') return !0;
                  if (N === '(') L += 1;
                  else if (N === ')') {
                    if (L === 0) return !1;
...
`
                ...
                ((this._output = new i(this._options, N)),
                  ...
                  (this._ch = null));
                for (
                  var F = 0, f = !1, d = !1, g = !1, R = !1, v = !1, _ = this._ch, C = !1, E, k, x;
                  (E = this._input.read(b)),
                    (k = E !== ''),
                    (x = _),
                    (this._ch = this._input.next()),
                  ...
                  if (this._ch === '/' && this._input.peek() === '*') {
                    ...
                    var M = this._input.read(D),
                      B = h.get_directives(M);
                    (B && B.ignore === 'start' && (M += h.readIgnored(this._input)),
                      this.print_string(M),
                    ...
                    (O.match(/[ :]$/) &&
                      ...
                      this.print_string(O),
                      (this._output.space_before_token = !0)),
                      F === 0 && O.indexOf(':') !== -1 && ((d = !0), this.indent()));
                  } else if (this._ch === '@')
                    if ((this.preserveSingleSpace(k), this._input.peek() === '{'))
                      ...
                      (z.match(/[ :]$/) &&
                        ((z = this.eatString(': ').replace(/\s+$/, '')),
                        this.print_string(z),
                        (this._output.space_before_token = !0)),
                        F === 0 && z.indexOf(':') !== -1
                          ? ((d = !0), this.indent())
                          : z in this.NESTED_AT_RULE
                            ? ((this._nestedLevel += 1),
                              z in this.CONDITIONAL_GROUP_RULE && (g = !0))
                            : F === 0 && !d && (R = !0));
                    }
                  else if (this._ch === '#' && this._input.peek() === '{')
                    (this.preserveSingleSpace(k),
                      this.print_string(this._ch + this.eatString('}')));
                  else if (this._ch === '{')
                    (d && ((d = !1), this.outdent()),
                      (R = !1),
                      g
                        ? ((g = !1), (f = this._indentLevel >= this._nestedLevel))
                    ...
                    if (this._input.lookBack('url'))
                      ...
                      var j = !1;
                      (this._input.lookBack('with') && (j = !0),
                        this.preserveSingleSpace(k || j),
                        this.print_string(this._ch),
                        d && x === '$' && this._options.selector_separator_newline
                          ? (this._output.add_new_line(), (v = !0))
                          : (this.eatWhitespace(), F++, this.indent()));
                    }
                  else if (this._ch === ')')
                    (F && (F--, this.outdent()),
                      v &&
                    ...
                    (this.print_string(this._ch),
                      this.eatWhitespace(!0),
                      this._options.selector_separator_newline && (!d || v) && F === 0 && !R
                        ? this._output.add_new_line()
                        : (this._output.space_before_token = !0));
                  else if (
                    (this._ch === '>' || this._ch === '+' || this._ch === '~') &&
...
` &&
                ...
                var ae = this._output.get_code(I);
                return ae;
              }),
              (e.exports.Beautifier = y));
          },
          function (e, r, u) {
            var c = u(6).Options;
            function i(s) {
              ...
              var l = this._get_boolean('space_around_selector_separator');
              this.space_around_combinator = this._get_boolean('space_around_combinator') || l;
              ...
              for (var p = 0; p < h.length; p++)
                h[p] !== 'expand' ? (this.brace_style = 'collapse') : (this.brace_style = h[p]);
            }
            ((i.prototype = new c()), (e.exports.Options = i));
          },
        ],
        n = {};
      function o(e) {
...
You passed in: '` +
          ...
          function (e, r, u) {
            var c = u(8).InputScanner,
              i = u(3).Token,
              s = u(10).TokenStream,
              l = u(11).WhitespacePattern,
              ...
              p = function (m, A) {
                ((this._input = new c(m)),
                  ...
                  (this.__tokens = null),
                  (this._patterns = {}),
                  (this._patterns.whitespace = new l(this._input)));
              };
            ((p.prototype.tokenize = function () {
              (this._input.restart(), (this.__tokens = new s()), this._reset());
              for (
                var m, A = new i(h.START, ''), b = null, D = [], T = new s();
                A.type !== h.EOF;

              ) {
                for (m = this._get_next_token(A, b); this._is_comment(m); )
                  (T.add(m), (m = this._get_next_token(A, b)));
                (T.isEmpty() || ((m.comments_before = T), (T = new s())),
                  (m.parent = b),
                  this._is_opening(m)
                    ? (D.push(b), (b = m))
                    : b &&
                      this._is_closing(m, b) &&
                      ((m.opened = b), (b.closed = m), (b = D.pop()), (m.parent = b)),
                  (m.previous = A),
                  (A.next = m),
                  this.__tokens.add(m),
                  (A = m));
              ...
              (p.prototype._get_next_token = function (m, A) {
                this._readWhitespace();
                var b = this._input.read(/.+/g);
                return b ? this._create_token(h.RAW, b) : this._create_token(h.EOF, '');
              }),
              (p.prototype._is_comment = function (m) {
                return !1;
              }),
              (p.prototype._is_opening = function (m) {
                return !1;
              }),
              (p.prototype._is_closing = function (m, A) {
                return !1;
              }),
              (p.prototype._create_token = function (m, A) {
                var b = new i(
                  m,
                  A,
          ...
          function (e) {
            ...
            ((r.prototype.restart = function () {
              ...
              (r.prototype.next = function () {
                var u = null;
                return (
                  this.hasNext() && ((u = this.__tokens[this.__position]), (this.__position += 1)),
                  u
                );
              }),
              (r.prototype.peek = function (u) {
                var c = null;
                return (
                  (u = u || 0),
                  (u += this.__position),
                  u >= 0 && u < this.__tokens_length && (c = this.__tokens[u]),
                  c
                );
              }),
              (r.prototype.add = function (u) {
                (this.__parent_token && (u.parent = this.__parent_token),
                  this.__tokens.push(u),
          ...
          function (e, r, u) {
            ...
            function i(s, l) {
              (c.call(this, s, l),
                l
                  ? (this._line_regexp = this._input.get_regexp(l._line_regexp))
                  : this.__set_whitespace_patterns('', ''),
                (this.newline_count = 0),
                (this.whitespace_before_token = ''));
            }
            ((i.prototype = new c()),
              (i.prototype.__set_whitespace_patterns = function (s, l) {
                ((s += '\\t '),
                  (l += '\\n\\r'),
                  (this._match_pattern = this._input.get_regexp('[' + s + l + ']+', !0)),
              ...
              (i.prototype.read = function () {
                ...
                if (s === ' ') this.whitespace_before_token = ' ';
                  ...
                  var l = this.__split(this._newline_regexp, s);
                  ((this.newline_count = l.length - 1),
                    (this.whitespace_before_token = l[this.newline_count]));
                }
                return s;
              }),
              (i.prototype.matching = function (s, l) {
                var h = this._create();
                return (h.__set_whitespace_patterns(s, l), h._update(), h);
              }),
              (i.prototype._create = function () {
                return new i(this._input, this);
              }),
              (i.prototype.__split = function (s, l) {
                s.lastIndex = 0;
                for (var h = 0, p = [], m = s.exec(l); m; )
                  (p.push(l.substring(h, m.index)), (h = m.index + m[0].length), (m = s.exec(l)));
                return (h < l.length ? p.push(l.substring(h, l.length)) : p.push(''), p);
              }),
          ...
          function (e) {
            function r(u, c) {
              ((this._input = u),
                ...
                (this._until_after = !1),
                c &&
                  ((this._starting_pattern = this._input.get_regexp(c._starting_pattern, !0)),
                  (this._match_pattern = this._input.get_regexp(c._match_pattern, !0)),
                  (this._until_pattern = this._input.get_regexp(c._until_pattern)),
                  (this._until_after = c._until_after)));
            }
            ((r.prototype.read = function () {
              var u = this._input.read(this._starting_pattern);
              return (
                (!this._starting_pattern || u) &&
                  (u += this._input.read(
                    this._match_pattern,
                    this._until_pattern,
                    this._until_after
              ...
              (r.prototype.until_after = function (u) {
                var c = this._create();
                return (
                  (c._until_after = !0),
                  (c._until_pattern = this._input.get_regexp(u)),
                  c._update(),
                  c
                );
              }),
              (r.prototype.until = function (u) {
                var c = this._create();
                return (
                  (c._until_after = !1),
                  (c._until_pattern = this._input.get_regexp(u)),
              ...
              (r.prototype.starting_with = function (u) {
                var c = this._create();
                return ((c._starting_pattern = this._input.get_regexp(u, !0)), c._update(), c);
              }),
              (r.prototype.matching = function (u) {
                var c = this._create();
                return ((c._match_pattern = this._input.get_regexp(u, !0)), c._update(), c);
              }),
          ...
          function (e, r, u) {
            var c = u(12).Pattern,
              i = { django: !1, erb: !1, handlebars: !1, php: !1, smarty: !1, angular: !1 };
            function s(l, h) {
              (c.call(this, l, h),
              ...
              this.__patterns = {
                ...
                handlebars_unescaped: p.starting_with(/{{{/).until_after(/}}}/),
                handlebars: p.starting_with(/{{/).until_after(/}}/),
                php: p.starting_with(/<\?(?:[= ]|php)/).until_after(/\?>/),
                erb: p.starting_with(/<%[^%]/).until_after(/[^%]%>/),
                django: p.starting_with(/{%/).until_after(/%}/),
                django_value: p.starting_with(/{{/).until_after(/}}/),
                django_comment: p.starting_with(/{#/).until_after(/#}/),
                smarty: p.starting_with(/{(?=[^}{\s\n])/).until_after(/[^\s\n]}/),
                smarty_comment: p.starting_with(/{\*/).until_after(/\*}/),
                smarty_literal: p.starting_with(/{literal}/).until_after(/{\/literal}/),
              };
            }
            ((s.prototype = new c()),
              ...
              (s.prototype.disable = function (l) {
                var h = this._create();
                return ((h._disabled[l] = !0), h._update(), h);
              }),
              (s.prototype.read_options = function (l) {
                var h = this._create();
                for (var p in i) h._disabled[p] = l.templating.indexOf(p) === -1;
                return (h._update(), h);
              }),
              (s.prototype.exclude = function (l) {
                var h = this._create();
                return ((h._excluded[l] = !0), h._update(), h);
              }),
              (s.prototype.read = function () {
                var l = '';
                this._match_pattern
                  ? (l = this._input.read(this._starting_pattern))
                  : (l = this._input.read(this._starting_pattern, this.__template_pattern));
                ...
                return (
                  this._until_after && (l += this._input.readUntilAfter(this._until_pattern)),
                  l
                );
              }),
              (s.prototype.__set_templated_pattern = function () {
                var l = [];
                (this._disabled.php || l.push(this.__patterns.php._starting_pattern.source),
                  this._disabled.handlebars ||
                    l.push(this.__patterns.handlebars._starting_pattern.source),
                  this._disabled.erb || l.push(this.__patterns.erb._starting_pattern.source),
                  this._disabled.django ||
                    (l.push(this.__patterns.django._starting_pattern.source),
                    l.push(this.__patterns.django_value._starting_pattern.source),
                    l.push(this.__patterns.django_comment._starting_pattern.source)),
                  this._disabled.smarty || l.push(this.__patterns.smarty._starting_pattern.source),
                  this._until_pattern && l.push(this._until_pattern.source),
                  (this.__template_pattern = this._input.get_regexp('(?:' + l.join('|') + ')')));
              }),
              (s.prototype._read_template = function () {
                ...
                if (h === '<') {
                  ...
                  (!this._disabled.php &&
                    !this._excluded.php &&
                    p === '?' &&
                    (l = l || this.__patterns.php.read()),
                    !this._disabled.erb &&
                      !this._excluded.erb &&
                      p === '%' &&
                      (l = l || this.__patterns.erb.read()));
                } else
                  h === '{' &&
                    (!this._disabled.handlebars &&
                      !this._excluded.handlebars &&
                      ((l = l || this.__patterns.handlebars_comment.read()),
                      (l = l || this.__patterns.handlebars_unescaped.read()),
                      (l = l || this.__patterns.handlebars.read())),
                    this._disabled.django ||
                      (!this._excluded.django &&
                        !this._excluded.handlebars &&
                        (l = l || this.__patterns.django_value.read()),
                      this._excluded.django ||
                        ((l = l || this.__patterns.django_comment.read()),
                        (l = l || this.__patterns.django.read()))),
                    this._disabled.smarty ||
                      (this._disabled.django &&
                        this._disabled.handlebars &&
                        ((l = l || this.__patterns.smarty_comment.read()),
                        (l = l || this.__patterns.smarty_literal.read()),
                        (l = l || this.__patterns.smarty.read()))));
                return l;
              }),
          ...
          function (e, r, u) {
            var c = u(20).Options,
              ...
              m = function (f, d) {
                ((this.indent_level = 0),
                  ...
                  (this._output = new i(f, d)));
              };
            ((m.prototype.current_line_has_match = function (f) {
              return this._output.current_line.has_match(f);
            }),
              (m.prototype.set_space_before_token = function (f, d) {
                ((this._output.space_before_token = f), (this._output.non_breaking_space = d));
              }),
              (m.prototype.set_wrap_point = function () {
                (this._output.set_indent(this.indent_level, this.alignment_size),
                  this._output.set_wrap_point());
              }),
              (m.prototype.add_raw_token = function (f) {
                this._output.add_raw_token(f);
              }),
              (m.prototype.print_preserved_newlines = function (f) {
                var d = 0;
                (f.type !== l.TEXT && f.previous.type !== l.TEXT && (d = f.newlines ? 1 : 0),
                  this.preserve_newlines &&
                    (d =
                      f.newlines < this.max_preserve_newlines + 1
                        ? f.newlines
                        : this.max_preserve_newlines + 1));
                for (var g = 0; g < d; g++) this.print_newline(g > 0);
                return d !== 0;
              }),
              (m.prototype.traverse_whitespace = function (f) {
              ...
              (m.prototype.print_newline = function (f) {
                this._output.add_new_line(f);
              }),
              (m.prototype.print_token = function (f) {
                f.text &&
                  (this._output.set_indent(this.indent_level, this.alignment_size),
              ...
              (m.prototype.get_full_indent = function (f) {
                return (
            ...
            var A = function (f) {
                for (var d = null, g = f.next; g.type !== l.EOF && f.closed !== g; ) {
                  if (g.type === l.ATTRIBUTE && g.text === 'type') {
                    g.next &&
                      g.next.type === l.EQUALS &&
                      g.next.next &&
                      g.next.next.type === l.VALUE &&
                      (d = g.next.next.text);
                    break;
                  }
                  g = g.next;
              ...
              b = function (f, d) {
                var g = null,
                  R = null;
                return d.closed
                  ? (f === 'script' ? (g = 'text/javascript') : f === 'style' && (g = 'text/css'),
                    (g = A(d) || g),
                    g.search('text/css') > -1
                      ? (R = 'css')
                      : g.search(
                        ...
                        ? (R = 'javascript')
                        : g.search(/(text|application|dojo)\/(x-)?(html)/) > -1
                          ? (R = 'html')
                          : g.search(/test\/null/) > -1 && (R = 'null'),
                    R)
                  : null;
              };
            function D(f, d) {
            ...
            function T(f, d, g) {
              ((this.parent = f || null),
                (this.tag = d ? d.tag_name : ''),
                (this.indent_level = g || 0),
                (this.parser_token = d || null));
            }
            function y(f) {
            ...
            ((y.prototype.get_parser_token = function () {
              ...
              (y.prototype.record_tag = function (f) {
                var d = new T(this._current_frame, f, this._printer.indent_level);
                this._current_frame = d;
              }),
              (y.prototype._try_pop_frame = function (f) {
                var d = null;
                return (
                  f &&
                    ((d = f.parser_token),
              ...
              (y.prototype._get_frame = function (f, d) {
                for (var g = this._current_frame; g && f.indexOf(g.tag) === -1; ) {
                  if (d && d.indexOf(g.tag) !== -1) {
                    g = null;
                    break;
                  }
                  g = g.parent;
              ...
              (y.prototype.try_pop = function (f, d) {
                var g = this._get_frame([f], d);
                return this._try_pop_frame(g);
              }),
              (y.prototype.indent_to_tag = function (f) {
                var d = this._get_frame(f);
...
`
              ...
              var g = f.match(/^[\t ]*/)[0],
                R = { text: '', type: '' },
                v = new I(),
                _ = new m(this._options, g),
                C = new s(f, this._options).tokenize();
              this._tag_stack = new y(_);
              for (var E = null, k = C.next(); k.type !== l.EOF; )
                (k.type === l.TAG_OPEN || k.type === l.COMMENT
                  ? ((E = this._handle_tag_open(_, k, v, R, C)), (v = E))
                  : k.type === l.ATTRIBUTE ||
                      k.type === l.EQUALS ||
                      k.type === l.VALUE ||
                      (k.type === l.TEXT && !v.tag_complete)
                    ? (E = this._handle_inside_tag(_, k, v, R))
                    : k.type === l.TAG_CLOSE
                      ? (E = this._handle_tag_close(_, k, v))
                      : k.type === l.TEXT
                        ? (E = this._handle_text(_, k, v))
                        : k.type === l.CONTROL_FLOW_OPEN
                          ? (E = this._handle_control_flow_open(_, k))
                          : k.type === l.CONTROL_FLOW_CLOSE
                            ? (E = this._handle_control_flow_close(_, k))
                            : _.add_raw_token(k),
                  (R = E),
                  (k = C.next()));
              var x = _._output.get_code(d);
              return x;
            }),
              (L.prototype._handle_control_flow_open = function (f, d) {
                var g = { text: d.text, type: d.type };
                return (
                  f.set_space_before_token(d.newlines || d.whitespace_before !== '', !0),
                  d.newlines
                    ? f.print_preserved_newlines(d)
                    : f.set_space_before_token(d.newlines || d.whitespace_before !== '', !0),
                  f.print_token(d),
                  f.indent(),
                  g
              ...
              (L.prototype._handle_control_flow_close = function (f, d) {
                var g = { text: d.text, type: d.type };
                return (
                  f.deindent(),
                  d.newlines
              ...
              (L.prototype._handle_tag_close = function (f, d, g) {
                var R = { text: d.text, type: d.type };
                return (
                  (f.alignment_size = 0),
                  (g.tag_complete = !0),
                  f.set_space_before_token(d.newlines || d.whitespace_before !== '', !0),
                  g.is_unformatted
                    ? f.add_raw_token(d)
                    : (g.tag_start_char === '<' &&
                        (f.set_space_before_token(d.text[0] === '/', !0),
                        this._is_wrap_attributes_force_expand_multiline &&
                          g.has_wrapped_attrs &&
                          f.print_newline(!1)),
                      f.print_token(d)),
                  g.indent_content &&
                    !(g.is_unformatted || g.is_content_unformatted) &&
                    (f.indent(), (g.indent_content = !1)),
                  !g.is_inline_element &&
                    !(g.is_unformatted || g.is_content_unformatted) &&
                    f.set_wrap_point(),
                  R
              ...
              (L.prototype._handle_inside_tag = function (f, d, g, R) {
                var v = g.has_wrapped_attrs,
                  _ = { text: d.text, type: d.type };
                return (
                  f.set_space_before_token(d.newlines || d.whitespace_before !== '', !0),
                  g.is_unformatted
                    ? f.add_raw_token(d)
                    : g.tag_start_char === '{' && d.type === l.TEXT
                      ? f.print_preserved_newlines(d)
                        ? ((d.newlines = 0), f.add_raw_token(d))
                        : f.print_token(d)
                      : (d.type === l.ATTRIBUTE
                          ? f.set_space_before_token(!0)
                          : (d.type === l.EQUALS ||
                              (d.type === l.VALUE && d.previous.type === l.EQUALS)) &&
                            f.set_space_before_token(!1),
                        d.type === l.ATTRIBUTE &&
                          g.tag_start_char === '<' &&
                          ((this._is_wrap_attributes_preserve ||
                            this._is_wrap_attributes_preserve_aligned) &&
                            (f.traverse_whitespace(d), (v = v || d.newlines !== 0)),
                          this._is_wrap_attributes_force &&
                            g.attr_count >= this._options.wrap_attributes_min_attrs &&
                            (R.type !== l.TAG_OPEN ||
                              this._is_wrap_attributes_force_expand_multiline) &&
                            (f.print_newline(!1), (v = !0))),
                        f.print_token(d),
                        (v = v || f.previous_token_wrapped()),
                        (g.has_wrapped_attrs = v)),
                  _
                );
              }),
              (L.prototype._handle_text = function (f, d, g) {
                var R = { text: d.text, type: 'TK_CONTENT' };
                return (
                  g.custom_beautifier_name
                    ? this._print_custom_beatifier_text(f, d, g)
                    : g.is_unformatted || g.is_content_unformatted
                      ? f.add_raw_token(d)
                      : (f.traverse_whitespace(d), f.print_token(d)),
                  R
                );
              }),
              (L.prototype._print_custom_beatifier_text = function (f, d, g) {
                var R = this;
                if (d.text !== '') {
                  var v = d.text,
                    _,
                    ...
                    E = '',
                    k = '';
                  (g.custom_beautifier_name === 'javascript' &&
                  typeof this._js_beautify == 'function'
                    ? (_ = this._js_beautify)
                    : g.custom_beautifier_name === 'css' && typeof this._css_beautify == 'function'
                      ? (_ = this._css_beautify)
                      : g.custom_beautifier_name === 'html' &&
                        (_ = function (U, P) {
                          var j = new L(U, P, R._js_beautify, R._css_beautify);
                          return j.beautify();
                        }),
                    this._options.indent_scripts === 'keep'
                      ? (C = 0)
                      : this._options.indent_scripts === 'separate' && (C = -f.indent_level));
                  var x = f.get_full_indent(C);
                  if (
                    ((v = v.replace(/\n[ \t]*$/, '')),
                    g.custom_beautifier_name !== 'html' &&
                      v[0] === '<' &&
...
`),
                      ...
                      (M[2] ||
                        M[3].indexOf(`
`) !== -1) &&
                        ((M = M[3].match(/[ \t]+$/)), M && (d.whitespace_before = M[0])));
                  }
                  if (v)
                    if (_) {
                      var B = function () {
...
` +
              ...
              (L.prototype._handle_tag_open = function (f, d, g, R, v) {
                var _ = this._get_tag_open_token(d);
                if (
                  ((g.is_unformatted || g.is_content_unformatted) &&
                  !g.is_empty_element &&
                  d.type === l.TAG_OPEN &&
                  !_.is_start_tag
                    ...
                    : (f.traverse_whitespace(d),
                      this._set_tag_position(f, d, _, g, R),
                      _.is_inline_element || f.set_wrap_point(),
                      f.print_token(d)),
                  _.is_start_tag && this._is_wrap_attributes_force)
                ) {
                  var C = 0,
                    E;
                  do ((E = v.peek(C)), E.type === l.ATTRIBUTE && (_.attr_count += 1), (C += 1));
                  while (E.type !== l.EOF && E.type !== l.TAG_CLOSE);
                }
                return (
                  (this._is_wrap_attributes_force_aligned ||
                    this._is_wrap_attributes_aligned_multiple ||
                    this._is_wrap_attributes_preserve_aligned) &&
                    (_.alignment_size = d.text.length + 1),
                  !_.tag_complete && !_.is_unformatted && (f.alignment_size = _.alignment_size),
                  _
                );
              }));
            var I = function (f, d) {
              if (
                ...
                var g;
                ((this.tag_start_char = d.text[0]),
                  (this.text = d.text),
                  this.tag_start_char === '<'
                    ? ((g = d.text.match(/^<([^\s>]*)/)), (this.tag_check = g ? g[1] : ''))
                    : ((g = d.text.match(/^{{~?(?:[\^]|#\*?)?([^\s}]+)/)),
                      (this.tag_check = g ? g[1] : ''),
                      (d.text.startsWith('{{#>') || d.text.startsWith('{{~#>')) &&
                        this.tag_check[0] === '>' &&
                        (this.tag_check === '>' && d.next !== null
                          ? (this.tag_check = d.next.text.split(' ')[0])
                          : (this.tag_check = d.text.split('>')[1]))),
                  (this.tag_check = this.tag_check.toLowerCase()),
                  d.type === l.COMMENT && (this.tag_complete = !0),
                  (this.is_start_tag = this.tag_check.charAt(0) !== '/'),
                  (this.tag_name = this.is_start_tag ? this.tag_check : this.tag_check.substr(1)),
                  (this.is_end_tag = !this.is_start_tag || (d.closed && d.closed.text === '/>')));
                var R = 2;
                (this.tag_start_char === '{' &&
                  this.text.length >= 3 &&
                  this.text.charAt(2) === '~' &&
            ...
            ((L.prototype._get_tag_open_token = function (f) {
              var d = new I(this._tag_stack.get_parser_token(), f);
              return (
                (d.alignment_size = this._options.wrap_attributes_indent_size),
                (d.is_end_tag = d.is_end_tag || D(d.tag_check, this._options.void_elements)),
                (d.is_empty_element = d.tag_complete || (d.is_start_tag && d.is_end_tag)),
                (d.is_unformatted = !d.tag_complete && D(d.tag_check, this._options.unformatted)),
                (d.is_content_unformatted =
                  !d.is_empty_element && D(d.tag_check, this._options.content_unformatted)),
                (d.is_inline_element =
                  D(d.tag_name, this._options.inline) ||
                  (this._options.inline_custom_elements && d.tag_name.includes('-')) ||
                  d.tag_start_char === '{'),
                d
              );
            }),
              (L.prototype._set_tag_position = function (f, d, g, R, v) {
                if (
                  (g.is_empty_element ||
                    (g.is_end_tag
                      ? (g.start_tag_token = this._tag_stack.try_pop(g.tag_name))
                      : (this._do_optional_end_element(g) &&
                          (g.is_inline_element || f.print_newline(!1)),
                        this._tag_stack.record_tag(g),
                        (g.tag_name === 'script' || g.tag_name === 'style') &&
                          !(g.is_unformatted || g.is_content_unformatted) &&
                          (g.custom_beautifier_name = b(g.tag_check, d)))),
                  D(g.tag_check, this._options.extra_liners) &&
                    (f.print_newline(!1), f._output.just_added_blankline() || f.print_newline(!0)),
                  g.is_empty_element)
                ) {
                  if (g.tag_start_char === '{' && g.tag_check === 'else') {
                    (this._tag_stack.indent_to_tag(['if', 'unless', 'each']),
                      (g.indent_content = !0));
                    var _ = f.current_line_has_match(/{{#if/);
                    _ || f.print_newline(!1);
                  }
                  (g.tag_name === '!--' &&
                    v.type === l.TAG_CLOSE &&
                    ...
                    g.text.indexOf(`
`) === -1) ||
                    (g.is_inline_element || g.is_unformatted || f.print_newline(!1),
                    this._calcluate_parent_multiline(f, g));
                } else if (g.is_end_tag) {
                  var C = !1;
                  ((C = g.start_tag_token && g.start_tag_token.multiline_content),
                    (C =
                      C ||
                      (!g.is_inline_element &&
                        !(R.is_inline_element || R.is_unformatted) &&
                        !(v.type === l.TAG_CLOSE && g.start_tag_token === R) &&
                        v.type !== 'TK_CONTENT')),
                    (g.is_content_unformatted || g.is_unformatted) && (C = !1),
                    C && f.print_newline(!1));
                } else
                  ((g.indent_content = !g.custom_beautifier_name),
                    g.tag_start_char === '<' &&
                      (g.tag_name === 'html'
                        ? (g.indent_content = this._options.indent_inner_html)
                        : g.tag_name === 'head'
                          ? (g.indent_content = this._options.indent_head_inner_html)
                          : g.tag_name === 'body' &&
                            (g.indent_content = this._options.indent_body_inner_html)),
                    !(g.is_inline_element || g.is_unformatted) &&
                      (v.type !== 'TK_CONTENT' || g.is_content_unformatted) &&
                      f.print_newline(!1),
                    this._calcluate_parent_multiline(f, g));
              }),
              (L.prototype._calcluate_parent_multiline = function (f, d) {
                d.parent &&
                  f._output.just_added_newline() &&
                  !((d.is_inline_element || d.is_unformatted) && d.parent.is_inline_element) &&
                  (d.parent.multiline_content = !0);
              }));
            var N = [
                'address',
                'article',
              ...
              F = ['a', 'audio', 'del', 'ins', 'map', 'noscript', 'video'];
            ((L.prototype._do_optional_end_element = function (f) {
              var d = null;
              if (!(f.is_empty_element || !f.is_start_tag || !f.parent)) {
                if (f.tag_name === 'body') d = d || this._tag_stack.try_pop('head');
                else if (f.tag_name === 'li')
                  d = d || this._tag_stack.try_pop('li', ['ol', 'ul', 'menu']);
                else if (f.tag_name === 'dd' || f.tag_name === 'dt')
                  ((d = d || this._tag_stack.try_pop('dt', ['dl'])),
                    (d = d || this._tag_stack.try_pop('dd', ['dl'])));
                else if (f.parent.tag_name === 'p' && N.indexOf(f.tag_name) !== -1) {
                  var g = f.parent.parent;
                  (!g || F.indexOf(g.tag_name) === -1) && (d = d || this._tag_stack.try_pop('p'));
                } else
                  f.tag_name === 'rp' || f.tag_name === 'rt'
                    ? ((d = d || this._tag_stack.try_pop('rt', ['ruby', 'rtc'])),
                      (d = d || this._tag_stack.try_pop('rp', ['ruby', 'rtc'])))
                    : f.tag_name === 'optgroup'
                      ? (d = d || this._tag_stack.try_pop('optgroup', ['select']))
                      : f.tag_name === 'option'
                        ? (d =
                            d ||
                            this._tag_stack.try_pop('option', ['select', 'datalist', 'optgroup']))
                        : f.tag_name === 'colgroup'
                          ? (d = d || this._tag_stack.try_pop('caption', ['table']))
                          : f.tag_name === 'thead'
                            ? ((d = d || this._tag_stack.try_pop('caption', ['table'])),
                              (d = d || this._tag_stack.try_pop('colgroup', ['table'])))
                            : f.tag_name === 'tbody' || f.tag_name === 'tfoot'
                              ? ((d = d || this._tag_stack.try_pop('caption', ['table'])),
                                (d = d || this._tag_stack.try_pop('colgroup', ['table'])),
                                (d = d || this._tag_stack.try_pop('thead', ['table'])),
                                (d = d || this._tag_stack.try_pop('tbody', ['table'])))
                              : f.tag_name === 'tr'
                                ? ((d = d || this._tag_stack.try_pop('caption', ['table'])),
                                  (d = d || this._tag_stack.try_pop('colgroup', ['table'])),
                                  (d =
                ...
                return ((f.parent = this._tag_stack.get_parser_token()), d);
              }
            }),
              (e.exports.Beautifier = L));
          },
          function (e, r, u) {
            var c = u(6).Options;
            function i(s) {
          ...
          function (e, r, u) {
            var c = u(9).Tokenizer,
              ...
              m = new s(/<\!--/, /-->/),
              A = function (b, D) {
                (c.call(this, b, D), (this._current_tag_name = ''));
            ...
            ((A.prototype = new c()),
              (A.prototype._is_comment = function (b) {
                return !1;
              }),
              (A.prototype._is_opening = function (b) {
                return b.type === p.TAG_OPEN || b.type === p.CONTROL_FLOW_OPEN;
              }),
              (A.prototype._is_closing = function (b, D) {
                return (
                  (b.type === p.TAG_CLOSE &&
                    D &&
                    (((b.text === '>' || b.text === '/>') && D.text[0] === '<') ||
                      (b.text === '}}' && D.text[0] === '{' && D.text[1] === '{'))) ||
                  (b.type === p.CONTROL_FLOW_CLOSE && b.text === '}' && D.text.endsWith('{'))
                );
              }),
              (A.prototype._reset = function () {
                this._current_tag_name = '';
              }),
              (A.prototype._get_next_token = function (b, D) {
                var T = null;
                this._readWhitespace();
                var y = this._input.peek();
                return y === null
                  ? this._create_token(p.EOF, '')
                  : ((T = T || this._read_open_handlebars(y, D)),
                    (T = T || this._read_attribute(y, b, D)),
                    (T = T || this._read_close(y, D)),
                    (T = T || this._read_control_flows(y, D)),
                    (T = T || this._read_raw_content(y, b, D)),
                    (T = T || this._read_content_word(y, D)),
                    (T = T || this._read_comment_or_cdata(y)),
                    (T = T || this._read_processing(y)),
                    (T = T || this._read_open(y, D)),
                    (T = T || this._create_token(p.UNKNOWN, this._input.next())),
                    T);
              }),
              (A.prototype._read_comment_or_cdata = function (b) {
                var D = null,
                  T = null,
                  y = null;
                if (b === '<') {
                  ...
                  (L === '!' &&
                    ...
                    T
                      ? ((y = m.get_directives(T)),
                        y && y.ignore === 'start' && (T += m.readIgnored(this._input)))
                      : (T = this.__patterns.cdata.read())),
                    T && ((D = this._create_token(p.COMMENT, T)), (D.directives = y)));
                }
                return D;
              }),
              (A.prototype._read_processing = function (b) {
                var D = null,
                  T = null,
                  y = null;
                if (b === '<') {
              ...
              (A.prototype._read_open = function (b, D) {
                var T = null,
                  y = null;
                return (
                  (!D || D.type === p.CONTROL_FLOW_OPEN) &&
                    b === '<' &&
                    ((T = this._input.next()),
                    this._input.peek() === '/' && (T += this._input.next()),
                    (T += this.__patterns.element_name.read()),
                    (y = this._create_token(p.TAG_OPEN, T))),
                  y
                );
              }),
              (A.prototype._read_open_handlebars = function (b, D) {
                var T = null,
                  y = null;
                return (
                  (!D || D.type === p.CONTROL_FLOW_OPEN) &&
                    ...
                    (this._input.peek(2) === '!'
                      ? ((T = this.__patterns.handlebars_comment.read()),
                        ...
                        (y = this._create_token(p.COMMENT, T)))
                      : ((T = this.__patterns.handlebars_open.read()),
                        (y = this._create_token(p.TAG_OPEN, T)))),
                  y
                );
              }),
              (A.prototype._read_control_flows = function (b, D) {
                var T = '',
                  y = null;
                if (
                ...
                if (b === '@') {
                  ...
                  y = this._create_token(p.CONTROL_FLOW_OPEN, T);
                } else
                  b === '}' &&
                    D &&
                    D.type === p.CONTROL_FLOW_OPEN &&
                    ((T = this._input.next()), (y = this._create_token(p.CONTROL_FLOW_CLOSE, T)));
                return y;
              }),
              (A.prototype._read_close = function (b, D) {
                var T = null,
                  y = null;
                return (
                  D &&
                    D.type === p.TAG_OPEN &&
                    (D.text[0] === '<' && (b === '>' || (b === '/' && this._input.peek(1) === '>'))
                      ? ((T = this._input.next()),
                        b === '/' && (T += this._input.next()),
                        (y = this._create_token(p.TAG_CLOSE, T)))
                      : D.text[0] === '{' &&
                        b === '}' &&
                        this._input.peek(1) === '}' &&
                        (this._input.next(),
                        this._input.next(),
                        (y = this._create_token(p.TAG_CLOSE, '}}')))),
                  y
                );
              }),
              (A.prototype._read_attribute = function (b, D, T) {
                var y = null,
                  L = '';
                if (T && T.text[0] === '<')
                  if (b === '=') y = this._create_token(p.EQUALS, this._input.next());
                  else if (b === '"' || b === "'") {
                    var I = this._input.next();
                    (b === '"'
                      ? (I += this.__patterns.double_quote.read())
                      : (I += this.__patterns.single_quote.read()),
                      (y = this._create_token(p.VALUE, I)));
                  } else
                    ((L = this.__patterns.attribute.read()),
                      L &&
                        (D.type === p.EQUALS
                          ? (y = this._create_token(p.VALUE, L))
                          : (y = this._create_token(p.ATTRIBUTE, L))));
                return y;
              }),
              (A.prototype._is_content_unformatted = function (b) {
                return (
                  this._options.void_elements.indexOf(b) === -1 &&
                  (this._options.content_unformatted.indexOf(b) !== -1 ||
                    this._options.unformatted.indexOf(b) !== -1)
                );
              }),
              (A.prototype._read_raw_content = function (b, D, T) {
                var y = '';
                if (T && T.text[0] === '{') y = this.__patterns.handlebars_raw_close.read();
                else if (D.type === p.TAG_CLOSE && D.opened.text[0] === '<' && D.text[0] !== '/') {
                  var L = D.opened.text.substr(1).toLowerCase();
                  if (L === 'script' || L === 'style') {
                    var I = this._read_comment_or_cdata(b);
                    if (I) return ((I.type = p.TEXT), I);
                    y = this._input.readUntil(new RegExp('</' + L + '[\\n\\r\\t ]*?>', 'ig'));
                  } else
                    this._is_content_unformatted(L) &&
                      (y = this._input.readUntil(new RegExp('</' + L + '[\\n\\r\\t ]*?>', 'ig')));
                }
                return y ? this._create_token(p.TEXT, y) : null;
              }),
              (A.prototype._read_content_word = function (b, D) {
                var T = '';
                if (
                  (this._options.unformatted_content_delimiter &&
                  ...
                  return this._create_token(p.TEXT, T);
              }),
              (e.exports.Tokenizer = A),
              (e.exports.TOKEN = p));
          },
        ],
        n = {};
    ...
    function _n(t, n, o) {
      let a = t.getText(),
        ...
        u = o.tabSize || 4;
      if (n) {
        let s = t.offsetAt(n.start),
          l = s;
        for (; l > 0 && wn(a, l - 1); ) l--;
        l === 0 || bn(a, l - 1) ? (s = l) : l < s && (s = l + 1);
        let h = t.offsetAt(n.end),
          p = h;
        for (; p < a.length && wn(a, p); ) p++;
        ((p === a.length || bn(a, p)) && (h = p), (n = W.create(t.positionAt(s), t.positionAt(h))));
        let m = a.substring(0, s);
        if (new RegExp(/.*[<][^>]*$/).test(m))
          return ((a = a.substring(s, h)), [{ range: n, newText: a }]);
        if (((e = h === a.length), (a = a.substring(s, h)), s !== 0)) {
          let A = t.offsetAt(q.create(n.start.line, 0));
          r = gi(t.getText(), A, o);
        }
      } else n = W.create(q.create(0, 0), t.positionAt(a.length));
      let c = {
          indent_size: u,
          indent_char: o.insertSpaces ? ' ' : '	',
          indent_empty_lines: Y(o, 'indentEmptyLines', !1),
          wrap_line_length: Y(o, 'wrapLineLength', 120),
          unformatted: wt(o, 'unformatted', void 0),
          content_unformatted: wt(o, 'contentUnformatted', void 0),
          indent_inner_html: Y(o, 'indentInnerHtml', !1),
          preserve_newlines: Y(o, 'preserveNewLines', !0),
          max_preserve_newlines: Y(o, 'maxPreserveNewLines', 32786),
          indent_handlebars: Y(o, 'indentHandlebars', !1),
          end_with_newline: e && Y(o, 'endWithNewline', !1),
          extra_liners: wt(o, 'extraLiners', void 0),
          wrap_attributes: Y(o, 'wrapAttributes', 'auto'),
          wrap_attributes_indent_size: Y(o, 'wrapAttributesIndentSize', void 0),
          eol: `
`,
          indent_scripts: Y(o, 'indentScripts', 'normal'),
          templating: fi(o, 'all'),
          unformatted_content_delimiter: Y(o, 'unformattedContentDelimiter', ''),
        },
        i = gn(mi(a), c);
      if (r > 0) {
        let s = o.insertSpaces ? bt(' ', u * r) : bt('	', r);
        ((i = i
          .split(
            `
`
...
` + s
          ...
          n.start.character === 0 && (i = s + i));
      }
      return [{ range: n, newText: i }];
    }
    function mi(t) {
      return t.replace(/^\s+/, '');
    }
    ...
    function wt(t, n, o) {
      ...
      return typeof a == 'string'
        ? a.length > 0
          ? a.split(',').map((e) => e.trim().toLowerCase())
          : []
        : o;
    }
    function fi(t, n) {
      let o = Y(t, 'templating', n);
      return o === !0 ? ['auto'] : o === !1 || o === n || Array.isArray(o) === !1 ? ['none'] : o;
    }
    function gi(t, n, o) {
      let a = n,
        e = 0,
    ...
    function bn(t, n) {
      return (
        `\r
`.indexOf(t.charAt(n)) !== -1
      );
    }
    function wn(t, n) {
      return ' 	'.indexOf(t.charAt(n)) !== -1;
    }
    var vn;
    (() => {
      'use strict';
      var t = {
          470: (e) => {
            ...
            function u(i, s) {
              for (var l, h = '', p = 0, m = -1, A = 0, b = 0; b <= i.length; ++b) {
                if (b < i.length) l = i.charCodeAt(b);
                else {
                  if (l === 47) break;
                  l = 47;
                }
                if (l === 47) {
                  if (!(m === b - 1 || A === 1))
                    if (m !== b - 1 && A === 2) {
                      if (
                        ...
                        if (h.length > 2) {
                          ...
                          if (D !== h.length - 1) {
                            (D === -1
                              ? ((h = ''), (p = 0))
                              : (p = (h = h.slice(0, D)).length - 1 - h.lastIndexOf('/')),
                              (m = b),
                              (A = 0));
                            continue;
                          }
                      ...
                      s && (h.length > 0 ? (h += '/..') : (h = '..'), (p = 2));
                    } else
                      (h.length > 0 ? (h += '/' + i.slice(m + 1, b)) : (h = i.slice(m + 1, b)),
                        (p = b - m - 1));
                  ((m = b), (A = 0));
                } else l === 46 && A !== -1 ? ++A : (A = -1);
              }
            ...
            var c = {
              resolve: function () {
                for (var i, s = '', l = !1, h = arguments.length - 1; h >= -1 && !l; h--) {
                  var p;
                  (h >= 0 ? (p = arguments[h]) : (i === void 0 && (i = process.cwd()), (p = i)),
                    r(p),
                    p.length !== 0 && ((s = p + '/' + s), (l = p.charCodeAt(0) === 47)));
                }
                return (
                  (s = u(s, !l)),
              ...
              normalize: function (i) {
                if ((r(i), i.length === 0)) return '.';
                var s = i.charCodeAt(0) === 47,
                  l = i.charCodeAt(i.length - 1) === 47;
                return (
                  (i = u(i, !s)).length !== 0 || s || (i = '.'),
                  i.length > 0 && l && (i += '/'),
                  s ? '/' + i : i
                );
              },
              isAbsolute: function (i) {
                return (r(i), i.length > 0 && i.charCodeAt(0) === 47);
              },
              join: function () {
                if (arguments.length === 0) return '.';
                for (var i, s = 0; s < arguments.length; ++s) {
                  var l = arguments[s];
                  (r(l), l.length > 0 && (i === void 0 ? (i = l) : (i += '/' + l)));
                }
                return i === void 0 ? '.' : c.normalize(i);
              },
              relative: function (i, s) {
                if ((r(i), r(s), i === s || (i = c.resolve(i)) === (s = c.resolve(s)))) return '';
                for (var l = 1; l < i.length && i.charCodeAt(l) === 47; ++l);
                for (
                  var h = i.length, p = h - l, m = 1;
                  m < s.length && s.charCodeAt(m) === 47;
                  ++m
                );
                for (var A = s.length - m, b = p < A ? p : A, D = -1, T = 0; T <= b; ++T) {
                  if (T === b) {
                    if (A > b) {
                      if (s.charCodeAt(m + T) === 47) return s.slice(m + T + 1);
                      if (T === 0) return s.slice(m + T);
                    } else p > b && (i.charCodeAt(l + T) === 47 ? (D = T) : T === 0 && (D = 0));
                    break;
                  }
                  var y = i.charCodeAt(l + T);
                  if (y !== s.charCodeAt(m + T)) break;
                  y === 47 && (D = T);
                }
                var L = '';
                for (T = l + D + 1; T <= h; ++T)
                  (T !== h && i.charCodeAt(T) !== 47) ||
                    (L.length === 0 ? (L += '..') : (L += '/..'));
                return L.length > 0
                  ? L + s.slice(m + D)
                  : ((m += D), s.charCodeAt(m) === 47 && ++m, s.slice(m));
              },
              ...
              dirname: function (i) {
                if ((r(i), i.length === 0)) return '.';
                for (
                  var s = i.charCodeAt(0), l = s === 47, h = -1, p = !0, m = i.length - 1;
                  m >= 1;
                  --m
                )
                  if ((s = i.charCodeAt(m)) === 47) {
                    if (!p) {
                      h = m;
                      break;
                    }
                  } else p = !1;
                return h === -1 ? (l ? '/' : '.') : l && h === 1 ? '//' : i.slice(0, h);
              },
              basename: function (i, s) {
                ...
                if (s !== void 0 && s.length > 0 && s.length <= i.length) {
                  ...
                  for (l = i.length - 1; l >= 0; --l) {
                    ...
                    if (D === 47) {
                      ...
                      (b === -1 && ((m = !1), (b = l + 1)),
                        A >= 0 &&
                          (D === s.charCodeAt(A) ? --A == -1 && (p = l) : ((A = -1), (p = b))));
                  }
                  return (h === p ? (p = b) : p === -1 && (p = i.length), i.slice(h, p));
                }
                for (l = i.length - 1; l >= 0; --l)
                ...
                return p === -1 ? '' : i.slice(h, p);
              },
              extname: function (i) {
                r(i);
                for (var s = -1, l = 0, h = -1, p = !0, m = 0, A = i.length - 1; A >= 0; --A) {
                  var b = i.charCodeAt(A);
                  if (b !== 47)
                    (h === -1 && ((p = !1), (h = A + 1)),
                      b === 46 ? (s === -1 ? (s = A) : m !== 1 && (m = 1)) : s !== -1 && (m = -1));
                  else if (!p) {
                    l = A + 1;
                    break;
                  }
                }
                return s === -1 || h === -1 || m === 0 || (m === 1 && s === h - 1 && s === l + 1)
                  ? ''
                  : i.slice(s, h);
              },
              format: function (i) {
                ...
                return (function (s, l) {
                  var h = l.dir || l.root,
                    p = l.base || (l.name || '') + (l.ext || '');
                  return h ? (h === l.root ? h + p : h + '/' + p) : p;
                })(0, i);
              },
              parse: function (i) {
                r(i);
                ...
                var l,
                  ...
                  p = h === 47;
                p ? ((s.root = '/'), (l = 1)) : (l = 0);
                for (var m = -1, A = 0, b = -1, D = !0, T = i.length - 1, y = 0; T >= l; --T)
                  if ((h = i.charCodeAt(T)) !== 47)
                    (b === -1 && ((D = !1), (b = T + 1)),
                      h === 46 ? (m === -1 ? (m = T) : y !== 1 && (y = 1)) : m !== -1 && (y = -1));
                  else if (!D) {
                    A = T + 1;
                    break;
                  }
                return (
                  m === -1 || b === -1 || y === 0 || (y === 1 && m === b - 1 && m === A + 1)
                    ? b !== -1 && (s.base = s.name = A === 0 && p ? i.slice(1, b) : i.slice(A, b))
                    : (A === 0 && p
                        ? ((s.name = i.slice(1, m)), (s.base = i.slice(1, b)))
                        : ((s.name = i.slice(A, m)), (s.base = i.slice(A, b))),
                      (s.ext = i.slice(m, b))),
                  A > 0 ? (s.dir = i.slice(0, A - 1)) : p && (s.dir = '/'),
                  s
                );
              },
              sep: '/',
      ...
      ((o.d = (e, r) => {
        for (var u in r)
          o.o(r, u) && !o.o(e, u) && Object.defineProperty(e, u, { enumerable: !0, get: r[u] });
      }),
      ...
      ((() => {
        ...
        (o.r(a),
          ...
          typeof process == 'object'
            ...
            : typeof navigator == 'object' && (e = navigator.userAgent.indexOf('Windows') >= 0));
        let r = /^\w[\w\d+.-]*$/,
          u = /^\//,
          c = /^\/\//;
        function i(v, _) {
        ...
        class p {
          ...
          constructor(_, C, E, k, x, M = !1) {
            typeof _ == 'object'
              ...
              : ((this.scheme = (function (B, O) {
                  return B || O ? B : 'file';
                })(_, M)),
                (this.authority = C || s),
                (this.path = (function (B, O) {
                  switch (B) {
                    case 'https':
                    case 'http':
                    case 'file':
          ...
          with(_) {
            if (!_) return this;
            let { scheme: C, authority: E, path: k, query: x, fragment: M } = _;
            return (
              C === void 0 ? (C = this.scheme) : C === null && (C = s),
              E === void 0 ? (E = this.authority) : E === null && (E = s),
              k === void 0 ? (k = this.path) : k === null && (k = s),
              x === void 0 ? (x = this.query) : x === null && (x = s),
              M === void 0 ? (M = this.fragment) : M === null && (M = s),
              C === this.scheme &&
              E === this.authority &&
              k === this.path &&
              x === this.query &&
          ...
          static parse(_, C = !1) {
            let E = h.exec(_);
            return E
              ? new A(E[2] || s, F(E[4] || s), F(E[5] || s), F(E[7] || s), F(E[9] || s), C)
              : new A(s, s, s, s, s);
          }
          static file(_) {
            let C = s;
            if ((e && (_ = _.replace(/\\/g, l)), _[0] === l && _[1] === l)) {
              let E = _.indexOf(l, 2);
              E === -1
                ? ((C = _.substring(2)), (_ = l))
                : ((C = _.substring(2, E)), (_ = _.substring(E) || l));
            }
            return new A('file', C, _, s, s);
          }
          static from(_) {
            let C = new A(_.scheme, _.authority, _.path, _.query, _.fragment);
            return (i(C, !0), C);
          }
          toString(_ = !1) {
            return L(this, _);
          ...
          static revive(_) {
            if (_) {
              if (_ instanceof p) return _;
              {
                let C = new A(_);
                return (
                  (C._formatted = _.external),
                  (C._fsPath = _._sep === m ? _.fsPath : null),
                  C
                );
              }
            }
        ...
        class A extends p {
          ...
          toJSON() {
            let _ = { $mid: 1 };
            return (
              this._fsPath && ((_.fsPath = this._fsPath), (_._sep = m)),
        ...
        function D(v, _, C) {
          ...
          for (let x = 0; x < v.length; x++) {
            ...
            if (
              ...
              (k !== -1 && ((E += encodeURIComponent(v.substring(k, x))), (k = -1)),
                E !== void 0 && (E += v.charAt(x)));
            else {
              E === void 0 && (E = v.substr(0, x));
              let B = b[M];
              B !== void 0
                ? (k !== -1 && ((E += encodeURIComponent(v.substring(k, x))), (k = -1)), (E += B))
                : k === -1 && (k = x);
            }
          }
          return (k !== -1 && (E += encodeURIComponent(v.substring(k))), E !== void 0 ? E : v);
        }
        function T(v) {
          let _;
          for (let C = 0; C < v.length; C++) {
            let E = v.charCodeAt(C);
            E === 35 || E === 63
              ? (_ === void 0 && (_ = v.substr(0, C)), (_ += b[E]))
              : _ !== void 0 && (_ += v[C]);
          }
          return _ !== void 0 ? _ : v;
        }
            ...
            (C =
              v.authority && v.path.length > 1 && v.scheme === 'file'
                ...
                : v.path.charCodeAt(0) === 47 &&
                  ...
                  ? _
                    ? v.path.substr(1)
                    : v.path[1].toLowerCase() + v.path.substr(2)
                  : v.path),
            e && (C = C.replace(/\//g, '\\')),
            C
          );
        ...
        function L(v, _) {
          let C = _ ? T : D,
            E = '',
            { scheme: k, authority: x, path: M, query: B, fragment: O } = v;
          if ((k && ((E += k), (E += ':')), (x || k === 'file') && ((E += l), (E += l)), x)) {
            let z = x.indexOf('@');
            if (z !== -1) {
              let U = x.substr(0, z);
              ((x = x.substr(z + 1)),
                ...
                z === -1
                  ? (E += C(U, !1, !1))
                  : ((E += C(U.substr(0, z), !1, !1)),
                    (E += ':'),
                    (E += C(U.substr(z + 1), !1, !0))),
                (E += '@'));
            }
            ((x = x.toLowerCase()),
              (z = x.lastIndexOf(':')),
              z === -1
                ? (E += C(x, !1, !0))
                : ((E += C(x.substr(0, z), !1, !0)), (E += x.substr(z))));
          }
          if (M) {
            if (M.length >= 3 && M.charCodeAt(0) === 47 && M.charCodeAt(2) === 58) {
              let z = M.charCodeAt(1);
              z >= 65 && z <= 90 && (M = `/${String.fromCharCode(z + 32)}:${M.substr(3)}`);
            } else if (M.length >= 2 && M.charCodeAt(1) === 58) {
              let z = M.charCodeAt(0);
              z >= 65 && z <= 90 && (M = `${String.fromCharCode(z + 32)}:${M.substr(2)}`);
            }
            E += C(M, !0, !1);
          }
          return (
        ...
        function I(v) {
          try {
            ...
            return v.length > 3 ? v.substr(0, 3) + I(v.substr(3)) : v;
          }
        }
        let N = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
        function F(v) {
          return v.match(N) ? v.replace(N, (_) => I(_)) : v;
        }
        var f = o(470);
        let d = f.posix || f,
          g = '/';
        var R;
        (function (v) {
          ((v.joinPath = function (_, ...C) {
            return _.with({ path: d.join(_.path, ...C) });
          }),
            (v.resolvePath = function (_, ...C) {
              let E = _.path,
                k = !1;
              E[0] !== g && ((E = g + E), (k = !0));
              let x = d.resolve(E, ...C);
              return (k && x[0] === g && !_.authority && (x = x.substring(1)), _.with({ path: x }));
            }),
            (v.dirname = function (_) {
              if (_.path.length === 0 || _.path === g) return _;
              let C = d.dirname(_.path);
              return (C.length === 1 && C.charCodeAt(0) === 46 && (C = ''), _.with({ path: C }));
            }),
            (v.basename = function (_) {
              return d.basename(_.path);
            }),
            (v.extname = function (_) {
              return d.extname(_.path);
            }));
        })(R || (R = {}));
      })(),
        (vn = a));
    })();
    var { URI: yn, Utils: _r } = vn;
    function _t(t) {
      let n = t[0],
        o = t[t.length - 1];
      return (n === o && (n === "'" || n === '"') && (t = t.substring(1, t.length - 1)), t);
    }
    function bi(t, n) {
      return !t.length || (n === 'handlebars' && /{{|}}/.test(t))
        ? !1
    ...
    function wi(t, n, o, a) {
      ...
      if (e) {
        ...
        return r === 'http' || r === 'https' || r === 'file' ? n : void 0;
      }
      return /^\#/i.test(n)
        ? t + n
        : /^\/\//i.test(n)
          ? (Z(t, 'https://') ? 'https' : 'http') + ':' + n.replace(/^\s*/g, '')
          : o
            ? o.resolveReference(n, a || t)
            : n;
    }
    function _i(t, n, o, a, e, r) {
      let u = _t(o);
      if (!bi(u, t.languageId)) return;
      u.length < o.length && (a++, e--);
      let c = wi(t.uri, u, n, r);
      if (!c) return;
      let i = yi(c, t);
      return { range: W.create(t.positionAt(a), t.positionAt(e)), target: i };
    }
    var vi = 35;
    function yi(t, n) {
      try {
        let o = yn.parse(t);
        return (
          o.scheme === 'file' && o.query && ((o = o.with({ query: null })), (t = o.toString(!0))),
          o.scheme === 'file' &&
          o.fragment &&
          !(t.startsWith(n.uri) && t.charCodeAt(n.uri.length) === vi)
            ? o.with({ fragment: null }).toString(!0)
            : t
        );
      } catch {
        return;
    ...
    var We = class {
      ...
      findDocumentLinks(n, o) {
        ...
        for (; r !== S.EOS; ) {
          switch (r) {
            case S.StartTag:
              ((c = e.getTokenText().toLowerCase()), s || (i = c === 'base'));
              break;
            case S.AttributeName:
              u = e.getTokenText().toLowerCase();
              break;
            case S.AttributeValue:
              if (c && u && this.dataManager.isPathAttribute(c, u)) {
                let h = e.getTokenText();
                if (!i) {
                  let p = _i(n, o, h, e.getTokenOffset(), e.getTokenEnd(), s);
                  p && a.push(p);
                }
                (i && typeof s > 'u' && ((s = _t(h)), s && o && (s = o.resolveReference(s, n.uri))),
                  (i = !1),
                  (u = void 0));
              } else if (u === 'id') {
                let h = _t(e.getTokenText());
                l[h] = e.getTokenOffset();
              }
              break;
          }
          r = e.scan();
        ...
        for (let h of a) {
          let p = n.uri + '#';
          if (h.target && Z(h.target, p)) {
            let m = h.target.substring(p.length),
              A = l[m];
            if (A !== void 0) {
              let b = n.positionAt(A);
              h.target = `${p}${b.line + 1},${b.character + 1}`;
            } else h.target = n.uri;
          }
        }
        return a;
    ...
    function An(t, n, o) {
      ...
      if (!e.tag) return [];
      let r = [],
        u = Sn(S.StartTag, t, e.start),
        c = typeof e.endTagStart == 'number' && Sn(S.EndTag, t, e.endTagStart);
      return (
        ((u && kn(u, n)) || (c && kn(c, n))) &&
          (u && r.push({ kind: ue.Read, range: u }), c && r.push({ kind: ue.Read, range: c })),
        r
      );
    }
    function Tn(t, n) {
    ...
    function kn(t, n) {
      return Tn(t.start, n) && Tn(n, t.end);
    }
    function Sn(t, n, o) {
      let a = V(n.getText(), o),
        e = a.scan();
      for (; e !== S.EOS && e !== t; ) e = a.scan();
      return e !== S.EOS
        ? { start: n.positionAt(a.getTokenOffset()), end: n.positionAt(a.getTokenEnd()) }
        : null;
    }
    function xn(t, n) {
      let o = [],
        a = vt(t, n);
      for (let r of a) e(r, void 0);
      return o;
      function e(r, u) {
        let c = we.create(r.name, r.kind, r.range, t.uri, u?.name);
        if ((c.containerName ?? (c.containerName = ''), o.push(c), r.children))
          for (let i of r.children) e(i, r);
      }
    }
    function vt(t, n) {
      let o = [];
    ...
    function Dn(t, n, o) {
      let a = Ti(n),
        e = W.create(t.positionAt(n.start), t.positionAt(n.end)),
        r = _e.create(a, void 0, be.Field, e, e);
      (o.push(r),
        n.children.forEach((u) => {
          (r.children ?? (r.children = []), Dn(t, u, r.children));
        }));
    }
    function Ti(t) {
      let n = t.tag;
      if (t.attributes) {
        let o = t.attributes.id,
          a = t.attributes.class;
        (o && (n += `#${o.replace(/[\"\']/g, '')}`),
          a &&
            (n += a
              .replace(/[\"\']/g, '')
    ...
    function En(t, n, o, a) {
      let e = t.offsetAt(n),
        r = a.findNodeAt(e);
      if (!r.tag || !ki(r, e, r.tag)) return null;
      let u = [],
        c = { start: t.positionAt(r.start + 1), end: t.positionAt(r.start + 1 + r.tag.length) };
      if ((u.push({ range: c, newText: o }), r.endTagStart)) {
        let s = {
          start: t.positionAt(r.endTagStart + 2),
          end: t.positionAt(r.endTagStart + 2 + r.tag.length),
        };
        u.push({ range: s, newText: o });
      }
      return { changes: { [t.uri.toString()]: u } };
    }
    function ki(t, n, o) {
      return t.endTagStart && t.endTagStart + 2 <= n && n <= t.endTagStart + 2 + o.length
        ? !0
        : t.start + 1 <= n && n <= t.start + 1 + o.length;
    }
    function Cn(t, n, o) {
      let a = t.offsetAt(n),
        e = o.findNodeAt(a);
      if (!e.tag || !e.endTagStart) return null;
      if (e.start + 1 <= a && a <= e.start + 1 + e.tag.length) {
        let r = a - 1 - e.start + e.endTagStart + 2;
        return t.positionAt(r);
      }
      if (e.endTagStart + 2 <= a && a <= e.endTagStart + 2 + e.tag.length) {
        let r = a - 2 - e.endTagStart + e.start + 1;
        return t.positionAt(r);
      }
      return null;
    }
    function yt(t, n, o) {
      let a = t.offsetAt(n),
        e = o.findNodeAt(a),
        r = e.tag ? e.tag.length : 0;
      return e.endTagStart &&
        ((e.start + 1 <= a && a <= e.start + 1 + r) ||
          (e.endTagStart + 2 <= a && a <= e.endTagStart + 2 + r))
        ? [
            W.create(t.positionAt(e.start + 1), t.positionAt(e.start + 1 + r)),
            W.create(t.positionAt(e.endTagStart + 2), t.positionAt(e.endTagStart + 2 + r)),
          ]
        : null;
    }
    var Ue = class {
      ...
      limitRanges(n, o) {
        n = n.sort((h, p) => {
          let m = h.startLine - p.startLine;
          return (m === 0 && (m = h.endLine - p.endLine), m);
        });
        let a,
          e = [],
          r = [],
          u = [],
          c = (h, p) => {
            ((r[h] = p), p < 30 && (u[p] = (u[p] || 0) + 1));
          };
        for (let h = 0; h < n.length; h++) {
          let p = n[h];
          if (!a) ((a = p), c(h, 0));
          else if (p.startLine > a.startLine) {
            if (p.endLine <= a.endLine) (e.push(a), (a = p), c(h, e.length));
            else if (p.startLine > a.endLine) {
              do a = e.pop();
              while (a && p.startLine > a.endLine);
              (a && e.push(a), (a = p), c(h, e.length));
            }
          }
        }
        let i = 0,
        ...
        for (let h = 0; h < n.length; h++) {
          let p = r[h];
          typeof p == 'number' && (p < s || (p === s && i++ < o)) && l.push(n[h]);
        }
        return l;
      }
      getFoldingRanges(n, o) {
        let a = this.dataManager.getVoidElements(n.languageId),
          e = V(n.getText()),
          r = e.scan(),
          u = [],
          c = [],
          ...
          s = -1;
        function l(p) {
          (u.push(p), (s = p.startLine));
        }
        for (; r !== S.EOS; ) {
          switch (r) {
            case S.StartTag: {
              let p = e.getTokenText(),
                m = n.positionAt(e.getTokenOffset()).line;
              (c.push({ startLine: m, tagName: p }), (i = p));
              break;
            }
            case S.EndTag: {
              i = e.getTokenText();
            ...
            case S.StartTagClose:
              if (!i || !this.dataManager.isVoidElement(i, a)) break;
            case S.EndTagClose:
            case S.StartTagSelfClose: {
              let p = c.length - 1;
              for (; p >= 0 && c[p].tagName !== i; ) p--;
              if (p >= 0) {
                let m = c[p];
                c.length = p;
                let A = n.positionAt(e.getTokenOffset()).line,
                  b = m.startLine,
                  D = A - 1;
                D > b && s !== b && l({ startLine: b, endLine: D });
              }
              break;
            }
            case S.Comment: {
              let p = n.positionAt(e.getTokenOffset()).line,
                A = e.getTokenText().match(/^\s*#(region\b)|(endregion\b)/);
              if (A)
                if (A[1]) c.push({ startLine: p, tagName: '' });
                else {
                  let b = c.length - 1;
                  for (; b >= 0 && c[b].tagName.length; ) b--;
                  if (b >= 0) {
                    let D = c[b];
                    c.length = b;
                    let T = p;
                    ((p = D.startLine),
                      T > p && s !== p && l({ startLine: p, endLine: T, kind: oe.Region }));
                  }
                }
              else {
                let b = n.positionAt(e.getTokenOffset() + e.getTokenLength()).line;
                p < b && l({ startLine: p, endLine: b, kind: oe.Comment });
              }
              break;
            }
          }
        ...
        let h = (o && o.rangeLimit) || Number.MAX_VALUE;
        return u.length > h ? this.limitRanges(u, h) : u;
      }
    };
    var Oe = class {
      constructor(n) {
      ...
      getSelectionRanges(n, o) {
        let a = this.htmlParser.parseDocument(n);
        return o.map((e) => this.getSelectionRange(e, n, a));
      }
      getSelectionRange(n, o, a) {
        let e = this.getApplicableRanges(o, n, a),
          r,
          u;
        for (let c = e.length - 1; c >= 0; c--) {
          let i = e[c];
          ((!r || i[0] !== r[0] || i[1] !== r[1]) &&
            (u = ce.create(W.create(o.positionAt(e[c][0]), o.positionAt(e[c][1])), u)),
            (r = i));
        }
        return (u || (u = ce.create(W.create(n, n))), u);
      }
      getApplicableRanges(n, o, a) {
        let e = n.offsetAt(o),
          r = a.findNodeAt(e),
          u = this.getAllParentTagRanges(r);
        if (r.startTagEnd && !r.endTagStart) {
          if (r.startTagEnd !== r.end) return [[r.start, r.end]];
          let c = W.create(n.positionAt(r.startTagEnd - 2), n.positionAt(r.startTagEnd));
          return (
            n.getText(c) === '/>'
              ? u.unshift([r.start + 1, r.startTagEnd - 2])
              : u.unshift([r.start + 1, r.startTagEnd - 1]),
            (u = this.getAttributeLevelRanges(n, r, e).concat(u)),
            u
          );
        }
        return !r.startTagEnd || !r.endTagStart
          ? u
          : (u.unshift([r.start, r.end]),
            r.start < e && e < r.startTagEnd
              ? (u.unshift([r.start + 1, r.startTagEnd - 1]),
                (u = this.getAttributeLevelRanges(n, r, e).concat(u)),
                u)
              : r.startTagEnd <= e && e <= r.endTagStart
                ? (u.unshift([r.startTagEnd, r.endTagStart]), u)
                : (e >= r.endTagStart + 2 && u.unshift([r.endTagStart + 2, r.end - 1]), u));
      }
      getAllParentTagRanges(n) {
        let o = n,
          a = [];
        for (; o.parent; ) ((o = o.parent), this.getNodeRanges(o).forEach((e) => a.push(e)));
        return a;
      }
      getNodeRanges(n) {
        return n.startTagEnd && n.endTagStart && n.startTagEnd < n.endTagStart
          ? [
      ...
      getAttributeLevelRanges(n, o, a) {
        let e = W.create(n.positionAt(o.start), n.positionAt(o.end)),
          r = n.getText(e),
          u = a - o.start,
          c = V(r),
          i = c.scan(),
        ...
        for (; i !== S.EOS; ) {
          switch (i) {
            case S.AttributeName: {
              if (u < c.getTokenOffset()) {
                h = !1;
                break;
              }
              (u <= c.getTokenEnd() && l.unshift([c.getTokenOffset(), c.getTokenEnd()]),
                (h = !0),
                (p = c.getTokenOffset()));
              break;
            }
            case S.AttributeValue: {
              if (!h) break;
              let m = c.getTokenText();
              if (u < c.getTokenOffset()) {
                l.push([p, c.getTokenEnd()]);
                break;
              }
              u >= c.getTokenOffset() &&
                u <= c.getTokenEnd() &&
                (l.unshift([c.getTokenOffset(), c.getTokenEnd()]),
                ((m[0] === '"' && m[m.length - 1] === '"') ||
                  (m[0] === "'" && m[m.length - 1] === "'")) &&
                  u >= c.getTokenOffset() + 1 &&
                  u <= c.getTokenEnd() - 1 &&
                  l.unshift([c.getTokenOffset() + 1, c.getTokenEnd() - 1]),
                l.push([p, c.getTokenEnd()]));
              break;
            }
          }
...
*   a _positive value_ means that the element should be focusable and reachable via sequential keyboard navigation; the order in which the elements are focused is the increasing value of the [**tabindex**](#attr-tabindex). If several elements share the same tabindex, their relative order follows their relative positions in the document.`,
        ...
        {
          name: 'onseeked',
          description: { kind: 'markdown', value: 'A seek operation completed.' },
        },
    ...
    var Be = class {
        constructor(n) {
          ((this.dataProviders = []),
            this.setDataProviders(n.useDefaultDataProvider !== !1, n.customDataProviders || []));
        }
        setDataProviders(n, o) {
          ((this.dataProviders = []),
            n && this.dataProviders.push(new pe('html5', Tt)),
        ...
        isVoidElement(n, o) {
          return !!n && ln(o, n.toLowerCase(), (a, e) => a.localeCompare(e)) >= 0;
        }
        getVoidElements(n) {
          let o = Array.isArray(n) ? n : this.getDataProviders().filter((e) => e.isApplicable(n)),
            a = [];
          return (
            o.forEach((e) => {
              e.provideTags()
                .filter((r) => r.void)
                .forEach((r) => a.push(r.name));
            }),
            a.sort()
          );
        }
        isPathAttribute(n, o) {
          if (o === 'src' || o === 'href') return !0;
          let a = Si[n];
          return a ? (typeof a == 'string' ? a === o : a.indexOf(o) !== -1) : !1;
        }
      },
      Si = {
        a: 'href',
    ...
    function Ln(t = Ai) {
      let n = new Be(t),
        ...
        c = new We(n);
      return {
        setDataProviders: n.setDataProviders.bind(n),
        createScanner: V,
        parseHTMLDocument: e.parseDocument.bind(e),
        doComplete: a.doComplete.bind(a),
        doComplete2: a.doComplete2.bind(a),
        setCompletionParticipants: a.setCompletionParticipants.bind(a),
        doHover: o.doHover.bind(o),
        format: _n,
        findDocumentHighlights: An,
        findDocumentLinks: c.findDocumentLinks.bind(c),
        findDocumentSymbols: xn,
        findDocumentSymbols2: vt,
        getFoldingRanges: u.getFoldingRanges.bind(u),
        getSelectionRanges: r.getSelectionRanges.bind(r),
        doQuoteComplete: a.doQuoteComplete.bind(a),
        doTagComplete: a.doTagComplete.bind(a),
        doRename: En,
        findMatchingTagPosition: Cn,
        findOnTypeRenameRanges: yt,
        findLinkedEditingRanges: yt,
      };
    }
    function Mn(t, n) {
      return new pe(t, n);
    ...
    var Ne = class {
      constructor(n, o) {
        ...
        let a = this._languageSettings.data,
          e = a?.useDefaultDataProvider,
          r = [];
        if (a?.dataProviders) for (let u in a.dataProviders) r.push(Mn(u, a.dataProviders[u]));
        this._languageService = Ln({ useDefaultDataProvider: e, customDataProviders: r });
      }
      async doComplete(n, o) {
        let a = this._getTextDocument(n);
        if (!a) return null;
        let e = this._languageService.parseHTMLDocument(a);
      ...
      async format(n, o, a) {
        let e = this._getTextDocument(n);
        if (!e) return [];
        let r = { ...this._languageSettings.format, ...a },
          u = this._languageService.format(e, o, r);
      ...
      async doHover(n, o) {
        ...
        if (!a) return null;
        let e = this._languageService.parseHTMLDocument(a),
          r = this._languageService.doHover(a, o, e);
        return Promise.resolve(r);
      }
      async findDocumentHighlights(n, o) {
        let a = this._getTextDocument(n);
        if (!a) return [];
        let e = this._languageService.parseHTMLDocument(a),
          r = this._languageService.findDocumentHighlights(a, o, e);
        return Promise.resolve(r);
      }
      async findDocumentLinks(n) {
        let o = this._getTextDocument(n);
        if (!o) return [];
        let a = this._languageService.findDocumentLinks(o, null);
        return Promise.resolve(a);
      }
      async findDocumentSymbols(n) {
        let o = this._getTextDocument(n);
        if (!o) return [];
        let a = this._languageService.parseHTMLDocument(o),
          e = this._languageService.findDocumentSymbols(o, a);
        return Promise.resolve(e);
      }
      async getFoldingRanges(n, o) {
        let a = this._getTextDocument(n);
        if (!a) return [];
        let e = this._languageService.getFoldingRanges(a, o);
        return Promise.resolve(e);
      }
      async getSelectionRanges(n, o) {
        let a = this._getTextDocument(n);
        if (!a) return [];
        let e = this._languageService.getSelectionRanges(a, o);
        return Promise.resolve(e);
      }
      async doRename(n, o, a) {
        let e = this._getTextDocument(n);
        if (!e) return null;
        let r = this._languageService.parseHTMLDocument(e),
          u = this._languageService.doRename(e, o, a, r);
        return Promise.resolve(u);
      }
      _getTextDocument(n) {
        ...
        for (let a of o)
          if (a.uri.toString() === n)
            return ve.create(n, this._languageId, a.version, a.getValue());
        return null;
      }
    };
    function Di(t, n) {
