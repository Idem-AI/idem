      ...
      Ar = (e, t, r, n) => {
        if ((t && typeof t == 'object') || typeof t == 'function')
          for (let i of vr(t))
            !xr.call(e, i) &&
              i !== r &&
              ft(e, i, { get: () => t[i], enumerable: !(n = br(t, i)) || n.enumerable });
        return e;
      };
    ...
    function Se(e, t = !1) {
      ...
      function p() {
        ...
        if (n < e.length && e.charCodeAt(n) === 46)
          if ((n++, n < e.length && Ae(e.charCodeAt(n))))
...
`)),
        ...
        switch (g) {
          ...
          case 45:
            if (((i += String.fromCharCode(g)), n++, n === r || !Ae(e.charCodeAt(n))))
              return (o = 16);
          case 48:
          case 49:
          case 50:
...
`,
    ...
    function pt(e, t, r) {
      ...
      function k() {
        let x = p.scan();
        for (u = 0; x === 15 || x === 14; )
          (x === 14 && r.keepLines ? (u += 1) : x === 14 && (u = 1), (x = p.scan()));
      ...
      function g(x, T, O) {
        !m &&
          (!t || (T < c && O > o)) &&
          e.substring(T, O) !== x &&
          w.push({ offset: T, length: O - T, content: x });
      }
      let S = k();
      ...
      for (; S !== 17; ) {
        ...
        for (; u === 0 && (T === 12 || T === 13); ) {
          ...
          (g(Q[1], x, j),
            (x = p.getTokenOffset() + p.getTokenLength() + s),
            (I = T === 12),
            (O = I ? y() : ''),
            (T = k()));
        }
        if (T === 2)
          (S !== 1 && f--,
            (r.keepLines && u > 0) || (!r.keepLines && S !== 1)
              ? (O = y())
              : r.keepLines && (O = Q[1]));
        else if (T === 4)
          (S !== 3 && f--,
            (r.keepLines && u > 0) || (!r.keepLines && S !== 3)
              ? (O = y())
              : r.keepLines && (O = Q[1]));
        else {
          switch (S) {
...
`.indexOf(e.charAt(t)) !== -1
    ...
    function ln(e, t, r = De.DEFAULT) {
      ...
      function I() {
        return n.getToken() !== 10
          ? (x(3, [], [2, 5]), !1)
          : (T(!1),
            n.getToken() === 6 ? (m(':'), S(), N() || x(4, [], [2, 5])) : x(5, [], [2, 5]),
            i.pop(),
            !0);
      }
      function E() {
    ...
    (function (e) {
      function t(n, i) {
        return (
          n === Number.MAX_VALUE && (n = Be.MAX_VALUE),
          i === Number.MAX_VALUE && (i = Be.MAX_VALUE),
          { line: n, character: i }
        );
      }
      e.create = t;
    ...
    (function (e) {
      function t(n, i, s, o) {
        if (b.uinteger(n) && b.uinteger(i) && b.uinteger(s) && b.uinteger(o))
          return { start: D.create(n, i), end: D.create(s, o) };
    ...
    (function (e) {
      ...
      function r(n) {
        ...
        return (
          ...
          (b.undefined(s.codeDescription) ||
            b.string((i = s.codeDescription) === null || i === void 0 ? void 0 : i.href)) &&
          ...
          (i.options === void 0 ||
            ((i.options.recursive === void 0 || b.boolean(i.options.recursive)) &&
              (i.options.ignoreIfNotExists === void 0 ||
                b.boolean(i.options.ignoreIfNotExists)))) &&
          (i.annotationId === void 0 || Te.is(i.annotationId))
        );
      }
      e.is = r;
        ...
        return (
          ...
          (n.documentChanges === void 0 ||
            n.documentChanges.every((i) =>
              b.string(i.kind) ? Tt.is(i) || Nt.is(i) || Pt.is(i) : Ce.is(i)
            ))
        );
      }
      e.is = t;
    ...
    (function (e) {
      function t(r) {
        ...
        return (
          n &&
          (b.string(n.detail) || n.detail === void 0) &&
          (b.string(n.description) || n.description === void 0)
        );
      }
      e.is = t;
    })(Nn || (Nn = {}));
    ...
    (function (e) {
      function t(r, n, ...i) {
        let s = { label: r };
        return (
          b.defined(n) && (s.documentation = n),
          b.defined(i) ? (s.parameters = i) : (s.parameters = []),
          s
        );
      }
      e.create = t;
      ...
      function r(n) {
        ...
        return (
          ...
          (i.triggerKind === void 0 ||
            i.triggerKind === We.Invoked ||
            i.triggerKind === We.Automatic)
        );
      }
      e.is = r;
    })(Rt || (Rt = {}));
    ...
    (function (e) {
      ...
      function r(n) {
        ...
        return (
          i != null &&
          _.is(i.range) &&
          b.boolean(i.caseSensitiveLookup) &&
          (b.string(i.variableName) || i.variableName === void 0)
        );
      }
      e.is = r;
    })(Dn || (Dn = {}));
    ...
    (function (e) {
      ...
      function i(s, o) {
        ...
        let u = 0,
          f = 0,
          d = 0;
        for (; u < l.length && f < a.length; )
          o(l[u], a[f]) <= 0 ? (s[d++] = l[u++]) : (s[d++] = a[f++]);
...
` &&
    ...
    var ze = class e {
          ...
          for (let n of t)
            if (e.isIncremental(n)) {
              ...
              if (l - c === u.length) for (let d = 0, h = u.length; d < h; d++) a[d + c + 1] = u[d];
                ...
                u.length < 1e4
                  ? a.splice(c + 1, l - c, ...u)
                  : (this._lineOffsets = a = a.slice(0, c + 1).concat(u, a.slice(l + 1)));
        ...
        getLineOffsets() {
          return (
            this._lineOffsets === void 0 && (this._lineOffsets = Zn(this._content, !0)),
            this._lineOffsets
          );
        }
        positionAt(t) {
    ...
    (function (e) {
      ...
      function n(i, s) {
        ...
        for (let u of c) {
          ...
          (f > l && a.push(o.substring(l, f)),
            u.newText.length && a.push(u.newText),
            (l = i.offsetAt(u.range.end)));
        }
    ...
    function A(...e) {
      let t = e[0],
        ...
        i;
      if (typeof t == 'string')
        ((r = t), (n = t), e.splice(0, 1), (i = !e || typeof e[0] != 'object' ? e : e[0]));
        ...
        ((n = t.message),
          ...
          t.comment &&
            t.comment.length > 0 &&
            (r += `/${Array.isArray(t.comment) ? t.comment.join('') : t.comment}`),
          (i = t.args ?? {}));
      let s = Mr?.[r];
      return s
        ? typeof s == 'string'
    ...
    var $r = {
        ...
        date: {
          errorMessage: A('String is not a RFC3339 date.'),
    ...
    var q = class {
          ...
          for (let r of this.problems)
            r.code === M.EnumValueMismatch &&
              (r.message = A(
                ...
                this.enumValues.map((n) => JSON.stringify(n)).join(', ')
              ));
        }
      }
      mergePropertyMatch(t) {
        ((this.problems = this.problems.concat(t.problems)),
          ...
          (t.enumValueMatch || (!t.hasProblems() && t.propertiesMatches)) &&
            this.propertiesValueMatches++,
          t.enumValueMatch &&
            t.enumValues &&
            t.enumValues.length === 1 &&
      ...
      validate(t, r, n = z.Warning, i) {
        if (this.root && r) {
          ...
          return (
            ...
            s.problems.map((o) => {
              let c = _.create(
                t.positionAt(o.location.offset),
                t.positionAt(o.location.offset + o.location.length)
              );
    ...
    function C(e, t, r, n, i) {
      ...
      function o() {
          ...
          (Array.isArray(t.type)
            ? t.type.some(f) ||
              r.problems.push({
                ...
                message:
                  t.errorMessage || A('Incorrect type. Expected one of {0}.', t.type.join(', ')),
              })
            : t.type &&
              (f(t.type) ||
                r.problems.push({
        ...
        let h = (w, g) => {
          ...
          for (let T of w) {
            let O = Z(T),
              I = new q(),
              E = n.newSub();
            if ((C(s, O, I, E, i), I.hasProblems() || S.push(O), !x))
          ...
          return (
            S.length > 1 &&
              ...
              r.problems.push({
                ...
                message: A('Matches multiple schemas when only one must validate.'),
              }),
        ...
        let p = (w) => {
          ...
          m = (w, g, S) => {
            ...
            (C(s, x, T, O, i),
              n.merge(O),
              r.mergeProcessedProperties(T),
              T.hasProblems() ? S && p(S) : g && p(g));
          },
          y = Z(t.if);
            ...
            g ||
              r.problems.push({
                ...
                message:
                  ...
                  A(
                    'Value is not accepted. Valid values: {0}.',
                    t.enum.map((S) => JSON.stringify(S)).join(', ')
                  ),
              }));
        }
        if (Y(t.const)) {
        ...
        if (k || t.deprecated) {
          ...
          r.problems.push({
            location: { offset: w.offset, length: w.length },
            severity: z.Warning,
            message: k,
            code: M.Deprecated,
          });
      ...
      function c(f) {
        ...
        if (W(t.multipleOf)) {
          ...
          if (Number.isInteger(t.multipleOf)) S = d % t.multipleOf;
            ...
            if (x && T) {
              ...
              (T.multiplier < x.multiplier ? (T.value *= O) : (x.value *= O),
                (S = T.value % x.value));
            }
          }
          S !== 0 &&
            r.problems.push({
              ...
              message: A('Value is not divisible by {0}.', t.multipleOf),
            });
        }
        function p(S, x) {
          if (W(x)) return x;
        ...
        W(y) &&
          ...
          r.problems.push({
            location: { offset: f.offset, length: f.length },
            message: A('Value is below the exclusive minimum of {0}.', y),
          });
        ...
        W(k) &&
          ...
          r.problems.push({
            location: { offset: f.offset, length: f.length },
            message: A('Value is above the exclusive maximum of {0}.', k),
          });
        ...
        W(w) &&
          ...
          r.problems.push({
            location: { offset: f.offset, length: f.length },
            message: A('Value is below the minimum of {0}.', w),
          });
        ...
        W(g) &&
          ...
          r.problems.push({
            location: { offset: f.offset, length: f.length },
            message: A('Value is above the maximum of {0}.', g),
          });
      }
      function l(f) {
        if (
            ...
            (me(t.pattern)?.test(f.value) ||
              r.problems.push({
                ...
                message:
                  ...
                  t.errorMessage ||
                  A('String does not match the pattern of "{0}".', t.pattern),
              })),
          t.format)
        )
          switch (t.format) {
            ...
            case 'uri-reference':
              {
                ...
                if (!f.value) h = A('URI expected.');
                  ...
                  p
                    ? !p[2] && t.format === 'uri' && (h = A('URI with a scheme is expected.'))
                    : (h = A('URI is expected.'));
                }
                h &&
                  r.problems.push({
                    location: { offset: f.offset, length: f.length },
                    message:
                      t.patternErrorMessage || t.errorMessage || A('String is not a URI: {0}', h),
                  });
              }
              break;
            case 'color-hex':
      ...
      function a(f) {
        ...
        i.schemaDraft >= ie.v2020_12
          ...
          : ((d = Array.isArray(t.items) ? t.items : void 0),
            (h = Array.isArray(t.items) ? t.additionalItems : t.items));
        let p = 0;
        if (d !== void 0) {
          ...
          for (; p < k; p++) {
            let w = d[p],
              ...
              S = new q(),
              x = f.items[p];
            (x && (C(x, g, S, n, i), r.mergePropertyMatch(S)),
              r.processedProperties.add(String(p)));
          }
        }
        ...
        if (m) {
          ...
          for (let w = 0; w < f.items.length; w++) {
            let g = f.items[w],
              S = new q();
            (C(g, m, S, ve.instance, i),
              S.hasProblems() ||
                (k++, i.schemaDraft >= ie.v2020_12 && r.processedProperties.add(String(w))));
          }
          (k === 0 &&
            !W(t.minContains) &&
            r.problems.push({
        ...
        if (
          ...
          w() &&
            r.problems.push({
              location: { offset: f.offset, length: f.length },
              message: A('Array has duplicate items.'),
            });
        }
      }
      function u(f) {
    ...
    function tr(e, t) {
              ...
              Array.isArray(o) &&
                o.push(
                  _.create(
                    ...
                    e.positionAt(s.getTokenOffset() + s.getTokenLength())
                  )
                );
              break;
            case 15:
      ...
      function f() {
        switch (s.getTokenError()) {
          ...
          case 6:
            return (
              u(
                A('Invalid characters in string. Control characters must be escaped.'),
                M.InvalidCharacter
              ),
              !0
            );
      ...
      function h(O) {
        ...
        for (; s.getToken() !== 4 && s.getToken() !== 17; ) {
          ...
          let N = S(I);
          (N ? I.items.push(N) : u(A('Value expected'), M.ValueExpected, void 0, [], [4, 5]),
            (j = !0));
        }
        return s.getToken() !== 4
          ? u(A('Expected comma or closing bracket'), M.CommaOrCloseBacketExpected, I)
          : d(I, !0);
      }
      ...
      function m(O, I) {
            ...
            ? (a(
              ...
              oe(v) &&
                a(
                  ...
                  M.DuplicateKey,
                  v.keyNode.offset,
                  v.keyNode.offset + v.keyNode.length,
                  z.Warning
                ),
              (I[j.value] = !0))
            : (I[j.value] = E);
        ...
        if (s.getToken() === 6) ((E.colonOffset = s.getTokenOffset()), c());
          ...
          s.getToken() === 10 &&
            e.positionAt(j.offset + j.length).line < e.positionAt(s.getTokenOffset()).line)
        )
          return ((E.length = j.length), E);
        let N = S(E);
        return N
          ? ((E.valueNode = N), (E.length = N.offset + N.length - E.offset), E)
          : u(A('Value expected'), M.ValueExpected, E, [], [2, 5]);
      }
      function y(O) {
        ...
        for (; s.getToken() !== 2 && s.getToken() !== 17; ) {
          ...
          (N
            ? I.properties.push(N)
            : u(A('Property expected'), M.PropertyExpected, void 0, [], [2, 5]),
            (j = !0));
        }
        return s.getToken() !== 2
          ? u(A('Expected comma or closing brace'), M.CommaOrCloseBraceExpected, I)
          : d(I, !0);
      }
      function k(O) {
      ...
      return (
        c() !== 17 &&
          ((x = S(x)),
          x
            ? s.getToken() !== 17 && u(A('End of file expected.'), M.Undefined)
            : u(A('Expected a JSON object, array or literal.'), M.Undefined)),
        new Qe(x, r, o)
      );
    }
    function Ke(e, t, r) {
      ...
      et = class {
        ...
        doComplete(t, r, n) {
          ...
          if (c && o === c.offset + c.length && o > 0) {
            let h = s[o - 1];
            ((c.type === 'object' && h === '}') || (c.type === 'array' && h === ']')) &&
              (c = c.parent);
          }
          ...
          return this.schemaService.getSchemaForResource(t.uri, n).then((h) => {
            ...
            if (c && c.type === 'string') {
              ...
              g &&
                ...
                ((m = !g.valueNode),
                (k = g),
                (y = s.substr(c.offset + 1, c.length - 2)),
                g && (c = g.parent));
            }
            if (c && c.type === 'object') {
              ...
              (m && (S = this.evaluateSeparatorAfter(t, t.offsetAt(a.end))),
                h
                  ? this.getPropertyCompletions(h, n, c, m, S, d)
                  : this.getSchemaLessPropertyCompletions(n, c, y, d));
              let x = Ve(c);
            ...
            return (
              h
                ? this.getValueCompletions(h, n, c, o, t, d, w)
                : this.getSchemaLessValueCompletions(n, c, o, t, d),
              this.contributions.length > 0 &&
                this.getContributedValueCompletions(n, c, o, t, d, p),
                ...
                Object.keys(a).forEach((f) => {
                  ...
                  if (typeof d == 'object' && !d.deprecationMessage && !d.doNotSuggest) {
                    ...
                    (d.suggestSortText !== void 0 && (h.sortText = d.suggestSortText),
                      h.insertText &&
                        fe(h.insertText, `$1${s}`) &&
                        (h.command = { title: 'Suggest', command: 'editor.action.triggerSuggest' }),
                      o.add(h));
                  }
                });
              ...
              if (typeof u == 'object' && !u.deprecationMessage && !u.doNotSuggest) {
                let f = (d, h = void 0) => {
                  let p = {
                    ...
                    documentation:
                      h || this.fromMarkup(u.markdownDescription) || u.description || '',
                  };
                  (u.suggestSortText !== void 0 && (p.sortText = u.suggestSortText),
                    p.insertText &&
                      fe(p.insertText, `$1${s}`) &&
                      (p.command = { title: 'Suggest', command: 'editor.action.triggerSuggest' }),
                    o.add(p));
                };
                if (u.enum)
                  for (let d = 0; d < u.enum.length; d++) {
                    ...
                    (u.markdownEnumDescriptions && d < u.markdownEnumDescriptions.length
                      ...
                      : u.enumDescriptions &&
                        d < u.enumDescriptions.length &&
                        (h = u.enumDescriptions[d]),
                      f(u.enum[d], h));
                  }
                u.const && f(u.const);
              }
        ...
        getSchemaLessValueCompletions(t, r, n, i, s) {
          ...
          if (r.type === 'property' && n > (r.colonOffset || 0)) {
            ...
            (t.visit(
              (f) => (
                f.type === 'property' && f.keyNode.value === u && f.valueNode && l(f.valueNode),
                !0
              )
            ),
              u === '$schema' &&
              ...
              t.visit(
                (u) => (
                  u.type === 'property' &&
                    u.keyNode.value === a &&
                    u.valueNode &&
                    u.valueNode.type === 'array' &&
                    u.valueNode.items.forEach(l),
                  !0
                )
              );
                ...
                if (n.type === 'array' && h.schema.items) {
                  ...
                  if (h.schema.uniqueItems) {
                    ...
                    (n.children.forEach((y) => {
                      y.type !== 'array' &&
                        y.type !== 'object' &&
                        m.add(this.getLabelForValue(ae(y)));
                    }),
                      (p = {
                        ...o,
                        add(y) {
                  ...
                  if (Array.isArray(h.schema.items)) {
                    ...
                    m < h.schema.items.length &&
                      this.addSchemaValueCompletions(h.schema.items[m], f, p, c);
        ...
        addSchemaValueCompletions(t, r, n, i) {
          typeof t == 'object' &&
            ...
            Array.isArray(t.allOf) &&
              t.allOf.forEach((s) => this.addSchemaValueCompletions(s, r, n, i)),
            Array.isArray(t.anyOf) &&
              t.anyOf.forEach((s) => this.addSchemaValueCompletions(s, r, n, i)),
            Array.isArray(t.oneOf) &&
              t.oneOf.forEach((s) => this.addSchemaValueCompletions(s, r, n, i)));
        }
        addDefaultValueCompletions(t, r, n, i = 0) {
          ...
          if (Y(t.default)) {
            ...
            (this.doesSupportsLabelDetails()
              ? (l.labelDetails = { description: A('Default value') })
              : (l.detail = A('Default value')),
              n.add(l),
              (s = !0));
          }
...
` + p
        ...
        addEnumValueCompletions(t, r, n) {
          if (
            ...
            for (let i = 0, s = t.enum.length; i < s; i++) {
              ...
              (t.markdownEnumDescriptions &&
              i < t.markdownEnumDescriptions.length &&
              this.doesSupportMarkdown()
                ? (c = this.fromMarkup(t.markdownEnumDescriptions[i]))
                : t.enumDescriptions &&
                  i < t.enumDescriptions.length &&
                  (c = t.enumDescriptions[i]),
                n.add({
                  kind: this.getSuggestionKind(t.type),
        ...
        getInsertTextForValue(t, r) {
          ...
          return n === '{}'
            ...
            : n === '[]'
              ? '[$1]' + r
              : this.getInsertTextForPlainText(n + r);
        }
        getInsertTextForSnippetValue(t, r) {
          return (
            Ke(t, '', (i) =>
              typeof i == 'string' && i[0] === '^' ? i.substr(1) : JSON.stringify(i)
            ) + r
          );
        }
          ...
          if (r) {
            ...
            if (
              (r.enum &&
                (!c &&
                  r.enum.length === 1 &&
                  (c = this.getInsertTextForGuessedValue(r.enum[0], '')),
                (l += r.enum.length)),
              ...
              Array.isArray(r.examples) &&
                r.examples.length &&
                (c || (c = this.getInsertTextForGuessedValue(r.examples[0], '')),
                (l += r.examples.length)),
              l === 0)
            ) {
...
\r\v":{[,]}`.indexOf(i.charAt(n)) === -1;
        ...
        findItemAtOffset(t, r, n) {
          ...
          for (let o = s.length - 1; o >= 0; o--) {
            ...
            if (n > c.offset + c.length)
              return (
                i.setPosition(c.offset + c.length),
                i.scan() === 5 && n >= i.getTokenOffset() + i.getTokenLength() ? o + 1 : o
              );
        ...
        doesSupportMarkdown() {
          if (!Y(this.supportsMarkdown)) {
            let t =
              this.clientCapabilities.textDocument?.completion?.completionItem?.documentationFormat;
          ...
          if (u && s) {
            ...
            f.every((k) => {
              if (
                ...
                k.schema &&
                ((d = d || k.schema.title),
                (h = h || k.schema.markdownDescription || Kt(k.schema.description)),
                k.schema.enum)
              ) {
    ...
    var rt = class {
        ...
        configure(t) {
          t &&
            ...
            (this.commentSeverity = t.allowComments ? void 0 : z.Error));
        }
    ...
    var it = class {
      ...
      findDocumentSymbols(t, r, n = { resultLimit: Number.MAX_VALUE }) {
        ...
        if (
          (o === 'vscode://defaultsettings/keybindings.json' ||
            fe(o.toLowerCase(), '/user/keybindings.json')) &&
          i.type === 'array'
        ) {
          let d = [];
            ...
            if (h.type === 'object') {
              for (let p of h.properties)
                if (p.keyNode.value === 'key' && p.valueNode) {
                  ...
                  if (
                    (d.push({ name: sr(p.valueNode), kind: re.Function, location: m }), s--, s <= 0)
                  )
          ...
          if (i) {
            ...
            for (let a of c)
              if (
                !a.inverted &&
                a.schema &&
                (a.schema.format === 'color' || a.schema.format === 'color-hex') &&
                a.node &&
                a.node.type === 'string'
              ) {
      ...
      getColorPresentations(t, r, n, i) {
        ...
        return (
          n.alpha === 1
            ? (u = `#${a(o)}${a(c)}${a(l)}`)
            : (u = `#${a(o)}${a(c)}${a(l)}${a(Math.round(n.alpha * 255))}`),
          ...
          470: (i) => {
                ...
                if (u === 47) {
                  if (!(h === m - 1 || p === 1))
                    if (h !== m - 1 && p === 2) {
                      if (
                        ...
                        if (f.length > 2) {
                          ...
                          if (y !== f.length - 1) {
                            (y === -1
                              ? ((f = ''), (d = 0))
                              : (d = (f = f.slice(0, y)).length - 1 - f.lastIndexOf('/')),
                              (h = m),
                              (p = 0));
                            continue;
                          }
                      ...
                      (f.length > 0 ? (f += '/' + l.slice(h + 1, m)) : (f = l.slice(h + 1, m)),
                        (d = m - h - 1));
                  ((h = m), (p = 0));
                } else u === 46 && p !== -1 ? ++p : (p = -1);
              }
            ...
            var c = {
              ...
              relative: function (l, a) {
                ...
                var g = '';
                for (k = u + y + 1; k <= f; ++k)
                  (k !== f && l.charCodeAt(k) !== 47) ||
                    (g.length === 0 ? (g += '..') : (g += '/..'));
                return g.length > 0
                  ? g + a.slice(h + y)
                  : ((h += y), a.charCodeAt(h) === 47 && ++h, a.slice(h));
              },
              ...
              dirname: function (l) {
                if ((s(l), l.length === 0)) return '.';
                for (
                  var a = l.charCodeAt(0), u = a === 47, f = -1, d = !0, h = l.length - 1;
                  h >= 1;
                  --h
                )
                ...
                if (a !== void 0 && a.length > 0 && a.length <= l.length) {
                  ...
                  for (u = l.length - 1; u >= 0; --u) {
                    ...
                    if (y === 47) {
                      ...
                      (m === -1 && ((h = !1), (m = u + 1)),
                        p >= 0 &&
                          (y === a.charCodeAt(p) ? --p == -1 && (d = u) : ((p = -1), (d = m))));
                  }
              ...
              extname: function (l) {
                ...
                for (var a = -1, u = 0, f = -1, d = !0, h = 0, p = l.length - 1; p >= 0; --p) {
                  ...
                  if (m !== 47)
                    (f === -1 && ((d = !1), (f = p + 1)),
                      m === 46 ? (a === -1 ? (a = p) : h !== 1 && (h = 1)) : a !== -1 && (h = -1));
                  else if (!d) {
                    u = p + 1;
                    break;
                  }
                }
                return a === -1 || f === -1 || h === 0 || (h === 1 && a === f - 1 && a === u + 1)
                  ? ''
                  : l.slice(a, f);
              },
              format: function (l) {
              ...
              parse: function (l) {
                ...
                return (
                  h === -1 || m === -1 || w === 0 || (w === 1 && h === m - 1 && h === p + 1)
                    ...
                    : (p === 0 && d
                        ? ((a.name = l.slice(1, h)), (a.base = l.slice(1, m)))
                        : ((a.name = l.slice(p, h)), (a.base = l.slice(p, m))),
                      (a.ext = l.slice(h, m))),
      ...
      ((() => {
        ...
        class d {
          ...
          static parse(v, P = !1) {
            let L = f.exec(v);
            return L
              ? new p(L[2] || a, T(L[4] || a), T(L[5] || a), T(L[7] || a), T(L[9] || a), P)
              : new p(a, a, a, a, a);
          }
          static file(v) {
            let P = a;
            if ((i && (v = v.replace(/\\/g, u)), v[0] === u && v[1] === u)) {
              ...
              L === -1
                ? ((P = v.substring(2)), (v = u))
                : ((P = v.substring(2, L)), (v = v.substring(L) || u));
            }
          ...
          static revive(v) {
            if (v) {
              if (v instanceof d) return v;
              {
                let P = new p(v);
                return (
                  (P._formatted = v.external),
                  (P._fsPath = v._sep === h ? v.fsPath : null),
                  P
                );
              }
            }
        ...
        class p extends d {
          ...
          toString(v = !1) {
            return v
              ? g(this, !0)
              : (this._formatted || (this._formatted = g(this, !1)), this._formatted);
          }
          toJSON() {
            let v = { $mid: 1 };
            return (
        ...
        function y(N, v, P) {
          ...
          for (let F = 0; F < N.length; F++) {
            ...
            if (
              ...
              ($ !== -1 && ((L += encodeURIComponent(N.substring($, F))), ($ = -1)),
                L !== void 0 && (L += N.charAt(F)));
            else {
              L === void 0 && (L = N.substr(0, F));
              let se = m[V];
              se !== void 0
                ? ($ !== -1 && ((L += encodeURIComponent(N.substring($, F))), ($ = -1)), (L += se))
                : $ === -1 && ($ = F);
            }
          }
            ...
            (P =
              N.authority && N.path.length > 1 && N.scheme === 'file'
                ...
                : N.path.charCodeAt(0) === 47 &&
                    ((N.path.charCodeAt(1) >= 65 && N.path.charCodeAt(1) <= 90) ||
                      (N.path.charCodeAt(1) >= 97 && N.path.charCodeAt(1) <= 122)) &&
          ...
          if (($ && ((L += $), (L += ':')), (F || $ === 'file') && ((L += u), (L += u)), F)) {
            ...
            if (J !== -1) {
              ...
              ((F = F.substr(J + 1)),
                ...
                J === -1
                  ? (L += P($e, !1, !1))
                  : ((L += P($e.substr(0, J), !1, !1)),
                    (L += ':'),
                    (L += P($e.substr(J + 1), !1, !0))),
                (L += '@'));
            }
            ((F = F.toLowerCase()),
              (J = F.lastIndexOf(':')),
              J === -1
                ? (L += P(F, !1, !0))
                : ((L += P(F.substr(0, J), !1, !0)), (L += F.substr(J))));
          }
          if (V) {
          ...
          case '*':
            ...
            s
              ? d > 1 &&
                ...
                ? (h === '/'
                    ? a++
                    : f === '/' && n.endsWith('\\/') && (n = n.substr(0, n.length - 2)),
                  (n += '((?:[^/]*(?:/|$))*)'))
                : (n += '([^/]*)')
              : (n += '.*');
            break;
    ...
    var qr = '!',
              ...
              (s || (i = i.substring(1)),
                i.length > 0 &&
                  ...
                  this.globWrappers.push({
                    regexp: ar('**/' + i, { extended: !0, globstar: !0 }),
                    include: s,
                  })));
            }
      ...
      tn = class {
        ...
        getResolvedSchema() {
          return (
            this.resolvedSchema ||
              (this.resolvedSchema = this.getUnresolvedSchema().then((t) =>
                this.service.resolveSchemaContent(t, this)
              )),
            this.resolvedSchema
          );
        }
      ...
      ot = class {
        ...
        getSectionRecursive(t, r) {
          ...
          if (r.patternProperties) {
            for (let i of Object.keys(r.patternProperties))
              if (me(i)?.test(n)) return this.getSectionRecursive(t, r.patternProperties[i]);
          } else {
      ...
      at = class {
        ...
        onResourceChange(t) {
          ...
          for (; n.length; ) {
            ...
            for (let o = 0; o < i.length; o++) {
              let c = i[o];
              c &&
                (c.uri === s || c.dependencies.has(s)) &&
                (c.uri !== s && n.push(c.uri), c.clearSchema() && (r = !0), (i[o] = void 0));
            }
          }
          return r;
        }
        ...
        registerExternalSchema(t) {
          ...
          return (
            ...
            t.fileMatch &&
              t.fileMatch.length &&
              this.addFilePatternAssociation(t.fileMatch, t.folderUri, [r]),
        ...
        clearExternalSchemas() {
          ((this.schemasById = {}),
            ...
            (this.registeredSchemasIds = {}),
            (this.cachedSchemaForResource = void 0));
          for (let t in this.contributionSchemas)
        ...
        resolveSchemaContent(t, r) {
          ...
          if (s === 'http://json-schema.org/draft-03/schema')
            return this.promise.resolve(
              new ot({}, [A('Draft-03 schemas are not supported.')], [], s)
            );
          let o = new Set(),
            ...
            l = (m, y) => {
              ...
              return (
                ...
                y
                  .split('/')
                  .some((w) => ((w = w.replace(/~1/g, '/').replace(/~0/g, '~')), (k = k[w]), !k)),
                k
              );
            },
            ...
            f = (m, y, k, w) => {
              ...
              (w === void 0 || w.length === 0
                ...
                g
                  ? u(m, g)
                  : n.push(A("$ref '{0}' in '{1}' can not be resolved.", w || '', k.uri)));
            },
            d = (m, y, k, w) => {
              (c &&
                !/^[A-Za-z][A-Za-z0-9+\-.+]*:\/\/.*/.test(y) &&
                (y = c.resolveRelativePath(y, w.uri)),
                (y = pe(y)));
            ...
            h = (m, y, k) => {
              ...
              return (
                this.traverseNodes(m, (g) => {
                  ...
                  (g.$recursiveRef && o.add('$recursiveRef'),
                    g.$dynamicRef && o.add('$dynamicRef'));
                }),
                this.promise.all(w)
              );
            },
            p = (m) => {
              ...
              return (
                this.traverseNodes(m, (k) => {
                  ...
                  (g &&
                    (y.has(g) ? n.push(A("Duplicate anchor declaration: '{0}'", g)) : y.set(g, k)),
            ...
            for (let n of r.root.properties)
              if (n.keyNode.value === '$schema' && n.valueNode?.type === 'string') {
                ...
                return (
                  this.contextService &&
                    !/^\w[\w\d+.-]*:/.test(i) &&
                    (i = this.contextService.resolveRelativePath(i, t)),
                  i
                );
              }
          }
        ...
        getAssociatedSchemas(t) {
          let r = Object.create(null),
            n = [],
            i = lr(t);
          for (let s of this.filePatternAssociations)
            if (s.matchesPattern(i)) for (let o of s.getURIs()) r[o] || (n.push(o), (r[o] = !0));
          return n;
        }
        ...
        getSchemaForResource(t, r) {
          ...
          let n = this.getAssociatedSchemas(t),
            i =
              n.length > 0
                ? this.createCombinedSchema(t, n).getResolvedSchema()
        ...
        getMatchingSchemas(t, r, n) {
          ...
          return this.getSchemaForResource(t.uri, r).then((i) =>
            i ? r.getMatchingSchemas(i.schema).filter((s) => !s.inverted) : []
          );
        }
      },
      zr = 0;
          ...
          case 4: {
            ...
            if (i.length > 0 && i[i.length - 1].kind === p) {
              ...
              m &&
                y > m.startLine + 1 &&
                s !== m.startLine &&
                ((m.endLine = y - 1), l(m), (s = m.startLine));
            }
            break;
          }
          case 13: {
...
`,
      ...
      return mn(e.getText(), n, i).map((s) =>
        G.replace(_.create(e.positionAt(s.offset), e.positionAt(s.offset + s.length)), s.content)
      );
    }
    var B;
    (function (e) {
    ...
    var ke = class {
      ...
      addChildProperty(t) {
        if (((t.parent = this), this.childrenProperties.length > 0)) {
          let r = 0;
          (t.noKeyName
            ? (r = this.childrenProperties.length)
            : (r = Gr(this.childrenProperties, t, Hr)),
            r < 0 && (r = r * -1 - 1),
    ...
    function Xr(e) {
      ...
      for (; (c = r.scan()) !== 17; ) {
        if (
          ...
          (f === 2 || f === 4 ? (o.endLineNumber = g - 1) : (s.endLineNumber = g - 1),
            (p = g),
            (k = !1));
        }
        if (
          (w === !0 &&
            ...
            c !== 12 &&
            c !== 13 &&
            ((p = r.getTokenStartLine()), (w = !1)),
          r.getTokenStartLine() !== l)
        ) {
        ...
        switch (c) {
          ...
          case 3: {
            if (
              (n.beginningLineNumber === void 0 && (n.beginningLineNumber = r.getTokenStartLine()),
              y[y.length - 1] === B.Object)
            )
              i = s;
        ...
        c !== 14 &&
          ...
          (u = c),
          (d = r.getTokenStartLine()),
          (h = r.getTokenOffset() + r.getTokenLength() - a));
      }
      return n;
    }
    function Zr(e, t) {
    ...
    function ur(e, t, r) {
      if (t.childrenProperties.length !== 0)
        if (t.type === B.Object) {
          let n = 1 / 0;
          for (let s of t.childrenProperties)
            s.beginningLineNumber < n && (n = s.beginningLineNumber);
    ...
    function hr(e, t, r) {
      for (let n of t.childrenProperties) {
        if (n.type === B.Object) {
          let i = 1 / 0;
          for (let o of n.childrenProperties)
            o.beginningLineNumber < i && (i = o.beginningLineNumber);
          let s = i - n.beginningLineNumber;
          e.push(
            new lt(r + n.beginningLineNumber - t.beginningLineNumber + s, n.childrenProperties)
          );
        }
      ...
      return {
        configure: (c) => {
          (r.clearExternalSchemas(),
            c.schemas?.forEach(r.registerExternalSchema.bind(r)),
            o.configure(c));
        },
    ...
    var ct = class {
        ...
        _getTextDocument(t) {
          ...
          for (let n of r)
            if (n.uri.toString() === t)
              return X.create(t, this._languageId, n.version, n.getValue());
          return null;
        }
      },
      ni = 47,
    ...
    function yr(e) {
      ...
      for (let n of e)
        n.length === 0 ||
          ...
          (n.length === 2 && n.charCodeAt(0) === rn && n.charCodeAt(1) === rn
            ? t.pop()
            : t.push(n));
