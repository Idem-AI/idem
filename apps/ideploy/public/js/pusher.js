    ...
    function (t, e, n) {
              ...
              if (200 === s.status) {
                ...
                try {
                  ...
                  r(
                    new y(
                      200,
                      `JSON returned from ${i.toString()} endpoint was invalid, yet status code was 200. Data was: ${s.responseText}`
                    ),
                    null
                  );
                }
                ...
                r(
                  new y(
                    s.status,
                    `Unable to retrieve auth string from ${i.toString()} endpoint - received status: ${s.status} from ${n.endpoint}. ${t}`
                  ),
                  null
                );
              }
      ...
      var P = function (t) {
          ...
          return e < 128
            ...
            : e < 2048
              ...
              : S(224 | ((e >>> 12) & 15)) + S(128 | ((e >>> 6) & 63)) + S(128 | (63 & e));
        },
        E = function (t) {
      ...
      function H() {
        for (var t = ['Pusher'], e = 0; e < arguments.length; e++)
          'string' == typeof arguments[e] ? t.push(arguments[e]) : t.push(G(arguments[e]));
        return t.join(' : ');
      }
      function U(t, e) {
            ...
            (function t(i, r) {
              ...
              switch (typeof i) {
                case 'object':
                  ...
                  if (
                    (e.push(i), n.push(r), '[object Array]' === Object.prototype.toString.apply(i))
                  )
          ...
          ((e.script = document.createElement('script')),
            ...
            e.script.addEventListener
              ...
              : (e.script.onreadystatechange = function () {
                  ('loaded' !== e.script.readyState && 'complete' !== e.script.readyState) ||
                    t.callback(null);
                }),
      ...
      function et(t, e) {
        return (
          '/app/' +
          t +
          ('?protocol=' + s.PROTOCOL + '&client=js&version=' + s.VERSION + (e ? '&' + e : ''))
        );
      }
      var nt = {
      ...
      class at {
        ...
        unbind_global(t) {
          return t
            ? ((this.global_callbacks = F(this.global_callbacks || [], (e) => e !== t)), this)
      ...
      class ct extends at {
        ...
        onClose(t) {
          (t
            ? this.changeState('closed', { code: t.code, reason: t.reason, wasClean: t.wasClean })
        ...
        changeState(t, e) {
          ((this.state = t),
            this.timeline.info(this.buildTimelineMessage({ state: t, params: e })),
            this.emit(t, e));
        }
      ...
      var ut = new ht({
        ...
        gt = { ws: ut, xhr_streaming: new ht(N({}, dt, ft)), xhr_polling: new ht(N({}, pt, ft)) },
        vt = new ht({
          file: 'sockjs',
          urls: rt,
      ...
      const kt = {
        ...
        processHandshake: function (t) {
          ...
          if ('pusher:error' === e.event)
            return { action: this.getCloseAction(e.data), error: this.getCloseError(e.data) };
        ...
        getCloseError: function (t) {
          return 1e3 !== t.code && 1001 !== t.code
            ? { type: 'PusherError', data: { code: t.code, message: t.reason || t.message } }
            : null;
        },
      };
      var Ct = kt;
            ...
            At(this, void 0, void 0, function* () {
              if (!t)
                if (null != (n = n).channel_data) {
                  ...
                  if (
                    (yield this.pusher.user.signinDonePromise, null == this.pusher.user.user_data)
                  ) {
      ...
      class jt extends xt {
        ...
        authorize(t, e) {
          super.authorize(t, (t, n) => {
            ...
            i
              ? ((this.key = Object(Dt.decode)(i)), delete n.shared_secret, e(null, n))
              : e(
                  new Error(
                ...
                e
                  ...
                  : ((r = this.nacl.secretbox.open(n, i, this.key)),
                    null !== r
                      ...
                      : V.error('Failed to decrypt event with new key. Dropping encrypted event'));
              })
            );
          this.emit(t, this.getDataToEmit(r));
        }
            ...
            o = (a, c) => {
              c
                ...
                : ((i += 1),
                  ...
                  i < n.length
                    ? (r && ((r *= 2), this.timeoutLimit && (r = Math.min(r, this.timeoutLimit))),
                      (s = this.tryStrategy(n[i], t, { timeout: r, failFast: this.failFast }, o)))
                    : e(!0));
            };
          return (
            (s = this.tryStrategy(n[i], t, { timeout: r, failFast: this.failFast }, o)),
      ...
      class Ft {
        ...
        connect(t, e) {
          ...
          if (i && i.timestamp + this.ttl >= j.now()) {
            ...
            o &&
              (['ws', 'wss'].includes(i.transport) || r > 3
                ? (this.timeline.info({ cached: !0, transport: i.transport, latency: i.latency }),
                  s.push(new zt([o], { timeout: 2 * i.latency + 1e3, failFast: !0 })))
                : r++);
          }
          var a = j.now(),
            c = s.pop().connect(t, function i(o, h) {
              o
                ? (Jt(n), s.length > 0 ? ((a = j.now()), (c = s.pop().connect(t, i))) : e(o))
                : (!(function (t, e, n, i) {
      ...
      var Yt = function (t, e, n) {
          ...
          var s,
            ...
            l = new Mt({ lives: 2, minPingDelay: 1e4, maxPingDelay: t.activityTimeout }),
            d = r('ws', 'ws', 3, o, u),
            p = r('wss', 'ws', 3, a, u),
            ...
            C = new zt([new Wt(Vt(_), new qt([_, new $t(k, { delay: 4e3 })]), k)], h),
            T = new Wt(Vt(C), C, S);
          return (
            (s = e.useTLS
              ? new qt([y, new $t(T, { delay: 2e3 })])
              : new qt([y, new $t(w, { delay: 2e3 }), new $t(T, { delay: 5e3 })])),
      ...
      class Kt extends at {
        ...
        close() {
          (this.unloader && (ue.removeUnloadListener(this.unloader), (this.unloader = null)),
      ...
      var re,
        se = class {
            ...
            try {
              return (
                ue
                  .createSocketRequest(
                    'POST',
                    ne(((e = this.location), (n = this.session), e.base + '/' + n + '/xhr_send'))
                  )
                  .start(t),
                !0
              );
          ...
          onChunk(t) {
            var e;
            if (200 === t.status)
              switch ((this.readyState === te.OPEN && this.onActivity(), t.data.slice(0, 1))) {
                case 'o':
          ...
          onEvent(t) {
            this.readyState === te.OPEN && this.onmessage && this.onmessage({ data: t });
          }
          onActivity() {
        ...
        ue = {
          ...
          transportConnectionInitializer: function () {
            var t = this;
            (t.timeline.info(
              t.buildTimelineMessage({ transport: t.name + (t.options.useTLS ? 's' : '') })
            ),
              t.hooks.isInitialized()
                ? t.changeState('initialized')
                : t.hooks.file
                  ? (t.changeState('initializing'),
                    a.load(t.hooks.file, { useTLS: t.options.useTLS }, function (e, n) {
                      t.hooks.isInitialized()
          ...
          addUnloadListener(t) {
            void 0 !== window.addEventListener
              ...
              : void 0 !== window.attachEvent && window.attachEvent('onunload', t);
          },
          removeUnloadListener(t) {
            void 0 !== window.addEventListener
              ? window.removeEventListener('unload', t, !1)
              : void 0 !== window.detachEvent && window.detachEvent('onunload', t);
          },
          randomInt: (t) =>
            Math.floor(
              ((window.crypto || window.msCrypto).getRandomValues(new Uint32Array(1))[0] /
                Math.pow(2, 32)) *
                t
            ),
        };
      ...
      var ve = function (t, e, n, i, r, s) {
          ...
          return (
            !(
              ...
              ? ((r = Object.assign({ ignoreNullOrigin: t.ignoreNullOrigin }, r)),
      ...
      var ye = (t) => {
        ...
        return (e, n) => {
          const i = ((t, e) => {
            var n = 'socket_id=' + encodeURIComponent(t.socketId);
            for (var i in ((n += '&channel_name=' + encodeURIComponent(t.channelName)), e.params))
              n += '&' + encodeURIComponent(i) + '=' + encodeURIComponent(e.params[i]);
            if (null != e.paramsProvider) {
              let t = e.paramsProvider();
              for (var i in t) n += '&' + encodeURIComponent(i) + '=' + encodeURIComponent(t[i]);
      ...
      class Oe extends at {
        ...
        _onSigninSuccess(t) {
          ...
          if ('string' != typeof this.user_data.id || '' === this.user_data.id)
            return (
              V.error("user_data doesn't contain an id. user_data: " + this.user_data),
              void this._cleanup()
            );
          (this._signinDoneResolve(), this._subscribeChannels());
        }
        _subscribeChannels() {
          ((this.serverToUserChannel = new Ot('#server-to-user-' + this.user_data.id, this.pusher)),
        ...
        constructor(t, e) {
          (!(function (t) {
            ...
            (function (t) {
              ...
              'disableStats' in t &&
                V.warn('The disableStats option is deprecated in favor of enableStats');
            })(e),
            (this.key = t),
        ...
        disconnect() {
          (this.connection.disconnect(),
            this.timelineSenderTimer &&
              (this.timelineSenderTimer.ensureAborted(), (this.timelineSenderTimer = null)));
        }
        bind(t, e, n) {
