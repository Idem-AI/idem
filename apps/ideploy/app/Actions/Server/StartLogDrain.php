...
[FILTER]
    ...
    Rename              IDEPLOY_APP_NAME ideploy.app_name
    Rename              IDEPLOY_PROJECT_NAME ideploy.project_name
    Rename              IDEPLOY_SERVER_IP ideploy.server_ip
    Rename              IDEPLOY_ENVIRONMENT_NAME ideploy.environment_name
[OUTPUT]
    Name nrlogs
    Match *
