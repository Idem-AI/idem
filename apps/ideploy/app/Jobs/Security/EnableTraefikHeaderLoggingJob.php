...
class EnableTraefikHeaderLoggingJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            $composePath = '/data/ideploy/proxy/docker-compose.yml';
            ...
            instant_remote_process([
                'touch /data/ideploy/proxy/access.log',
                'chmod 666 /data/ideploy/proxy/access.log',
    ...
    private function verifyHeaderLogging(): void
    {
        ...
        $possiblePaths = [
            '/data/ideploy/proxy/access.log',
            '/var/lib/docker/volumes/ideploy_ideploy_data/_data/proxy/access.log',
            '/var/lib/docker/volumes/ideploy_dev_ideploy_data/_data/proxy/access.log',
        ];
