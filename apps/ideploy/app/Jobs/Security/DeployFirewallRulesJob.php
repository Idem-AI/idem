...
class DeployFirewallRulesJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $appDir = "/var/lib/ideploy/crowdsec/config/appsec-configs";
            $scenarioDir = "/var/lib/ideploy/crowdsec/config/scenarios";
            ...
            $appSecRulesDir = "/var/lib/ideploy/crowdsec/config/appsec-rules/ideploy";
