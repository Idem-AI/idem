    ...
    public function handle()
    {
        ...
        try {
            ...
            instant_remote_process([
                'mkdir -p /var/lib/ideploy/traffic-logger',
            ], $this->server);
            ...
            instant_scp($tmpFile, '/var/lib/ideploy/traffic-logger/logger.py', $this->server);
            unlink($tmpFile);

            // Start container
            instant_remote_process([
                'cd /var/lib/ideploy/traffic-logger',
                'docker run -d --name traffic-logger --network ideploy --restart always ' .
