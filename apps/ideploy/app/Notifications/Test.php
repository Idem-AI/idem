...
class Test extends Notification implements ShouldQueue
{
    ...
    public function toDiscord(): DiscordMessage
    {
        $message = new DiscordMessage(
            ...
            description: 'This is a test Discord notification from Ideploy. :cross_mark: :warning: :information_source:',
    ...
    {
        return [
            'message' => 'Ideploy: This is a test Telegram notification from Ideploy.',
            'buttons' => [
                [
                    'text' => 'Go to your dashboard',
                    'url' => isDev() ? 'https://staging-but-dev.ideploy.io' : base_url(),
                ],
            ],
        ];
    }
    ...
    public function toPushover(): PushoverMessage
    {
        return new PushoverMessage(
            ...
            message: 'This is a test Pushover notification from Ideploy.',
            buttons: [
                [
                    'text' => 'Go to your dashboard',
                    'url' => base_url(),
    ...
    public function toSlack(): SlackMessage
    {
        return new SlackMessage(
            ...
            description: 'This is a test Slack notification from Ideploy.'
        );
    }
    ...
    public function toWebhook(): array
    {
        return [
            'success' => true,
            'message' => 'This is a test webhook notification from Ideploy.',
            'event' => 'test',
            'url' => base_url(),
        ];
    }
