...
class Server extends BaseModel
{
    ...
    protected function isIdeployHost(): Attribute
    {
    ...
    {
        $banner =
            "# This file is generated by Ideploy, do not edit it manually.\n".
    ...
    public function setupDynamicProxyConfiguration()
    {
        ...
        if ($this->proxyType() === ProxyTypes::TRAEFIK->value) {
            ...
            if (empty($settings->fqdn) || (isCloud() && $this->id !== 0) || ! $this->isLocalhost()) {
                ...
                $yaml =
                    "# This file is automatically generated by Ideploy.\n".
...
$schema://$host {
    ...
    public function validateDockerEngine($throwError = false)
    {
        ...
        $this->settings->save();
        $this->validateIdeployNetwork(isSwarm: false, isBuildServer: $this->settings->is_build_server);
    ...
    public function validateDockerSwarm()
    {
        ...
        $this->settings->is_usable = true;
        $this->settings->save();
        $this->validateIdeployNetwork(isSwarm: true);
    ...
    public function validateIdeployNetwork($isSwarm = false, $isBuildServer = false)
    {
        if ($isBuildServer) {
            return;
        }
