...
function fqdnLabelsForTraefik(string $uuid, Collection $domains, bool $is_force_https_enabled = false, $onlyPort = null, ?Collection $serviceLabels = null, ?bool $is_gzip_enabled = true, ?bool $is_stripprefix_enabled = true, ?string $service_name = null, bool $generate_unique_uuid = false, ?string $image = null, string $redirect_direction = 'both', bool $is_http_basic_auth_enabled = false, ?string $http_basic_auth_username = null, ?string $http_basic_auth_password = null, $application = null)
{
    $labels = collect([]);
        ...
        try {
            ...
            if ($schema === 'https') {
                ...
                if ($path !== '/') {
                    ...
                    // Add CrowdSec middlewares if firewall is enabled
...
function generateLabelsApplication(Application $application, ?ApplicationPreview $preview = null): array
{
    ...
    // Add CrowdSec labels if firewall is enabled
    $crowdSecLabels = crowdSecLabelsForApplication($application, $appUuid);
    if (!empty($crowdSecLabels)) {
