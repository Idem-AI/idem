  ...
  <div class="grid grow">
    {#key currentTagline}
      <a
        ...
        <span class="text-sm text-white">{currentTagline.label}</span>
        <Button
          class="shrink-0 rounded-md bg-[#1E1A2E] px-3 py-1.5 text-sm font-semibold text-white hover:bg-[#261A56]">
          Try now
        </Button>
      </a>
    {/key}
