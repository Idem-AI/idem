...
<div
  class={[
    'card border-muted flex h-fit flex-col overflow-hidden rounded-2xl border-2',
  ...
  <div
    ...
    tabindex="0"
    class={[
      'bg-muted flex h-11 flex-none cursor-pointer items-center justify-between p-2 whitespace-nowrap',
      isTabsShown && 'pb-1'
    ]}
