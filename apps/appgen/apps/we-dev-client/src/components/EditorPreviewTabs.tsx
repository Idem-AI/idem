...
// Les fonctionnalités WeChat DevTools ont été retirées dans la version web
const EditorPreviewTabs: React.FC = () => {
  ...
  // Version web - Cette fonction est désactivée dans l'environnement web
  const openWeChatEditor = async () => {
    console.log("Cette fonctionnalité n'est pas disponible en version web");
    return;
  };
...
const EditorIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M3 3L21 3V21H3L3 3Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
