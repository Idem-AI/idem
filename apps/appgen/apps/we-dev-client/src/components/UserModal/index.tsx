      ...
      {!openSetting && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[9999]">
          <div className="glass-card w-[400px] relative">
            <button
              onClick={closeModal}
              className="absolute right-4 top-4 text-gray-500 hover:text-text-secondary dark:hover:text-gray-200 transition-colors"
            >
              <X className="w-5 h-5" />
            </button>
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={closeModal}
                  className="flex-1 bg-gray-200 text-gray-900 hover:bg-gray-300 dark:bg-surface-3 dark:hover:bg-surface-3 dark:text-white rounded-lg py-2 text-sm font-medium transition-colors"
                >
                  {t("common.close")}
                </button>
              </div>
