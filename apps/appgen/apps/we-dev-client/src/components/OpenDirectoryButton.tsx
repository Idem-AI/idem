...
export const OpenDirectoryButton: React.FC = () => {
  ...
  const handleOpenDirectory = async () => {
    try {
      ...
      message.info(
        t('header.web_mode_info') || "Cette fonctionnalité n'est pas disponible en mode web"
      );
    ...
    <Tooltip
      title={
        <div className="text-xs">
          ...
          <div className="text-[#666] dark:text-gray-300">{t('header.open_directory_tips')}</div>
        </div>
      }
