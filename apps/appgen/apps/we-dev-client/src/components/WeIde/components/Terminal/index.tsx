      ...
      <div className="flex items-center">
        <TerminalIcon
          className={cn(
            ...
            isReady ? 'text-green-500 dark:text-green-400' : 'text-yellow-500 dark:text-yellow-400'
          )}
        />
        <span
          className={cn(
...
export function Terminal() {
  const { newTerminal, terminals, addTerminal, removeTerminal } = useTerminalStore();
  ...
  return (
    <div className={`w-full h-full flex flex-col`}>
      ...
      >
        ...
        <SquarePlus className="w-4 h-4 cursor-pointer" onClick={addTerminalHandle} />
      </div>
