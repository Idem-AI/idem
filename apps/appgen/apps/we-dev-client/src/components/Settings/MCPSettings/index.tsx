  ...
  return (
    ...
    >
      ...
      <p className="text-center max-w-md">
        {t('settings.mcp.web_mode_message') ||
          "Les fonctionnalités MCP ne sont pas disponibles en mode web. Ces fonctionnalités permettent d'accéder à des ressources locales qui ne sont pas accessibles dans un navigateur standard."}
      </p>
    </SettingContainer>
  );
