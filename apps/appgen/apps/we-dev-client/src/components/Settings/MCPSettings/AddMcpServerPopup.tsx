  ...
  return (
    ...
    >
      <div className="space-y-6">
        <FormField label={t('settings.mcp.name')} required error={errors.name}>
          <Input
            value={formData.name}
        ...
        {formData.serverType === 'stdio' && (
          <>
            <FormField label={t('settings.mcp.command')} required error={errors.command}>
              <Input
            ...
            <FormField label={t('settings.mcp.args')} tooltip={t('settings.mcp.argsTooltip')}>
              <TextArea
                value={formData.args}
            ...
            <FormField label={t('settings.mcp.env')} tooltip={t('settings.mcp.envTooltip')}>
              <TextArea
                value={formData.env}
