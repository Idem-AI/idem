  ...
  const steps = [
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          >
            <h4 className="font-medium mb-2" style={{ color: projectColors.primary }}>
              Project Details:
            </h4>
            <p className="text-sm" style={{ color: `${projectColors.primary}CC` }}>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-gray-600 dark:text-gray-300">
            Click the <strong>"Generate Now"</strong> button to start creating your application
          ...
          >
            <h4 className="font-medium mb-2" style={{ color: projectColors.accent }}>
              What happens next:
            </h4>
            <ul className="text-sm space-y-1" style={{ color: `${projectColors.accent}CC` }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              <div className="flex items-center space-x-2 mb-2">
                ...
                <h4 className="font-medium" style={{ color: projectColors.primary }}>
                  ZIP Export
                </h4>
              </div>
              <p className="text-sm" style={{ color: `${projectColors.primary}CC` }}>
            ...
            >
              <div className="flex items-center space-x-2 mb-2">
                <svg className="w-4 h-4" fill={projectColors.secondary} viewBox="0 0 24 24">
                ...
                <h4 className="font-medium" style={{ color: projectColors.secondary }}>
                  GitHub
                </h4>
              </div>
              <p className="text-sm" style={{ color: `${projectColors.secondary}CC` }}>
