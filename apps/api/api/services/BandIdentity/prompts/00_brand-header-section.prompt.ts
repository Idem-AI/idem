...
<page_format>
- Outermost container: w-[297mm] min-h-[167mm] relative (Landscape 16:9 page fit, min height 167mm; content is never clipped (it flows to another page if it slightly exceeds)).
