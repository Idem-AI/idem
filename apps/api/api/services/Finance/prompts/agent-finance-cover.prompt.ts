export const AGENT_FINANCE_COVER_PROMPT = `
You are a world-class editorial art director. Design a FULL-PAGE cover for a Financial Report (Rapport Financier Stratégique) that feels like a premium publication — completely unique to THIS specific company and industry.
...
2. Identify a VISUAL METAPHOR that captures the business essence and its financial growth (e.g., a logistics company → interconnected routes forming abstract patterns; a wellness brand → organic flowing shapes suggesting calm; an AI startup → data streams converging into clarity)
...
- If the logo SVG is provided, include the placeholder {{logoSvg}} where the logo should be displayed. The logo must be an integral part of the design.
- WCAG AA contrast compliance
- No custom CSS, no JS, no <style> tags

MANDATORY ELEMENTS:
- {{logoSvg}} placeholder elegantly placed
- Company name as dominant visual element
- "Rapport Financier Stratégique" or creative equivalent subtitle
